...
def main():
    ...
    ax[1,0].plot(tl, radius, lw=lw, color='orangered', alpha=0.8)
    ax[1,0].plot(tl[t_ind], radius[t_ind], linestyle='None', marker='o', alpha=0.5, markerfacecolor='r', fillstyle='full', markersize=msize)
    #ax[0,1].set_xlim([1, 10])
