...
#t_sim, aper0 = np.loadtxt(prefix+'_aperture.curve',skiprows=1, unpack=True)
#t_sim, Area = np.loadtxt(prefix+'_area.curve',skiprows=1, unpack=True)
#t_sim, press0 = np.loadtxt(prefix+'_pressure.curve',skiprows=1, unpack=True)
t_sim, press0, aper0, Area = np.loadtxt(prefix+'_timehist.txt',skiprows=1, unpack=True)
