...
../../build-macOS_arm-release/bin/Release/geosx -i buoyancy_staircase_co2_3d_tpfa.xml -o ../../../geos_output
...
../../build-macOS_arm-release/bin/Release/geosx -i buoyancy_staircase_co2_3d_mfd.xml -o ../../../geos_output
