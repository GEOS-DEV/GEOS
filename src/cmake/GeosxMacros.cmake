...
macro( geosx_add_code_checks )
    ...
    if (ENABLE_COVERAGE)
        blt_add_code_coverage_target( NAME   ${arg_PREFIX}_coverage
                                      RUNNER ctest --progress --output-on-failure -E 'blt_gtest_smoke|blt_mpi_smoke|testUncrustifyCheck|testDoxygenCheck|testXmlFormatCheck'
...
function(generateKernels)
  ...
  message( STATUS "Explicit combinations: ${explicitComboList}" )
  list( APPEND combinatoricSymbolList ${explicitComboList} )
  message( STATUS "Combinatoric symbol list: ${combinatoricSymbolList}" )
