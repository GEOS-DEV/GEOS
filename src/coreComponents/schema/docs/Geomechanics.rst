...
failedStepResponse      integer   0        Treatment if step fails, 0: accept solution, 1: log error and continue, 2: abort run, 3: log error and delete particle 
...
maxAllowedSubcycles     integer   0        Number of subcycles allowed before step is deemed to fail                                                              
...
plasticStrainTolerance  real64    0        Tolerance in the volumetric plastic strain consistency bisection - units of strain                                     
...
stressReturnTolerance   real64    0        Dimensionless precision of the non-hardening return relative to the trial stress increment                             
