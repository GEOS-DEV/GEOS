...
public:
   ...
   * @return A reference to @p T that refers to the sub-group.
   * @throw DomainError If the Group doesn't exist.
   */
  template< typename T = Group >
   ...
   * @throw DomainError if the wrapper doesn't exist.
   */
   ...
   * @throw A DomainError if the Wrapper does not exist.
   */
  template< typename T, typename LOOKUP_TYPE >
   ...
   * @throw DomainError if the Group doesn't have a parent.
   */
  Group & getParent()
  {
