...
DiagnosticContext DataFileContext::getContextInfo() const
{
  DiagnosticContext ctxInfo{
    toString(),
    { { DiagnosticContext::Attribute::InputFile, m_filePath },
      { DiagnosticContext::Attribute::InputLine, std::to_string( m_line )} }
  };
  return ctxInfo;
}
