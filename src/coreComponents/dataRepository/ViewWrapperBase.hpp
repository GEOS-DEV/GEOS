...
public:
  ...
  virtual localIndex Pack( char *& buffer, arrayView1d<localIndex> const & packList ) const = 0;
  virtual localIndex PackSize( ) const = 0;
  virtual localIndex PackSize( arrayView1d<localIndex> const & packList ) const = 0;

  virtual localIndex Unpack( char const *& buffer ) = 0;
  virtual localIndex Unpack( char const *& buffer, arrayView1d<localIndex> const & unpackIndices ) = 0;
