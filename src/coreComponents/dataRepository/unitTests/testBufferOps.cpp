...
TEST( testGeosxTraits, test_is_noncontainer_type_packable )
{
  ...
  static_assert( !is_noncontainer_type_packable< stdMap< string, int > >, "Should be false." );
...
{
  static_assert( is_packable_map< stdMap< string, int > >, "Should be true." );
  static_assert( is_packable_map< stdMap< string, array1d< int > > >, "Should be true." );
  static_assert( !is_packable_map< stdMap< string, std::pair< int, int > > >, "Should be false" );
}
