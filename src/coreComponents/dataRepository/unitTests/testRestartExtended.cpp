...
{
template <typename T>
Wrapper<array1d<T>>* createArrayView(Group* parent,
                                     const string& name,
                                     int sfp,
...
template <typename T>
Wrapper<array2d<T>>* createArray2dView(Group* parent,
                                       const string& name,
                                       int sfp,
...
template <typename T>
void checkArray2dView(const Wrapper<array2d<T>>* view,
                      int sfp,
                      const array2d<T>& data)
{
  EXPECT_EQ(view->sizedFromParent(), sfp);
...
template <typename T>
Wrapper<SortedArray<T>>* createSetView(Group* parent,
                                       const string& name,
                                       localIndex sfp,
...
template <typename T>
void checkSetView(const Wrapper<SortedArray<T>>* view,
                  localIndex sfp,
                  const SortedArray<T>& data)
{
  EXPECT_EQ(view->sizedFromParent(), sfp);
...
Wrapper<string>* createStringView(Group* parent,
                                  const string& name,
                                  int sfp,
                                  const string& str)
{
...
Wrapper<string_array>* createStringArrayView(Group* parent,
                                             const string& name,
                                             int sfp,
...
void checkStringArrayView(const Wrapper<string_array>* view,
                          const int sfp,
                          const string_array& arr)
{
  EXPECT_EQ(view->sizedFromParent(), sfp);
...
template <typename T>
Wrapper<T>* createScalarView(Group* parent,
                             const string& name,
                             int sfp,
                             const T& value)
{
