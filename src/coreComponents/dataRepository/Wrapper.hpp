...
public:
   ...
   */
  virtual localIndex Pack(buffer_unit_type *&buffer, bool onDevice) const override
  {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  virtual localIndex PackSize(bool onDevice) const override
  {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  virtual localIndex Unpack(buffer_unit_type const *&buffer, bool onDevice) override
  {
  ...
  struct copy_wrapper
  {
    ...
    static void copy(Array<U, NDIM, PERMUTATION> const &array,
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  virtual void copy(localIndex const sourceIndex,
   ...
   */
  traits::ViewTypeConst<T> reference() const { return referenceAsView(); }
   ...
   */
  template <typename U = T> DefaultValue<T> const &getDefaultValueStruct() const
  {
    return m_default;
  }
   ...
   */
  void setName() { wrapperHelpers::setName(reference(), m_conduitNode.path()); }
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  void populateMCArray(conduit::Node &node,
                       std::vector<std::string> const &componentNames = {}) const override
  {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  std::unique_ptr<WrapperBase> averageOverSecondDim(std::string const &name,
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  void finishWriting() const override { m_conduitNode.reset(); }
