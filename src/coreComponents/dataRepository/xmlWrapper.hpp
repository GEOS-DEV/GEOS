...
public:
  ...
  static void StringToInputVariable( array_decl< T, NDIM > & array, string value );
  ///@}
...
template< typename T, int NDIM >
void xmlWrapper::StringToInputVariable( array_decl< T, NDIM > & array, string valueString )
{
