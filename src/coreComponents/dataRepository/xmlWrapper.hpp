...
public:
  ...
  /**
   * @return a stdMap containing the original buffers of the document and its includes, indexed by file path.
   */
  stdMap< string, string > const & getOriginalBuffers() const;
  /**
...
private:
  ...
  stdMap< string, string > m_originalBuffers;
  /// @see getFilePath()
