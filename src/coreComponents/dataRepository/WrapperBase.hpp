...
public:
   ...
   */
  virtual void addBlueprintField(
    conduit::Node& fields,
   ...
   */
  virtual std::unique_ptr<WrapperBase> averageOverSecondDim(std::string const& name,
                                                            Group& group) const = 0;
   ...
   */
  virtual bool isPackable(bool on_device = false) const = 0;
   ...
   */
  virtual localIndex PackSize(bool on_device = false) const = 0;
   ...
   */
  int sizedFromParent() const { return m_sizedFromParent; }
   ...
   */
  InputFlags getInputFlag() const { return m_inputFlag; }
...
protected:
  ...
  conduit::Node& getConduitNode() { return m_conduitNode; }
