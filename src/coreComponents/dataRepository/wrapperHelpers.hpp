...
// inline std::enable_if_t< bufferOps::is_packable_array< std::remove_reference< std::remove_const< T > > > ||
//                         bufferOps::can_memcpy< std::remove_reference< std::remove_const < T > > >, localIndex >
localIndex
...
/*
template< bool DO_PACKING, typename T >
inline std::enable_if_t< bufferOps::is_packable_array< T >, localIndex >
PackDevice( buffer_unit_type * & buffer, T & var )
{
  return bufferOps::PackDevice< DO_PACKING >( buffer, var );
}
