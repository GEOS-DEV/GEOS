...
public:
  ...
  void AssembleAccumulationTerms(
    real64 const dt,
    DomainPartition const& domain,
    DofManager const& dofManager,
    CRSMatrixView<real64, globalIndex const> const& localMatrix,
  ...
  arrayView1d<string const> const& proppantModelNames() const
  {
...
private:
   ...
   */
  void UpdateCellBasedFlux(real64 const time_n, DomainPartition& domain);
