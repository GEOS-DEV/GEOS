...
private:
   ...
   * 
   */
  void ComputeTransmissibilityMatrix( arrayView2d<real64 const> const & nodePosition, 
   ...
   * 
   */
  void ComputeTPFAInnerProduct( arrayView2d<real64 const> const & nodePosition, 
                                ArrayOfArraysView<localIndex const> const & faceToNodes, 
                                arraySlice1d<localIndex const> const elemToFaces,
                                R1Tensor const & elemCenter,
                                R1Tensor const & elemPerm,
   ...
   * 
   */
  void ComputeQFamilyInnerProduct( arrayView2d<real64 const> const & nodePosition, 
                                   ArrayOfArraysView<localIndex const> const & faceToNodes, 
                                   arraySlice1d<localIndex const> const elemToFaces,
                                   R1Tensor const & elemCenter,
                                   real64   const & elemVolume,
