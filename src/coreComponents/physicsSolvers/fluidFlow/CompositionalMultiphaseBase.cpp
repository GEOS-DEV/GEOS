                                                                 ...
                                                                 DomainPartition & domain )
{
  ...
  real64 const nextDtPressure = round( currentDt * ( 1.0 + m_solutionChangeScalingFactor ) * m_targetRelativePresChange
  ...
  real64 const nextDtPhaseVolFrac = round( currentDt * ( 1.0 + m_solutionChangeScalingFactor ) * m_targetPhaseVolFracChange
  ...
  if( m_targetRelativeCompDensChange < LvArray::NumericLimits< real64 >::max )
  {
    nextDtCompDens = round( currentDt * ( 1.0 + m_solutionChangeScalingFactor ) * m_targetRelativeCompDensChange
  ...
  if( m_isThermal )
  {
    nextDtTemperature = round( currentDt * ( 1.0 + m_solutionChangeScalingFactor ) * m_targetRelativeTempChange
...
real64 CompositionalMultiphaseBase::setNextDtBasedOnCFL( const geos::real64 & currentDt, geos::DomainPartition & domain )
{
  ...
  return std::min( round( m_targetFlowCFL*currentDt/maxCompCFL ),
                   round( m_targetFlowCFL*currentDt/maxPhaseCFL ) );
}
