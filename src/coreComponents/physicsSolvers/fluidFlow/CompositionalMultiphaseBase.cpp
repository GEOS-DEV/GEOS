...
void CompositionalMultiphaseBase::updateFluidModel( ObjectManagerBase & dataGroup ) const
{
  ...
  compositionalMultiphaseUtilities::updateFluidModel( fluid, dataGroup.size(), pres, temp, compFrac );
}
                                                               ...
                                                               arrayView1d< string const > const & )
  {
                                                         ...
                                                         string const & )
    {
      if( fs.getLogLevel() >= 1 && m_nonlinearSolverParameters.m_numNewtonIterations == 0 )
      {
        ...
        GEOS_LOG_RANK_0( GEOS_FMT( getBoundaryConditionMessage(),
                                                    ...
                                                    arrayView1d< real64 > const & localRhs ) const
{
                                                               ...
                                                               arrayView1d< string const > const & )
  {
    ...
    applyFieldValue< ElementSubRegionBase >( time_n, dt, mesh, getBoundaryConditionMessage(),
                                                   ...
                                                   string const & )
    {
      ...
      compositionalMultiphaseUtilities::updateFluidModel( fluid, targetSet, bcPres, bcTemp, compFrac );
