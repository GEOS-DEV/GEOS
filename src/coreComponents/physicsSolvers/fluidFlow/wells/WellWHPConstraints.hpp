...
public:
   ...
   */
  virtual std::string getConstraintKey( ) const override { return "WHPConstraint"; };
  ///@}
...
public:
   ...
   * @return constraint key
   */
  virtual std::string  getConstraintKey( ) const override { return "MinimumWHPConstraint"; };
  ///@}
  /**
   * @brief Struct to serve as a container for variable strings and keys.
   * @struct viewKeyStruct
...
public:
   ...
   * @return constraint key
   */
  virtual std::string getConstraintKey( ) const override { return "MaximumWHPConstraint"; };
