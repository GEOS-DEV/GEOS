...
/**
 * @file ProdPipeFlowTableFunction.hpp
 */

#ifndef GEOS_FUNCTIONS_PRODPIPEFLOWTABLEFUNCTION_HPP_
#define GEOS_FUNCTIONS_PRODPIPEFLOWTABLEFUNCTION_HPP_
...
public:
   ...
   */
  ProdPipeFlowTableFunction( const string & name,
                             Group * const parent );

  /**
   * @brief The catalog name interface
   * @return name of the ProdPipeFlowTableFunction in the FunctionBase catalog
   */
  static string catalogName() { return "ProdPipeFlowTableFunction"; }
  ...
  viewKeysProdPipeFlowTableFunction;
...
#endif /* GEOS_FUNCTIONS_PRODPIPEFLOWTABLEFUNCTION_HPP_ */
