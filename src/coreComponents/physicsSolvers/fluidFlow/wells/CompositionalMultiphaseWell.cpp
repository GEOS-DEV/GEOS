...
void CompositionalMultiphaseWell::updateFluidModel( WellElementSubRegion & subRegion )
{
  ...
  compositionalMultiphaseUtilities::updateFluidModel( fluid, subRegion.size(), pres, temp, compFrac );
}
...
void CompositionalMultiphaseWell::initializeWells( DomainPartition & domain )
{
                                                                ...
                                                                arrayView1d< string const > const & regionNames )
  {
                                                                   ...
                                                                   WellElementSubRegion & subRegion )
    {
      ...
      compositionalMultiphaseUtilities::updateFluidModel( fluid, subRegion.size(), wellElemPressure, wellElemTemp, wellElemCompFrac );
