  ...
  m_targetPhaseIndex( -1 )
{
  ...
  addLogLevel( "logLevel >= 1", "Output well rates to a simple csv file" );
  addLogLevel( "logLevel >= 2", "Infos on the BHP pressure" );
  addLogLevel( "logLevel >= 2", "Infos on the surface density" );
