...
void CompositionalMultiphaseWell::ValidateConstitutiveModels(
...
void CompositionalMultiphaseWell::ValidateInjectionStreams(
...
void CompositionalMultiphaseWell::InitializePostInitialConditions_PreSubGroups(
...
void CompositionalMultiphaseWell::UpdateComponentFraction(
...
void CompositionalMultiphaseWell::UpdatePhaseVolumeFraction(
...
void CompositionalMultiphaseWell::UpdateState(WellElementSubRegion &subRegion,
                                              localIndex const targetIndex)
{
  // update properties
...
void CompositionalMultiphaseWell::AssembleFluxTerms(
...
void CompositionalMultiphaseWell::AssembleVolumeBalanceTerms(
  real64 const GEOSX_UNUSED_PARAM(time_n),
...
real64 CompositionalMultiphaseWell::CalculateResidualNorm(
  DomainPartition const &domain,
  DofManager const &dofManager,
...
real64 CompositionalMultiphaseWell::ScalingForSystemSolution(
  DomainPartition const &domain,
  DofManager const &dofManager,
...
bool CompositionalMultiphaseWell::CheckSystemSolution(
  DomainPartition const &domain,
  DofManager const &dofManager,
  arrayView1d<real64 const> const &localSolution,
...
void CompositionalMultiphaseWell::ComputePerforationRates(
  WellElementSubRegion &subRegion,
...
void CompositionalMultiphaseWell::ApplySystemSolution(
  DofManager const &dofManager,
  arrayView1d<real64 const> const &localSolution,
  real64 const scalingFactor,
...
void CompositionalMultiphaseWell::FormPressureRelations(
  DomainPartition const &domain,
  DofManager const &dofManager,
  CRSMatrixView<real64, globalIndex const> const &localMatrix,
  arrayView1d<real64> const &localRhs)
...
void CompositionalMultiphaseWell::ImplicitStepComplete(
