...
void WellSolverBase::AssembleSystem(
  real64 const time,
  real64 const dt,
  DomainPartition& domain,
...
void WellSolverBase::InitializePostInitialConditions_PreSubGroups(
...
WellControls const& WellSolverBase::GetWellControls(
...
std::vector<string> WellSolverBase::getConstitutiveRelations(
