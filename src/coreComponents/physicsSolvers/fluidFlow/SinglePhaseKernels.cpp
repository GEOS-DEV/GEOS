...
Launch<CellElementStencilTPFA>( CellElementStencilTPFA & stencil,
                                ...
                                FluxKernel::ElementView < arrayView1d<real64 const> > const & poroRef,
...
Launch<FaceElementStencil>( FaceElementStencil & stencil,
                            real64 const dt,
                            localIndex const fluidIndex,
                            localIndex const GEOSX_UNUSED_PARAM( fractureRegionIndex ),
                            FluxKernel::ElementView < arrayView1d<real64 const> > const & pres,
                            FluxKernel::ElementView < arrayView1d<real64 const> > const & gravCoef,
                            FluxKernel::MaterialView< arrayView2d<real64 const> > const & dens,
                            FluxKernel::MaterialView< arrayView2d<real64 const> > const & visc,
                            ...
                            FluxKernel::ElementView < arrayView1d<real64 const> > const & GEOSX_UNUSED_PARAM( poroRef ),
                            FluxKernel::ElementView < arrayView1d<real64 const> > const & totalCompressibility,
                            FluxKernel::ElementView < arrayView1d<real64 const> > const & referencePressure,
                            ElementRegionManager::ElementViewAccessor<arrayView1d<real64>> * const mass,
                            real64 * const maxStableDt)
