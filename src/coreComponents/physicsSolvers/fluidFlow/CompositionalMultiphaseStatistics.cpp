  ...
  m_computeRegionStatistics( 1 )
{
  ...
  addLogLevel( "logLevel >= 1 and pore volume equal 0", "Warning on the impossibility to compute pressure" );
  addLogLevel( "logLevel >= 1", "Information on the regions statistics" );
