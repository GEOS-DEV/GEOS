...
public:
  ...
  ElementBasedAssemblyKernel( localIndex const numPhases,
    ...
    m_dCompFrac_dCompDens( subRegion.getExtrinsicData< extrinsicMeshData::dGlobalCompFraction_dGlobalCompDensity >() ),
    m_phaseVolFracOld( subRegion.getExtrinsicData< extrinsicMeshData::phaseVolumeFractionOld >() ),
    m_phaseVolFrac( subRegion.getExtrinsicData< extrinsicMeshData::phaseVolumeFraction >() ),
    m_dPhaseVolFrac_dPres( subRegion.getExtrinsicData< extrinsicMeshData::dPhaseVolumeFraction_dPressure >() ),
    m_dPhaseVolFrac_dCompDens( subRegion.getExtrinsicData< extrinsicMeshData::dPhaseVolumeFraction_dGlobalCompDensity >() ),
    m_phaseDensOld( subRegion.getExtrinsicData< extrinsicMeshData::phaseDensityOld >() ),
    m_phaseDens( fluid.phaseDensity() ),
    m_dPhaseDens_dPres( fluid.dPhaseDensity_dPressure() ),
    m_dPhaseDens_dComp( fluid.dPhaseDensity_dGlobalCompFraction() ),
    m_phaseCompFracOld( subRegion.getExtrinsicData< extrinsicMeshData::phaseComponentFractionOld >() ),
