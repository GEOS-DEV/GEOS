...
struct FluxKernelHelper
{
   ...
   * @param[in] dElemDens_dPres the derivative of the density at this element's center
   ...
   * @param[out] dVolFlux_dPres the derivatives of the vol fluxes wrt to this element's elem centered pressure
   * @param[out] dVolFlux_dSat the derivatives of the vol fluxes wrt to this element's elem centered saturation
   * @param[out] dVolFlux_dFacePres the derivatives of the vol fluxes wrt to this element's face pressures
   *
   ...
   * @param[in] dMob_dSat the derivatives of the mobilities in the domain wrt elem-centered saturation (non-local)
   ...
   * @param[inout] dUpwMobility_dSat the derivatives of the upwinded phase mobilities wrt the elem-centered saturations
   ...
   * @param[in] dVolFlux_dSat the derivatives of the vol fluxes wrt to this element's elem centered saturation
   * @param[in] dVolFlux_dFacePres the derivatives of the vol fluxes wrt to this element's face pressures
   ...
   * @param[in] dUpwMobility_dSat the derivatives of the upwinded phase mobilities wrt the elem-centered saturations
  ...
  void AssembleOneSidedMassFluxes( real64 const & dt,
                                   ...
                                   stackArray2d< real64, HybridFVMInnerProduct::MAX_NUM_FACES *TwoPhaseBase::NUM_PHASES > const & dUpwMobility_dPres,
                                   stackArray2d< real64, HybridFVMInnerProduct::MAX_NUM_FACES *TwoPhaseBase::NUM_PHASES > const & dUpwMobility_dSat,
                                   stackArray2d< globalIndex, HybridFVMInnerProduct::MAX_NUM_FACES *TwoPhaseBase::NUM_PHASES > const & upwDofNumber,
...
struct FluxKernel< CellElementSubRegion >
{
  ...
  Compute( localIndex const er,
           ...
           ElementRegionManager::ElementViewAccessor< arrayView2d< real64 const > >::ViewTypeConst const & dElemPhaseMob_dSat,
           ElementRegionManager::ElementViewAccessor< arrayView1d< globalIndex const > >::ViewTypeConst const & elemDofNumber,
           array1d< localIndex > const & phaseToRow,
           stackArray2d< real64, HybridFVMInnerProduct::MAX_NUM_FACES
                         *HybridFVMInnerProduct::MAX_NUM_FACES > const & transMatrix,
           ...
           ParallelVector * const rhs )
  {
    ...
    stackArray2d< real64, maxNumFaces *numPhases > volFlux( numFacesInElem, numPhases );
    stackArray2d< real64, maxNumFaces *numPhases > dVolFlux_dPres( numFacesInElem, numPhases );
    stackArray2d< real64, maxNumFaces *numPhases > dVolFlux_dSat( numFacesInElem, numPhases );
    stackArray3d< real64, maxNumFaces *maxNumFaces *numPhases > dVolFlux_dFacePres( numFacesInElem, numFacesInElem, numPhases );

    // upwinded mobility
    stackArray2d< real64, maxNumFaces *numPhases > upwMobility( numFacesInElem, numPhases );
    stackArray2d< real64, maxNumFaces *numPhases > dUpwMobility_dPres( numFacesInElem, numPhases );
    stackArray2d< real64, maxNumFaces *numPhases > dUpwMobility_dSat( numFacesInElem, numPhases );
    stackArray2d< globalIndex, maxNumFaces *numPhases > upwDofNumber( numFacesInElem, numPhases );
