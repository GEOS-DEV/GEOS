...
/**
 * @file SinglePhaseStateReset.hpp
 */

#ifndef SRC_CORECOMPONENTS_PHYSICSSOLVERS_MULTIPHYSICS_SINGLEPHASESTATERESET_HPP_
#define SRC_CORECOMPONENTS_PHYSICSSOLVERS_MULTIPHYSICS_SINGLEPHASESTATERESET_HPP_
 ...
 *
 */
class SinglePhaseStateReset : public TaskBase
{
public:
   ...
   */
  SinglePhaseStateReset( const string & name,
                         Group * const parent );

  /// Destructor for the class
  ~SinglePhaseStateReset() override;

  /// Accessor for the catalog name
  static string catalogName() { return "SinglePhaseStateReset"; }
...
#endif /* SRC_CORECOMPONENTS_PHYSICSSOLVERS_MULTIPHYSICS_SINGLEPHASESTATERESET_HPP_ */
