...
ProppantTransport::ProppantTransport( const std::string & name, Group * const parent ) :
  FlowSolverBase( name, parent )
{
  this
    ->registerWrapper( viewKeyStruct::proppantNamesString, &m_proppantModelNames )
    ->setInputFlag( InputFlags::REQUIRED )
    ->setDescription(
      "Name of proppant constitutive object to use for this solver." );
  ...
  registerWrapper( viewKeyStruct::frictionCoefficientString, &m_frictionCoefficient )
    ->setApplyDefaultValue( 0.03 )
    ->setInputFlag( InputFlags::OPTIONAL )
    ->setDescription( "Friction coefficient" );

  registerWrapper( viewKeyStruct::updateProppantPackingString,
...
void
ProppantTransport::PostProcessInput()
{
...
void
ProppantTransport::RegisterDataOnMesh( Group * const MeshBodies )
{
  ...
  for( auto & mesh : MeshBodies->GetSubGroups() )
  {
    ...
    forTargetSubRegions< CellElementSubRegion >(
      meshLevel,
      [&]( localIndex const, CellElementSubRegion & subRegion ) {
        ...
        subRegion
          ...
          ->setDefaultValue( 0.0 );
        subRegion
          .registerWrapper< array2d< real64 > >(
        ...
        subRegion
          ...
          ->setDefaultValue( 0.0 );
        subRegion
          .registerWrapper< array1d< R1Tensor > >( viewKeyStruct::cellBasedFluxString )
          ->setDefaultValue( { 0.0, 0.0, 0.0 } );
        subRegion
          .registerWrapper< array1d< integer > >(
            viewKeyStruct::isProppantBoundaryString )
          ->setDefaultValue( 0 );
        subRegion
          .registerWrapper< array2d< real64 > >(
      ...
      [&]( localIndex const, FaceElementSubRegion & subRegion ) {
        subRegion
          .registerWrapper< array1d< real64 > >(
            viewKeyStruct::proppantConcentrationString )
          ->setPlotLevel( PlotLevel::LEVEL_0 );
        subRegion.registerWrapper< array1d< real64 > >(
          viewKeyStruct::deltaProppantConcentrationString );
        subRegion
          .registerWrapper< array2d< real64 > >(
            viewKeyStruct::componentConcentrationString )
          ->setPlotLevel( PlotLevel::LEVEL_0 );
        subRegion.registerWrapper< array2d< real64 > >(
          viewKeyStruct::deltaComponentConcentrationString );
        subRegion.registerWrapper< array2d< real64 > >(
          viewKeyStruct::oldComponentDensityString );
        subRegion.registerWrapper< array1d< R1Tensor > >(
          viewKeyStruct::cellBasedFluxString );
        subRegion.registerWrapper< array1d< integer > >(
          viewKeyStruct::isProppantBoundaryString );
        subRegion.registerWrapper< array1d< integer > >(
          viewKeyStruct::isProppantMobileString );
        subRegion
          .registerWrapper< array1d< real64 > >(
            viewKeyStruct::proppantPackVolumeFractionString )
          ->setPlotLevel( PlotLevel::LEVEL_0 );
        subRegion.registerWrapper< array1d< real64 > >(
          viewKeyStruct::proppantExcessPackVolumeString );
        subRegion.registerWrapper< array1d< real64 > >(
          viewKeyStruct::proppantLiftFluxString );
        subRegion
          .registerWrapper< array1d< real64 > >( viewKeyStruct::poroMultiplierString )
          ->setDefaultValue( 1.0 );
        subRegion
          .registerWrapper< array1d< R1Tensor > >( viewKeyStruct::transTMultiplierString )
...
void
ProppantTransport::InitializePreSubGroups( Group * const rootGroup )
{
  ...
  for( auto & mesh : domain->getMeshBodies()->GetSubGroups() )
  {
    MeshLevel & meshLevel =
      *Group::group_cast< MeshBody * >( mesh.second )->getMeshLevel( 0 );
    ValidateModelMapping< SlurryFluidBase >( *meshLevel.getElemManager(),
                                             m_fluidModelNames );
    ValidateModelMapping< ParticleFluidBase >( *meshLevel.getElemManager(),
                                               m_proppantModelNames );
  }

  SlurryFluidBase const * fluid0 =
    cm.GetConstitutiveRelation< SlurryFluidBase >( m_fluidModelNames[0] );
...
void
ProppantTransport::ResizeFractureFields( MeshLevel & mesh )
{
  localIndex const NC = m_numComponents;
    ...
    forTargetSubRegions< FaceElementSubRegion >(
      ...
      [&]( localIndex const, FaceElementSubRegion & subRegion ) {
        ...
        subRegion
          ...
          .resizeDimension< 1 >( NC );
        subRegion
          .getReference< array2d< real64 > >( viewKeyStruct::oldComponentDensityString )
          .resizeDimension< 1 >( NC );
        subRegion
          .getReference< array2d< real64 > >(
            viewKeyStruct::bcComponentConcentrationString )
...
void
ProppantTransport::UpdateFluidModel( Group & dataGroup,
                                     localIndex const targetIndex )
{
  ...
  arrayView2d< real64 const > const & componentConc =
    dataGroup.getReference< array2d< real64 > >(
      viewKeyStruct::componentConcentrationString );
  arrayView2d< real64 const > const & dComponentConc =
    dataGroup.getReference< array2d< real64 > >(
      viewKeyStruct::deltaComponentConcentrationString );

  SlurryFluidBase & fluid =
    GetConstitutiveModel< SlurryFluidBase >( dataGroup,
                                             m_fluidModelNames[targetIndex] );

  constitutive::constitutiveUpdatePassThru( fluid, [&]( auto & castedFluid ) {
    typename TYPEOFREF( castedFluid )::KernelWrapper fluidWrapper =
      castedFluid.createKernelWrapper();
...
void
ProppantTransport::UpdateComponentDensity( Group & dataGroup,
                                           localIndex const targetIndex )
{
  GEOSX_MARK_FUNCTION;
...
void
ProppantTransport::UpdateProppantModel( Group & dataGroup,
                                        localIndex const targetIndex )
{
  GEOSX_MARK_FUNCTION;

  arrayView1d< real64 const > const & proppantConc =
    dataGroup.getReference< array1d< real64 > >(
      viewKeyStruct::proppantConcentrationString );
  ...
  arrayView2d< real64 const > const & dFluidDens_dPres =
    fluid.dFluidDensity_dPressure();
  arrayView3d< real64 const > const & dFluidDens_dCompConc =
    fluid.dFluidDensity_dComponentConcentration();
  arrayView2d< real64 const > const & fluidVisc = fluid.fluidViscosity();
  arrayView2d< real64 const > const & dFluidVisc_dPres =
    fluid.dFluidViscosity_dPressure();
  arrayView3d< real64 const > const & dFluidVisc_dCompConc =
    fluid.dFluidViscosity_dComponentConcentration();

  ParticleFluidBase & proppant =
    GetConstitutiveModel< ParticleFluidBase >( dataGroup,
                                               m_proppantModelNames[targetIndex] );

  constitutiveUpdatePassThru( proppant, [&]( auto & castedProppant ) {
    typename TYPEOFREF( castedProppant )::KernelWrapper proppantWrapper =
      castedProppant.createKernelWrapper();
...
void
ProppantTransport::UpdateProppantMobility( Group & dataGroup )
{
  GEOSX_MARK_FUNCTION;

  arrayView1d< real64 const > const & conc = dataGroup.getReference< array1d< real64 > >(
    viewKeyStruct::proppantConcentrationString );
  arrayView1d< real64 const > const & aperture =
    dataGroup.getReference< array1d< real64 > >(
      FaceElementSubRegion::viewKeyStruct::elementApertureString );
  arrayView1d< integer > const & isProppantMobile =
    dataGroup.getReference< array1d< integer > >(
      viewKeyStruct::isProppantMobileString );

  real64 const minAperture = m_minAperture;
  real64 const maxProppantConcentration = m_maxProppantConcentration;

  forAll< parallelDevicePolicy<> >( dataGroup.size(),
                                    [=] GEOSX_HOST_DEVICE( localIndex const a ) {
                                      isProppantMobile[a] =
                                        aperture[a] > minAperture &&
                                        conc[a] < maxProppantConcentration;
                                    } );
}

void
ProppantTransport::UpdateState( Group & dataGroup, localIndex const targetIndex )
{
  GEOSX_MARK_FUNCTION;
...
void
ProppantTransport::InitializePostInitialConditions_PreSubGroups(
  Group * const rootGroup )
{
  GEOSX_MARK_FUNCTION;
  ...
  fieldNames["elems"].emplace_back(
    string( viewKeyStruct::proppantConcentrationString ) );
  fieldNames["elems"].emplace_back(
    string( viewKeyStruct::componentConcentrationString ) );
  ...
  forTargetSubRegions(
    mesh,
    [&]( localIndex const targetIndex, ElementSubRegionBase & subRegion ) {
      UpdateState( subRegion, targetIndex );

      SlurryFluidBase const & fluid =
        GetConstitutiveModel< SlurryFluidBase >( subRegion, targetIndex );
      arrayView3d< real64 const > const & componentDens = fluid.componentDensity();
      arrayView2d< real64 > const & componentDensOld =
      ...
      forAll< parallelDevicePolicy<> >( subRegion.size(),
                                        [=] GEOSX_HOST_DEVICE( localIndex const ei ) {
                                          ...
                                          {
                                            componentDensOld[ei][c] =
                                              componentDens[ei][0][c];
                                          }
                                        } );
    } );
  ...
  m_proppantPackPermeability = m_proppantDiameter * m_proppantDiameter / 180.0 *
    ( oneMinusMaxConc * oneMinusMaxConc * oneMinusMaxConc ) /
...
real64
ProppantTransport::SolverStep( real64 const & time_n,
                               real64 const & dt,
                               ...
                               DomainPartition & domain )
{
  ...
  if( cycleNumber == 0 )
  {
    FieldSpecificationManager const & boundaryConditionManager =
  ...
  real64 const dtReturn =
    this->NonlinearImplicitStep( time_n, dt, cycleNumber, domain );
...
void
ProppantTransport::PreStepUpdate( real64 const & time,
                                  ...
                                  DomainPartition & domain )
{
  ...
  forTargetSubRegions(
    ...
    [&]( localIndex const targetIndex, ElementSubRegionBase & subRegion ) {
      ...
      arrayView1d< real64 > const & excessPackV =
        subRegion.getReference< array1d< real64 > >(
          viewKeyStruct::proppantExcessPackVolumeString );
...
void
ProppantTransport::PostStepUpdate( real64 const & time_n,
...
void
ProppantTransport::ImplicitStepSetup( real64 const & GEOSX_UNUSED_PARAM( time_n ),
                                      real64 const & GEOSX_UNUSED_PARAM( dt ),
                                      DomainPartition & domain )
{
  MeshLevel & mesh = *domain.getMeshBody( 0 )->getMeshLevel( 0 );
...
void
ProppantTransport::ImplicitStepComplete(
...
void
ProppantTransport::SetupDofs( DomainPartition const & GEOSX_UNUSED_PARAM( domain ),
...
void
ProppantTransport::AssembleSystem(
  real64 const time,
  real64 const dt,
  DomainPartition & domain,
  ...
  arrayView1d< real64 > const & localRhs )
{
  ...
  AssembleAccumulationTerms( dt, domain, dofManager, localMatrix, localRhs );

  AssembleFluxTerms( time, dt, domain, dofManager, localMatrix, localRhs );
}

void
ProppantTransport::AssembleAccumulationTerms(
  real64 const dt,
  ...
  arrayView1d< real64 > const & localRhs )
{
  ...
  forTargetSubRegions(
    mesh,
    [&]( localIndex const targetIndex, ElementSubRegionBase const & subRegion ) {
      string const dofKey =
        dofManager.getKey( viewKeyStruct::proppantConcentrationString );
      ...
      arrayView3d< real64 const > const & dCompDens_dPres =
        fluid.dComponentDensity_dPressure();
      arrayView4d< real64 const > const & dCompDens_dCompConc =
        fluid.dComponentDensity_dComponentConcentration();
...
void
ProppantTransport::AssembleFluxTerms(
  real64 const GEOSX_UNUSED_PARAM( time_n ),
  real64 const dt,
  DomainPartition const & domain,
  DofManager const & dofManager,
  ...
  arrayView1d< real64 > const & localRhs )
{
  ...
  FluxKernel::ElementViewConst< arrayView1d< real64 const > > const & proppantConc =
    m_proppantConcentration.toViewConst();
  FluxKernel::ElementViewConst< arrayView1d< real64 const > > const & dProppantConc =
    m_deltaProppantConcentration.toViewConst();

  FluxKernel::ElementViewConst< arrayView1d< real64 const > > const & gravCoef =
  ...
  FluxKernel::ElementViewConst< arrayView2d< real64 const > > const & dFluidDens_dPres =
    m_dFluidDensity_dPressure.toViewConst();
  FluxKernel::ElementViewConst< arrayView3d< real64 const > > const & dFluidDens_dComponentConc =
    m_dFluidDensity_dComponentConcentration.toViewConst();
  ...
  FluxKernel::ElementViewConst< arrayView1d< real64 const > > const & proppantPackVf =
    m_proppantPackVolumeFraction.toViewConst();

  FluxKernel::ElementViewConst< arrayView1d< integer const > > const & elemGhostRank =
...
void
ProppantTransport::ApplyBoundaryConditions(
  real64 const time_n,
  real64 const dt,
  DomainPartition & domain,
  DofManager const & dofManager,
  ...
  if( NC > 0 )
  {
    ...
    fsManager.Apply(
      ...
      [&]( FieldSpecificationBase const * const GEOSX_UNUSED_PARAM( fs ),
        ...
        GEOSX_ERROR_IF(
          bcStatusMap[subRegionName].count( setName ) > 0,
    ...
    fsManager.Apply(
      ...
      [&]( FieldSpecificationBase const * const fs,
        ...
        GEOSX_ERROR_IF( bcStatusMap[subRegionName].count( setName ) == 0,
                        "Proppant boundary condition not prescribed on set '"
                          << setName << "'" );
        GEOSX_ERROR_IF( bcStatusMap[subRegionName][setName][comp],
                        "Conflicting composition["
                          << comp << "] boundary conditions on set '" << setName
                          << "'" );
    ...
    GEOSX_ERROR_IF( !bcConsistent,
                    "Inconsistent composition boundary conditions" );
      ...
      [&]( FieldSpecificationBase const * const GEOSX_UNUSED_PARAM( bc ),
        ...
        forAll< parallelDevicePolicy<> >(
          ...
          [=] GEOSX_HOST_DEVICE( localIndex const a ) {
            ...
            for( localIndex ic = 0; ic < NC; ++ic )
            {
              FieldSpecificationEqual::SpecifyFieldValue(
                dofIndex + ic + 1,
                rankOffset,
                localMatrix,
                rhsValue,
...
real64
ProppantTransport::CalculateResidualNorm(
  DomainPartition const & domain,
  DofManager const & dofManager,
  arrayView1d< real64 const > const & localRhs )
{
  ...
  real64 const globalResidualNorm =
    MpiWrapper::Sum( localResidualNorm, MPI_COMM_GEOSX );
  return sqrt( globalResidualNorm );
}

void
ProppantTransport::ApplySystemSolution(
  DofManager const & dofManager,
  ...
  DomainPartition & domain )
{
  ...
  std::map< string, string_array > fieldNames;
  fieldNames["elems"].emplace_back(
    string( viewKeyStruct::deltaProppantConcentrationString ) );
  fieldNames["elems"].emplace_back(
    string( viewKeyStruct::deltaComponentConcentrationString ) );
...
void
ProppantTransport::SolveSystem( DofManager const & dofManager,
...
void
ProppantTransport::ResetStateToBeginningOfStep( DomainPartition & domain )
{
  MeshLevel & mesh = *domain.getMeshBody( 0 )->getMeshLevel( 0 );
...
void
ProppantTransport::ResetViews( MeshLevel & mesh )
{
  FlowSolverBase::ResetViews( mesh );
  ElementRegionManager & elemManager = *mesh.getElemManager();

  m_pressure.clear();
  m_pressure = elemManager.ConstructArrayViewAccessor< real64, 1 >(
    viewKeyStruct::pressureString );
  m_pressure.setName( getName() + "/accessors/" + viewKeyStruct::pressureString );

  m_deltaPressure.clear();
  m_deltaPressure = elemManager.ConstructArrayViewAccessor< real64, 1 >(
    viewKeyStruct::deltaPressureString );
  m_deltaPressure.setName( getName() + "/accessors/" +
                           viewKeyStruct::deltaPressureString );

  m_proppantConcentration.clear();
  m_proppantConcentration = elemManager.ConstructArrayViewAccessor< real64, 1 >(
    viewKeyStruct::proppantConcentrationString );
  m_proppantConcentration.setName( getName() + "/accessors/" +
                                   viewKeyStruct::proppantConcentrationString );

  m_deltaProppantConcentration.clear();
  m_deltaProppantConcentration =
    elemManager.ConstructArrayViewAccessor< real64, 1 >(
      viewKeyStruct::deltaProppantConcentrationString );
  m_deltaProppantConcentration.setName(
    getName() + "/accessors/" + viewKeyStruct::deltaProppantConcentrationString );

  m_cellBasedFlux.clear();
  m_cellBasedFlux = elemManager.ConstructArrayViewAccessor< R1Tensor, 1 >(
    viewKeyStruct::cellBasedFluxString );
  m_cellBasedFlux.setName( getName() + "/accessors/" +
                           viewKeyStruct::cellBasedFluxString );
  ...
  m_proppantPackVolumeFraction =
    elemManager.ConstructArrayViewAccessor< real64, 1 >(
      viewKeyStruct::proppantPackVolumeFractionString );
  m_proppantPackVolumeFraction.setName(
    getName() + "/accessors/" + viewKeyStruct::proppantPackVolumeFractionString );

  m_proppantExcessPackVolume.clear();
  m_proppantExcessPackVolume = elemManager.ConstructArrayViewAccessor< real64, 1 >(
    viewKeyStruct::proppantExcessPackVolumeString );
  m_proppantExcessPackVolume.setName(
    getName() + "/accessors/" + viewKeyStruct::proppantExcessPackVolumeString );

  m_proppantLiftFlux.clear();
  m_proppantLiftFlux = elemManager.ConstructArrayViewAccessor< real64, 1 >(
    viewKeyStruct::proppantLiftFluxString );
  m_proppantLiftFlux.setName( getName() + "/accessors/" +
                              viewKeyStruct::proppantLiftFluxString );

  m_isProppantMobile.clear();
  m_isProppantMobile = elemManager.ConstructArrayViewAccessor< integer, 1 >(
    viewKeyStruct::isProppantMobileString );
  m_isProppantMobile.setName( getName() + "/accessors/" +
                              viewKeyStruct::isProppantMobileString );

  m_isProppantBoundaryElement.clear();
  m_isProppantBoundaryElement =
    elemManager.ConstructArrayViewAccessor< integer, 1 >(
      viewKeyStruct::isProppantBoundaryString );
  m_isProppantBoundaryElement.setName( getName() + "/accessors/" +
                                       viewKeyStruct::isProppantBoundaryString );

  {
    ...
    m_density.clear();
    m_density = elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
      keys::densityString,
      targetRegionNames(),
      fluidModelNames() );
    ...
    m_dDensity_dPressure =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
        keys::dDens_dPresString,
        targetRegionNames(),
        fluidModelNames() );
    m_dDensity_dPressure.setName( getName() + "/accessors/" +
                                  keys::dDens_dPresString );

    m_dDensity_dProppantConcentration.clear();
    m_dDensity_dProppantConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
        keys::dDens_dProppantConcString,
        targetRegionNames(),
        fluidModelNames() );
    m_dDensity_dProppantConcentration.setName( getName() + "/accessors/" +
                                               keys::dDens_dProppantConcString );

    m_dDensity_dComponentConcentration.clear();
    m_dDensity_dComponentConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 3 >(
        keys::dDens_dCompConcString,
        targetRegionNames(),
        fluidModelNames() );
    m_dDensity_dComponentConcentration.setName( getName() + "/accessors/" +
                                                keys::dDens_dCompConcString );

    m_componentDensity.clear();
    m_componentDensity =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 3 >(
        keys::componentDensityString,
        targetRegionNames(),
        fluidModelNames() );
    m_componentDensity.setName( getName() + "/accessors/" +
                                keys::componentDensityString );

    m_dComponentDensity_dPressure.clear();
    m_dComponentDensity_dPressure =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 3 >(
        keys::dCompDens_dPresString,
        targetRegionNames(),
        fluidModelNames() );
    m_dComponentDensity_dPressure.setName( getName() + "/accessors/" +
                                           keys::dCompDens_dPresString );

    m_dComponentDensity_dComponentConcentration.clear();
    m_dComponentDensity_dComponentConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 4 >(
        keys::dCompDens_dCompConcString,
        targetRegionNames(),
        fluidModelNames() );
    m_dComponentDensity_dComponentConcentration.setName(
      getName() + "/accessors/" + keys::dCompDens_dCompConcString );

    m_fluidDensity.clear();
    m_fluidDensity = elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
      keys::fluidDensityString,
      targetRegionNames(),
      fluidModelNames() );
    ...
    m_dFluidDensity_dPressure =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
        keys::dFluidDens_dPresString,
        targetRegionNames(),
        fluidModelNames() );
    m_dFluidDensity_dPressure.setName( getName() + "/accessors/" +
                                       keys::dFluidDens_dPresString );

    m_dFluidDensity_dComponentConcentration.clear();
    m_dFluidDensity_dComponentConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 3 >(
        keys::dFluidDens_dCompConcString,
        targetRegionNames(),
        fluidModelNames() );
    m_dFluidDensity_dComponentConcentration.setName(
      getName() + "/accessors/" + keys::dFluidDens_dCompConcString );

    m_fluidViscosity.clear();
    m_fluidViscosity = elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
      keys::fluidViscosityString,
      targetRegionNames(),
      fluidModelNames() );
    m_fluidViscosity.setName( getName() + "/accessors/" +
                              keys::fluidViscosityString );

    m_viscosity.clear();
    m_viscosity = elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
      keys::viscosityString,
      targetRegionNames(),
      fluidModelNames() );
    ...
    m_dViscosity_dPressure =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
        keys::dVisc_dPresString,
        targetRegionNames(),
        fluidModelNames() );
    m_dViscosity_dPressure.setName( getName() + "/accessors/" +
                                    keys::dVisc_dPresString );

    m_dViscosity_dProppantConcentration.clear();
    m_dViscosity_dProppantConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
        keys::dVisc_dProppantConcString,
        targetRegionNames(),
        fluidModelNames() );
    m_dViscosity_dProppantConcentration.setName(
      getName() + "/accessors/" + keys::dVisc_dProppantConcString );

    m_dViscosity_dComponentConcentration.clear();
    m_dViscosity_dComponentConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 3 >(
        keys::dVisc_dCompConcString,
        targetRegionNames(),
        fluidModelNames() );
    m_dViscosity_dComponentConcentration.setName( getName() + "/accessors/" +
                                                  keys::dVisc_dCompConcString );
  }

  {
    ...
    m_settlingFactor = elemManager.ConstructMaterialArrayViewAccessor< real64, 1 >(
      keys::settlingFactorString,
      targetRegionNames(),
      proppantModelNames() );
    m_settlingFactor.setName( getName() + "/accessors/" +
                              keys::settlingFactorString );

    m_dSettlingFactor_dPressure.clear();
    m_dSettlingFactor_dPressure =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 1 >(
        keys::dSettlingFactor_dPressureString,
        targetRegionNames(),
        proppantModelNames() );
    m_dSettlingFactor_dPressure.setName( getName() + "/accessors/" +
                                         keys::dSettlingFactor_dPressureString );

    m_dSettlingFactor_dProppantConcentration.clear();
    m_dSettlingFactor_dProppantConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 1 >(
        keys::dSettlingFactor_dProppantConcentrationString,
        targetRegionNames(),
        proppantModelNames() );
    m_dSettlingFactor_dProppantConcentration.setName(
      getName() + "/accessors/" +
      keys::dSettlingFactor_dProppantConcentrationString );
    ...
    m_dSettlingFactor_dComponentConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 2 >(
        keys::dSettlingFactor_dComponentConcentrationString,
        targetRegionNames(),
        proppantModelNames() );
    m_dSettlingFactor_dComponentConcentration.setName(
      getName() + "/accessors/" +
      keys::dSettlingFactor_dComponentConcentrationString );

    m_collisionFactor.clear();
    m_collisionFactor = elemManager.ConstructMaterialArrayViewAccessor< real64, 1 >(
      keys::collisionFactorString,
      targetRegionNames(),
      proppantModelNames() );
    m_collisionFactor.setName( getName() + "/accessors/" +
                               keys::collisionFactorString );

    m_dCollisionFactor_dProppantConcentration.clear();
    m_dCollisionFactor_dProppantConcentration =
      elemManager.ConstructMaterialArrayViewAccessor< real64, 1 >(
        keys::dCollisionFactor_dProppantConcentrationString,
        targetRegionNames(),
        proppantModelNames() );
    m_dCollisionFactor_dProppantConcentration.setName(
      getName() + "/accessors/" +
      keys::dCollisionFactor_dProppantConcentrationString );
  }

  m_transTMultiplier.clear();
  m_transTMultiplier = elemManager.ConstructArrayViewAccessor< R1Tensor, 1 >(
    viewKeyStruct::transTMultiplierString );
  m_transTMultiplier.setName( getName() + "/accessors/" +
                              viewKeyStruct::transTMultiplierString );
}

void
ProppantTransport::UpdateCellBasedFlux( real64 const GEOSX_UNUSED_PARAM( time_n ),
                                        DomainPartition & domain )
{
  GEOSX_MARK_FUNCTION;
  ...
  ElementRegionManager::ElementViewAccessor< arrayView1d< R1Tensor > > const & cellBasedFluxAccessor =
    mesh.getElemManager()
      ->ConstructViewAccessor< array1d< R1Tensor >, arrayView1d< R1Tensor > >(
        viewKeyStruct::cellBasedFluxString );

  FluxKernel::ElementView< arrayView1d< R1Tensor > > const & cellBasedFlux =
    cellBasedFluxAccessor.toView();
...
void
ProppantTransport::UpdateProppantPackVolume(
  real64 const GEOSX_UNUSED_PARAM( time_n ),
  real64 const dt,
  DomainPartition & domain )
{
  ...
  fluxApprox.forAllStencils( mesh, [&]( auto const & stencil ) {
    ProppantPackVolumeKernel::LaunchProppantPackVolumeCalculation(
      stencil,
      dt,
      m_proppantDensity,
      m_proppantDiameter,
...

  {
    ...
    fieldNames["elems"].emplace_back(
      string( viewKeyStruct::proppantConcentrationString ) );
    fieldNames["elems"].emplace_back(
      string( viewKeyStruct::proppantPackVolumeFractionString ) );
    fieldNames["elems"].emplace_back(
      string( viewKeyStruct::proppantExcessPackVolumeString ) );
    fieldNames["elems"].emplace_back(
      string( viewKeyStruct::proppantLiftFluxString ) );
  ...
  fluxApprox.forAllStencils( mesh, [&]( auto const & stencil ) {
    ProppantPackVolumeKernel::LaunchProppantPackVolumeUpdate(
      stencil,
      downVector,
      m_maxProppantConcentration,
      m_isProppantMobile.toViewConst(),
  ...
  forTargetSubRegions( mesh, [&]( localIndex const, ElementSubRegionBase & subRegion ) {
    ...
    forAll< parallelDevicePolicy<> >(
      ...
      [=] GEOSX_HOST_DEVICE( localIndex const ei ) {
        poroMultiplier[ei] =
          1.0 - maxProppantConcentration * proppantPackVfNew[ei];

        //K0 horizontal
        transTMultiplier[ei][0] = ( 1.0 - proppantPackVfNew[ei] ) +
          proppantPackVfNew[ei] * proppantPackPermeability * 12.0 /
            ( aperture0[ei] * aperture0[ei] );

        //K1 vertical
        transTMultiplier[ei][1] = 1.0 /
          ( proppantPackVfNew[ei] * aperture0[ei] * aperture0[ei] / 12.0 /
