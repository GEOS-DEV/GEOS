...
/**
 * @file DLSinglePhaseFVM.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_FLUIDFLOW_DLSINGLEPHASEFVM_HPP_
#define GEOS_PHYSICSSOLVERS_FLUIDFLOW_DLSINGLEPHASEFVM_HPP_
...
public:
  ...
  // Aliasing public/protected members/methods of DLFlowSolverBase so we don't
  // have to use this->member etc.
  ...
  DLSinglePhaseFVM() = delete;

  /// deleted copy constructor
  DLSinglePhaseFVM( DLSinglePhaseFVM const & ) = delete;

  /// default move constructor
  DLSinglePhaseFVM( DLSinglePhaseFVM && ) = default;

  /// deleted assignment operator
  DLSinglePhaseFVM & operator=( DLSinglePhaseFVM const & ) = delete;

  /// deleted move operator
  DLSinglePhaseFVM & operator=( DLSinglePhaseFVM && ) = delete;

  /**
   * @brief default destructor
   */
  virtual ~DLSinglePhaseFVM() override = default;
  ...
  {
    if constexpr ( std::is_same_v< BASE, DLSinglePhaseBase > )
    {
      return "DLSinglePhaseFVM";
    }
...
private:
  ...
  // no data needed here, see DLSinglePhaseBase

};

} /* namespace geos */

#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_DLSINGLEPHASEFVM_HPP_
