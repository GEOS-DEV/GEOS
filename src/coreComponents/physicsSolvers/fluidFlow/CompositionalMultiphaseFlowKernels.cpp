...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void ComponentFractionKernel::Compute( arraySlice1d< real64 const > const compDens,
...
{
  forAll< parallelDevicePolicy< 128 > >( size, [=] GEOSX_HOST_DEVICE ( localIndex const a )
  {
...
void ComponentFractionKernel::Launch( SortedArrayView< localIndex const > const & targetSet,
                                      ...
                                      arrayView3d< real64 > const & dCompFrac_dCompDens )
{
  forAll< parallelDevicePolicy< 128 > >( targetSet.size(), [=] GEOSX_HOST_DEVICE ( localIndex const i )
  {
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void PhaseVolumeFractionKernel::Compute( arraySlice1d< real64 const > const compDens,
                                         arraySlice1d< real64 const > const dCompDens,
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void PhaseMobilityKernel::Compute( arraySlice2d< real64 const > const dCompFrac_dCompDens,
                                   arraySlice1d< real64 const > const phaseDens,
                                   arraySlice1d< real64 const > const dPhaseDens_dPres,
                                   arraySlice2d< real64 const > const dPhaseDens_dComp,
