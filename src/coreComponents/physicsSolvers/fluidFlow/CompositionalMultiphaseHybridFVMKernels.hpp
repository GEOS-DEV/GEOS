...
struct AssemblerKernelHelper
{
  ...
  static void
    applyGradient( arrayView1d< real64 const > const & facePres,
                   ...
                   multifluid::ArraySlice< real64 const, 1 > const & elemPhaseMassDens,
                   multifluid::ArraySlice< real64 const, 2 > const & dElemPhaseMassDens,
...
protected:
  ...
  multifluid::ArrayView< real64 const, 3 > m_phaseVisc;
  multifluid::ArrayView< real64 const, 4 > m_dPhaseVisc;
...
protected:
  ...
  ElementViewConst< multifluid::ArrayView< real64 const, 2 > > const m_totalDens_n;
