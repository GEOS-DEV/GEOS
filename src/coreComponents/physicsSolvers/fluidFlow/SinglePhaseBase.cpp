...
void SinglePhaseBase::PostProcessInput()
{
...
void SinglePhaseBase::UpdateEOS( real64 const time_n,
                                 real64 const dt,
...
void SinglePhaseBase::UpdateStencil( DomainPartition * const domain )
{
  GEOSX_MARK_FUNCTION;
