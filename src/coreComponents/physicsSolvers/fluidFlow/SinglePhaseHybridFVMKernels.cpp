...
GEOSX_HOST_DEVICE void AssemblerKernelHelper::ComputeOneSidedVolFluxes(
...
template <localIndex NF>
GEOSX_HOST_DEVICE void AssemblerKernelHelper::UpdateUpwindedCoefficients(
  localIndex const er,
...
template <localIndex NF>
GEOSX_HOST_DEVICE void AssemblerKernelHelper::AssembleOneSidedMassFluxes(
...
template <localIndex NF>
GEOSX_HOST_DEVICE void AssemblerKernelHelper::AssembleConstraints(
  arrayView1d<globalIndex const> const& faceDofNumber,
...
template <localIndex NF>
GEOSX_HOST_DEVICE void AssemblerKernel::Compute(
  localIndex const er,
  localIndex const esr,
  localIndex const ei,
  SortedArrayView<localIndex const> const& regionFilter,
