...
template <typename BASE>
real64 SinglePhaseFVM<BASE>::CalculateResidualNorm(
...
template <typename BASE>
void SinglePhaseFVM<BASE>::ApplySystemSolution(
  DofManager const &dofManager,
...
template <typename BASE>
void SinglePhaseFVM<BASE>::AssembleFluxTerms(
...
template <typename BASE>
void SinglePhaseFVM<BASE>::ApplyBoundaryConditions(
  real64 const time_n,
  real64 const dt,
  DomainPartition &domain,
  DofManager const &dofManager,
...
template <typename BASE>
void SinglePhaseFVM<BASE>::ApplyFaceDirichletBC(
  real64 const time_n,
  real64 const dt,
  DofManager const &dofManager,
  DomainPartition &domain,
