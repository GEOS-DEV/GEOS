                                                    ...
                                                    arrayView1d< real64 > const & localRhs ) const
{
  ...
  forTargetSubRegions( mesh, [&]( localIndex const targetIndex, ElementSubRegionBase const & subRegion )
  {
    ...
    {
      GEOSX_UNUSED_VAR( phaseCompFrac, dPhaseCompFrac_dPres, dPhaseCompFrac_dComp, phaseDens,
        dPhaseDens_dPres, dPhaseDens_dComp, phaseMassDens, dPhaseMassDens_dPres, dPhaseMassDens_dComp );
    } );
  } );
