 ...
 */
template <bool FULL> struct AccessorHelper
{ };

template <> struct AccessorHelper<false>
{
  template <int NDIM, typename T> using ElementAccessor = Array<T, NDIM>;

  template <int NDIM, typename T> using MaterialAccessor = Array<T, NDIM>;

  template <int NDIM, typename T, typename... DIMS>
  static ElementAccessor<NDIM, T> makeElementAccessor(
    T const* const data,
  ...
  template <int NDIM, typename T, typename... DIMS>
  static MaterialAccessor<NDIM, T> makeMaterialAccessor(
    T const* const data,
    localIndex const stencilSize,
    arraySlice1d<localIndex const> const& GEOSX_UNUSED_PARAM(stencilRegIndices),
    arraySlice1d<localIndex const> const& GEOSX_UNUSED_PARAM(stencilSubRegIndices),
...
template <> struct AccessorHelper<true>
{
  ...
  template <int NDIM, typename T, typename... DIMS>
  static ElementAccessor<NDIM, T> makeMaterialAccessor(
    T const* const data,
    localIndex const stencilSize,
    arraySlice1d<localIndex const> const& stencilRegIndices,
    arraySlice1d<localIndex const> const& stencilSubRegIndices,
