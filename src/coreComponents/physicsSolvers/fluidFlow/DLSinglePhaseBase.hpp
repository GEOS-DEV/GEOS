...
/**
 * @file DLSinglePhaseBase.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_FLUIDFLOW_DLSINGLEPHASEBASE_HPP_
#define GEOS_PHYSICSSOLVERS_FLUIDFLOW_DLSINGLEPHASEBASE_HPP_

#include "physicsSolvers/fluidFlow/DLFlowSolverBase.hpp"
...
/**
 * @class DLSinglePhaseBase
 *
 * base class to perform a single phase finite volume solve.
 */
class DLSinglePhaseBase : public DLFlowSolverBase
{
public:
  ...
  DLSinglePhaseBase() = delete;

  /// deleted copy constructor
  DLSinglePhaseBase( DLSinglePhaseBase const & ) = delete;

  /// default move constructor
  DLSinglePhaseBase( DLSinglePhaseBase && ) = default;

  /// deleted assignment operator
  DLSinglePhaseBase & operator=( DLSinglePhaseBase const & ) = delete;

  /// deleted move operator
  DLSinglePhaseBase & operator=( DLSinglePhaseBase && ) = delete;

  /**
   * @brief default destructor
   */
  virtual ~DLSinglePhaseBase() override
  {}
  ...
  struct viewKeyStruct : DLFlowSolverBase::viewKeyStruct
  {
...
#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_DLSINGLEPHASEBASE_HPP_
