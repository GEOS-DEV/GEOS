                             ...
                             [&] ( MeshLevel &, WrappedStats & fluxStats )
    {
                                 ...
                                 [&] ( ElementRegionBase & region, WrappedStats & regionStats )
      {
        ...
        gatherStatsForLog( regionsStatsOn,
                           fluxStats.getFluxName(), region.getName(), tableRegionsData, regionStats );
