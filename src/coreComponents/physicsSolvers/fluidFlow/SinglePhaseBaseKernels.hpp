...
struct MobilityKernel
{
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  static void Compute(real64 const& dens,
  ...
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  static void Compute(real64 const& dens, real64 const& visc, real64& mob)
  {
    mob = dens / visc;
  }
...
template <bool ISPORO> struct AssembleAccumulationTermsHelper;

template <> struct AssembleAccumulationTermsHelper<true>
{
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  static void porosityUpdate(real64& poro,
                             real64& dPoro_dPres,
...
template <> struct AssembleAccumulationTermsHelper<false>
{
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  static void porosityUpdate(real64& poro,
...
template <typename REGIONTYPE> struct AccumulationKernel
{ };

template <> struct AccumulationKernel<CellElementSubRegion>
{
...
template <> struct AccumulationKernel<FaceElementSubRegion>
{
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  static void Compute(real64 const& densNew,
                      real64 const& densOld,
                      real64 const& dDens_dPres,
                      real64 const& volume,
                      real64 const& dVol,
