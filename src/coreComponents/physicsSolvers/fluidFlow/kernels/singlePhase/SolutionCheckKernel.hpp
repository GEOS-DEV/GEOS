...
/**
 * @file SinglePhaseSolutionCheckKernel.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASESOLUTIONCHECKKERNEL_HPP
...
#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASESOLUTIONCHECKKERNEL_HPP
