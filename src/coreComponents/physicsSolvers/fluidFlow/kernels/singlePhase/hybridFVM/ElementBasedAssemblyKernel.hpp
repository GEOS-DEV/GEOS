...
#ifndef GEOSX_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_HYBRIDFVM_ELEMENTBASEDASSEMBLYKERNEL_HPP
#define GEOSX_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_HYBRIDFVM_ELEMENTBASEDASSEMBLYKERNEL_HPP

#include "physicsSolvers/fluidFlow/kernels/compositionalMultiphase/hybridFVM/CellConnectivity.hpp"
...
public:
  ...
  using FlowAccessors =
    geos::StencilAccessors< geos::fields::flow::mobility,
  ...
  ElementBasedAssemblyKernel( geos::globalIndex const rankOffset,
                              geos::localIndex const er,
                              geos::localIndex const esr,
                              geos::real64 const & lengthTolerance,
                              geos::string const faceDofKey,
                              geos::NodeManager const & nodeManager,
                              ...
                              geos::constitutive::PermeabilityBase const & permeability,
                              geos::SortedArrayView< geos::localIndex const > const & regionFilter,
    ...
    m_faceDofNumber( faceManager.getReference< geos::array1d< geos::globalIndex > >( faceDofKey ) ),
    ...
    m_elemGravCoef( subRegion.getField< geos::fields::flow::gravityCoefficient >() ),
    ...
    m_transMultiplier( faceManager.getField< geos::fields::flow::transMultiplier >() ),
    m_elemPres( subRegion.getField< geos::fields::flow::pressure >() ),
    ...
    m_mob( flowAccessors.get( geos::fields::flow::mobility {} ) ),
    m_dMob_dPres( flowAccessors.get( geos::fields::flow::dMobility_dPressure {} ) ),
  ...
  struct StackVariables
  {
    ...
    stackArray2d< geos::real64, NUM_FACE * NUM_FACE > transMatrix;
...
#endif //GEOSX_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_HYBRIDFVM_ELEMENTBASEDASSEMBLYKERNEL_HPP
