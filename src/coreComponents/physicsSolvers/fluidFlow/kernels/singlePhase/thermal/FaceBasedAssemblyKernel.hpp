...
#ifndef GEOSX_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_THERMAL_FACEBASEDASSEMBLYKERNEL_HPP
#define GEOSX_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_THERMAL_FACEBASEDASSEMBLYKERNEL_HPP
...
public:
                    ...
                    StackVariables & stack ) const
  {
    ...
    singlePhaseFVMKernels::FaceBasedAssemblyKernel< NUM_DOF, STENCILWRAPPER >::computeFlux( iconn, stack, [&]( localIndex const (&k)[2],
                 ...
                 StackVariables & stack ) const
  {
    ...
    singlePhaseFVMKernels::FaceBasedAssemblyKernel< NUM_DOF, STENCILWRAPPER >::complete( iconn, stack, [&]( integer const i,
                                                                                                            localIndex const localRow )
    {
      ...
      RAJA::atomicAdd( parallelDeviceAtomic{}, &m_localRhs[localRow + numEqn - 1], stack.localFlux[i * numEqn + numEqn - 1] );

      m_localMatrix.template addToRowBinarySearchUnsorted< parallelDeviceAtomic >( localRow + numEqn - 1,
...
#endif //GEOSX_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_THERMAL_FACEBASEDASSEMBLYKERNEL_HPP
