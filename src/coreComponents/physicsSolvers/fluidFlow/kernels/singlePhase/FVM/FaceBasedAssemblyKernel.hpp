...
#ifndef GEOS_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_FVM_FACEBASEDASSEMBLYKERNEL_HPP
#define GEOS_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_FVM_FACEBASEDASSEMBLYKERNEL_HPP
...
public:
   ...
   */
  FaceBasedAssemblyKernel( geos::globalIndex const rankOffset,
...
public:
    ...
    geos::localIndex const numFluxElems;

    // Transmissibility and derivatives

    /// Transmissibility
    geos::real64 transmissibility[maxNumConns][2]{};
    /// Derivatives of transmissibility with respect to pressure
    geos::real64 dTrans_dPres[maxNumConns][2]{};
...
#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_SINGLEPHASE_FVM_FACEBASEDASSEMBLYKERNEL_HPP
