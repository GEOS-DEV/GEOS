...
DirichletFluxComputeZFormulationKernel< NUM_COMP, IS_THERMAL, FLUID >::DirichletFluxComputeZFormulationKernel( integer const numPhases,
...
template< integer NUM_COMP, bool IS_THERMAL, typename FLUID >
GEOS_HOST_DEVICE
void DirichletFluxComputeZFormulationKernel< NUM_COMP, IS_THERMAL, FLUID >::setup( localIndex const iconn,
...
#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_COMPOSITIONAL_ZFORMULATION_DIRICHLETFLUXCOMPUTEZFORMULATIONKERNEL_IMPL_HPP
