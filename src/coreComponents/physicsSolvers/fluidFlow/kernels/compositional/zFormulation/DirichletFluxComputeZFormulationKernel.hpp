...
#ifndef GEOS_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_COMPOSITIONAL_ZFORMULATION_DIRICHLETFLUXCOMPUTEZFORMULATIONKERNEL_HPP
#define GEOS_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_COMPOSITIONAL_ZFORMULATION_DIRICHLETFLUXCOMPUTEZFORMULATIONKERNEL_HPP
 ...
 * @tparam IS_THERMAL flag indicating if the kernel is thermal or not
...
public:
  ...
  using FluidWrapper = typename FLUID::KernelWrapper;
...
public:
                   ...
                   arrayView1d< real64 > const & localRhs )
  {
    constitutive::constitutiveComponentUpdatePassThru( fluidBase, numComps, [&]( auto & fluid, auto NC )
    {
      ...
      using kernelType = DirichletFluxComputeZFormulationKernel< NUM_COMP, false, FluidType >;
...
#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_COMPOSITIONAL_ZFORMULATION_DIRICHLETFLUXCOMPUTEZFORMULATIONKERNEL_HPP
