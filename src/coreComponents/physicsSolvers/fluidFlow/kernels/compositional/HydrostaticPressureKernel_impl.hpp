...
#ifndef GEOS_PHYSICSSOLVERS_FLUIDFLOW_COMPOSITIONAL_HYDROSTATICPRESSUREKERNEL_IMPL_HPP
...
static real64 constexpr MIN_FOR_PHASE_PRESENCE = constitutive::MultiFluidConstants::minForSpeciesPresence;
static real64 constexpr MIN_FOR_COMP_PRESENCE = constitutive::MultiFluidConstants::minForSpeciesPresence;

template< typename FLUID_WRAPPER >
typename HydrostaticPressureKernel< FLUID_WRAPPER >::ReturnType
HydrostaticPressureKernel< FLUID_WRAPPER >::
...
template< typename FLUID_WRAPPER >
void
HydrostaticPressureKernel< FLUID_WRAPPER >:: mixingStep( integer const & numComps,
                                                         real64 const & a,
                                                         arraySlice1d< real64 const, compflow::USD_COMP - 1 > const & inputComposition,
                                                         arraySlice1d< real64 const, compflow::USD_COMP - 1 > const & addedCompFrac,
                                                         arraySlice1d< real64, compflow::USD_COMP - 1 > const & compFrac )
...
integer
HydrostaticPressureKernel< FLUID_WRAPPER >::
evaluateFlashPhaseIndex( integer const & numPhases,
                         integer const & ipGas,
                         integer const & ipOil,
                         integer const & ipWater,
                         integer const & ipInit,
...
void
HydrostaticPressureKernel< FLUID_WRAPPER >::
evaluatePrimaryAndContactPhaseIndices( integer const & numPhases,
                                       integer const & ipGas,
                                       integer const & ipOil,
                                       integer const & ipWater,
...
#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_COMPOSITIONAL_HYDROSTATICPRESSUREKERNEL_IMPL_HPP
