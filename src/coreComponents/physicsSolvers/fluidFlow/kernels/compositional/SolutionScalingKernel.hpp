 ...
 */
class SolutionScalingKernel :
  public fluidFlow::kernels::compositional::SolutionScalingAndCheckingKernelBase< real64 >
{
public:

  using Base = fluidFlow::kernels::compositional::SolutionScalingAndCheckingKernelBase< real64 >;
