...
#ifndef GEOS_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_COMPOSITIONAL_THERMALDIRICHLETFLUXCOMPUTEKERNEL_HPP
...
public:
  ...
  using Base = isothermalCompositionalMultiphaseFVMKernels::DirichletFluxComputeKernel< NUM_COMP, true, FLUID >;
  using Base::numComp;
  using Base::numDof;
  using Base::numEqn;
...
#endif //GEOS_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_COMPOSITIONAL_THERMALDIRICHLETFLUXCOMPUTEKERNEL_HPP
