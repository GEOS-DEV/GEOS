...
DirichletFluxComputeKernel< NUM_COMP, IS_THERMAL, FLUID >::DirichletFluxComputeKernel( integer const numPhases,
...
template< integer NUM_COMP, bool IS_THERMAL, typename FLUID >
GEOS_HOST_DEVICE
void DirichletFluxComputeKernel< NUM_COMP, IS_THERMAL, FLUID >::setup( localIndex const iconn,
...
template< integer NUM_COMP, bool IS_THERMAL, typename FLUID >
GEOS_HOST_DEVICE
void DirichletFluxComputeKernel< NUM_COMP, IS_THERMAL, FLUID >::computeFlux( localIndex const iconn,
...
template< integer NUM_COMP, bool IS_THERMAL, typename FLUID >
GEOS_HOST_DEVICE
void DirichletFluxComputeKernel< NUM_COMP, IS_THERMAL, FLUID >::complete( localIndex const iconn,
                                                                          StackVariables & stack,
