...
#ifndef GEOSX_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_THERMAL_FACEBASEDASSEMBLYKERNEL_HPP
#define GEOSX_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_THERMAL_FACEBASEDASSEMBLYKERNEL_HPP
...
public:
  ...
  using ThermalCompFlowAccessors =
    geos::StencilAccessors< geos::fields::flow::temperature >;

  using ThermalMultiFluidAccessors =
    geos::StencilMaterialAccessors< geos::constitutive::MultiFluidBase,
                                    geos::fields::multifluid::phaseEnthalpy,
                                    geos::fields::multifluid::dPhaseEnthalpy >;

  using ThermalConductivityAccessors =
    geos::StencilMaterialAccessors< geos::constitutive::MultiPhaseThermalConductivityBase,
                                    geos::fields::thermalconductivity::effectiveConductivity >;
  ...
  FaceBasedAssemblyKernel( geos::integer const numPhases,
    ...
    : Base( numPhases,
            ...
            localMatrix,
            localRhs ),
    m_temp( thermalCompFlowAccessors.get( geos::fields::flow::temperature {} ) ),
    m_phaseEnthalpy( thermalMultiFluidAccessors.get( geos::fields::multifluid::phaseEnthalpy {} ) ),
    m_dPhaseEnthalpy( thermalMultiFluidAccessors.get( geos::fields::multifluid::dPhaseEnthalpy {} ) ),
    m_thermalConductivity( thermalConductivityAccessors.get( geos::fields::thermalconductivity::effectiveConductivity {} ) )
  {}
...
public:
    ...
    GEOS_HOST_DEVICE
    StackVariables( geos::localIndex const size, geos::localIndex numElems )
    ...
    geos::real64 thermalTransmissibility[maxNumConns][2]{};
  };
...
#endif //GEOSX_PHYSICSSOLVERS_FLUIDFLOW_KERNELS_THERMAL_FACEBASEDASSEMBLYKERNEL_HPP
