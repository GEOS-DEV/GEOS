...
/**
 * @file SinglePhaseStateReset.cpp
 */

#include "SinglePhaseStateReset.hpp"
...
SinglePhaseStateReset::SinglePhaseStateReset( const string & name,
                                              Group * const parent ):
...
SinglePhaseStateReset::~SinglePhaseStateReset()
{}

void SinglePhaseStateReset::postProcessInput()
{
  ...
  m_flowSolver = &physicsSolverManager.getGroup< SinglePhaseBase >( m_flowSolverName );
}

bool SinglePhaseStateReset::execute( real64 const time_n,
