...
public:
  ...
  EFEMKernelsBase( NodeManager const & nodeManager,
    ...
    Base( nodeManager,
          ...
          inputRhs,
          inputGravityVector ),
    m_w( embeddedSurfSubRegion.getField< extrinsicMeshData::contact::dispJump >().toView() ),
    m_tractionVec( embeddedSurfSubRegion.getField< extrinsicMeshData::contact::traction >().toViewConst() ),
    m_dTraction_dJump( embeddedSurfSubRegion.getField< extrinsicMeshData::contact::dTraction_dJump >().toViewConst() ),
