...
//    unpackedSize += elemManager.Unpack( receiveBufferPtr, modifiedElements );
  ...
  std::map< std::pair< localIndex, localIndex >, std::set< localIndex > > & allNewElements = receivedObjects.newElements;
  std::map< std::pair< localIndex, localIndex >, std::set< localIndex > > & allModifiedElements = receivedObjects.modifiedElements;
                                  ...
                                  FaceElementSubRegion & faceElemSubRegion )
{
  ...
  std::map< localIndex, localIndex > & edgesToConnectorEdges = faceElemSubRegion.m_edgesTo2dFaces;
