...
public:
   ...
   * @param[in] indexList the list of local indices that need new global indices
   */
  void AssignNewGlobalIndicesSerial(
  ...
  inline string const getFractureRegionName() const
  {
