  ...
  m_mpiCommOrder( 0 )
{
  ...
  addLogLevel( "logLevel >= 1", "Print splitting node along separation plane faces" );
  addLogLevel( "logLevel >= 1", "Print splitting edge and face" );
  addLogLevel( "logLevel >= 2", "Print all elements attached to the nodeID" );
  addLogLevel( "logLevel >= 2", "Print all faces on their element" );
  addLogLevel( "logLevel >= 3", "Information on the consistency checking of the maps" );
