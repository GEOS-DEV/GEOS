                                                        ...
                                                        int mpiCommOrder )
{
  ...
  MPI_iCommData commData3( CommunicationTools::getInstance().getCommID() );
  ...
  {
    unpackNewAndModifiedObjectsDataOnGhosts( neighbor, commData2.commID(), mesh, receivedObjects );
  }
