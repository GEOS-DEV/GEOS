...
/**
 * @file MaterialPointMethod.hpp
 */

#ifndef GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MATERIALPOINTMETHOD_HPP_
#define GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MATERIALPOINTMETHOD_HPP_
 ...
 */
class MaterialPointMethod : public SolverBase
{
public:
...
//  {
////    QuasiStatic,      //!< QuasiStatic, NOT YET SUPPORTED
////    ImplicitDynamic,  //!< ImplicitDynamic, NOT YET SUPPORTED
...
//  };
   ...
   */
  MaterialPointMethod( const string & name,
                       Group * const parent );


  MaterialPointMethod( MaterialPointMethod const & ) = delete;
  MaterialPointMethod( MaterialPointMethod && ) = default;

  MaterialPointMethod & operator=( MaterialPointMethod const & ) = delete;
  MaterialPointMethod & operator=( MaterialPointMethod && ) = delete;

  /**
   * destructor
   */
  virtual ~MaterialPointMethod() override;
...
//ENUM_STRINGS( MaterialPointMethod::TimeIntegrationOption, "QuasiStatic", "ImplicitDynamic", "ExplicitDynamic" )
...
//                    typename FE_TYPE > class KERNEL_TEMPLATE,
//          typename ... PARAMS >
//void MaterialPointMethod::assemblyLaunch( DomainPartition & domain,
//                                                  DofManager const & dofManager,
//                                                  CRSMatrixView< real64, globalIndex const > const & localMatrix,
//                                                  arrayView1d< real64 > const & localRhs,
//                                                  PARAMS && ... params )
...
#endif /* GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MATERIALPOINTMETHOD_HPP_ */
