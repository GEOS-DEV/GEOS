...
#ifndef GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MPMKERNELS_HPP_
#define GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MPMKERNELS_HPP_
...
public:
   ...
   */
  MPMKernel( NodeManager const & nodeManager,
...
public:
   ...
   *
   * For the MPMKernel implementation, global values from the
...
#endif // GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MPMKERNELS_HPP_
