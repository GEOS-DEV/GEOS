...
#ifndef GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MPM_HPP_
#define GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MPM_HPP_
...
public:
  ...
  MPM( const string & name,
              Group * const parent );

  // Destructor
  virtual ~MPM() override;
...
/* REGISTERING NEW ENUMS:
   ...
   at the namespace scope (in this case, right after the ``MaterialPointMethod`` class definition is complete):
 */
//START_SPHINX_INCLUDE_05
ENUM_STRINGS( MPM::TimeIntegrationOption, "SteadyState", "ImplicitTransient", "ExplicitTransient" )
//END_SPHINX_INCLUDE_05

} /* namespace geosx */

#endif /* GEOSX_PHYSICSSOLVERS_MATERIALPOINTMETHOD_MPM_HPP_ */
