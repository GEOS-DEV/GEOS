...
//Integrate Function
RAJA_HOST_DEVICE
RAJA_INLINE void Integrate(real64 f_local[LOCAL_DIM*NUM_NODES],real64 idetJ, real64 detF, real64 Finv[LOCAL_DIM][LOCAL_DIM],
...
//Integrate Function
RAJA_HOST_DEVICE
RAJA_INLINE void Integrate(real64 f_local_x[NUM_NODES], real64 f_local_y[NUM_NODES], real64 f_local_z[NUM_NODES],
...
//Integrate Function
RAJA_HOST_DEVICE
RAJA_INLINE void Integrate(real64 f_local[LOCAL_DIM * NUM_NODES],
                           real64 idetJ, real64 detF, geosxData Finv_ptr,
...
RAJA_HOST_DEVICE
RAJA_INLINE void Integrate(real64 f_local[LOCAL_DIM*NUM_NODES],real64 idetJ, real64 detF, real64 Finv[LOCAL_DIM][LOCAL_DIM],
                           real64 TotalStress[LOCAL_DIM][LOCAL_DIM], real64 dNdX[QUAD_PTS][NUM_NODES][LOCAL_DIM],
...
RAJA_INLINE void Integrate(real64 f_local_x[NUM_NODES],real64 f_local_y[NUM_NODES],real64 f_local_z[NUM_NODES],
                           real64 idetJ, real64 detF, real64 Finv[LOCAL_DIM][LOCAL_DIM],
                           real64 TotalStress[LOCAL_DIM][LOCAL_DIM],real64 dNdX_x[QUAD_PTS][NUM_NODES],
                           real64 dNdX_y[QUAD_PTS][NUM_NODES],real64 dNdX_z[QUAD_PTS][NUM_NODES],
                           localIndex q) 
{
  //---------[Integrate - Function]---------------------
  real64 const integrationFactor = idetJ*detF;
...
RAJA_HOST_DEVICE
RAJA_INLINE void AddLocalToGlobal(T nodeList, real64 f_local[LOCAL_DIM*NUM_NODES], geosxData iacc)
{
  for(localIndex a=0; a<NUM_NODES; ++a)
    {          
      localIndex id = nodeList[a];
...
RAJA_INLINE void AddLocalToGlobal(T nodeList,
                                  real64 f_local_x[NUM_NODES],real64 f_local_y[NUM_NODES],real64 f_local_z[NUM_NODES],
...
RAJA_INLINE void CalculateGradient(real64 dUdX[3][3],
                                   real64 u_local_x[8], real64 u_local_y[8], real64 u_local_z[8],
                                   real64 idNdX_x[QUAD_PTS][NUM_NODES],
                                   real64 idNdX_y[QUAD_PTS][NUM_NODES],
                                   real64 idNdX_z[QUAD_PTS][NUM_NODES],
...
RAJA_HOST_DEVICE
RAJA_INLINE void CalculateGradient(real64 dUdX[3][3], real64 u_local[24],
                                   real64 dNdX[QUAD_PTS][NUM_NODES][LOCAL_DIM], localIndex q){
