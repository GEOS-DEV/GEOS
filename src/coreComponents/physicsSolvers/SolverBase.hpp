...
public:
  ...
  CRSMatrixView<real64 const, globalIndex const> const &getLocalMatrix() const
  {
  ...
  arrayView1d<real64 const> const &getLocalRhs() const
  {
  ...
  arrayView1d<real64 const> const &getLocalSolution() const
  {
   ...
   * T
   */
  virtual void SetNextDt(real64 const &currentDt, real64 &nextDt);
   ...
   * T
   */
  void SetNextDtBasedOnNewtonIter(real64 const &currentDt, real64 &nextDt);
   ...
   */
  void DebugOutputSystem(real64 const &time,
                         integer const cycleNumber,
   ...
   */
  void DebugOutputSolution(real64 const &time,
                           integer const cycleNumber,
                           integer const nonlinearIteration,
  ...
  real64 GetTimestepRequest() { return m_nextDt; };
  ...
  arrayView1d<string const> const &targetRegionNames() const
  {
...
protected:
  ...
  static BASETYPE const &GetConstitutiveModel(dataRepository::Group const &dataGroup,
                                              LOOKUP_TYPE const &key);

  template <typename BASETYPE = constitutive::ConstitutiveBase, typename LOOKUP_TYPE>
  static BASETYPE &GetConstitutiveModel(dataRepository::Group &dataGroup,
                                        LOOKUP_TYPE const &key);
...
BASETYPE const &SolverBase::GetConstitutiveModel(dataRepository::Group const &dataGroup,
                                                 LOOKUP_TYPE const &key)
{
...
template <typename BASETYPE, typename LOOKUP_TYPE>
BASETYPE &SolverBase::GetConstitutiveModel(dataRepository::Group &dataGroup,
                                           LOOKUP_TYPE const &key)
{
...
void SolverBase::ValidateModelMapping(
