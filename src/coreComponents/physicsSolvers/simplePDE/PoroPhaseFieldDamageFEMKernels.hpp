...
/**
 * @file PoroPhaseFieldDamageKernels.hpp
 */

#ifndef GEOSX_PHYSICSSOLVERS_SIMPLEPDE_POROPHASEFIELDDAMAGEKERNELS_HPP_
#define GEOSX_PHYSICSSOLVERS_SIMPLEPDE_POROPHASEFIELDDAMAGEKERNELS_HPP_
...
template< typename SUBREGION_TYPE,
          ...
          typename FE_TYPE >
class PoroPhaseFieldDamageKernel :
...
public:
   ...
   */
  PoroPhaseFieldDamageKernel( NodeManager const & nodeManager,
...
public:
   ...
   *
   * For the PoroPhaseFieldDamageKernel implementation, global values from the
                              ...
                              StackVariables & stack ) const
  {
    ...
    real64 strain[6] = {0};
    m_constitutiveUpdate.getElasticStrain( k, q, strain );
...
#endif // GEOSX_PHYSICSSOLVERS_SIMPLEPDE_POROPHASEFIELDDAMAGEKERNELS_HPP_
