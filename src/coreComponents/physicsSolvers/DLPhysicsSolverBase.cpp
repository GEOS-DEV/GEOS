...
namespace geos
{
                                                    ...
                                                    DomainPartition &domain)
  {
    ...
    GEOS_LOG_LEVEL_RANK_0(logInfo::NonlinearSolver,
                          GEOS_FMT("--CustomLog--DLPhysicsSolverBase::nonlinearImplicitStep  maxNumberDtCuts:{} dtCutFactor:{} allowNonConverged:{} dtAttempt:{} maxConfigurationIter:{} configurationLoopIter:{} ",
                                                        ...
                                                        DomainPartition &domain)
  {
    ...
    for (newtonIter = 0; newtonIter < maxNewtonIter; ++newtonIter)
    {
      ...
      // if (m_nonlinearSolverParameters.m_lineSearchAction != NonlinearSolverParameters::LineSearchAction::None && residualNorm > lastResidual * m_nonlinearSolverParameters.m_lineSearchResidualFactor && newtonIter >= m_nonlinearSolverParameters.m_lineSearchStartingIteration)
      // {
