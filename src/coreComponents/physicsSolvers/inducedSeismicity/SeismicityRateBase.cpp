...
real64 SeismicityRateBase::solverStep( real64 const & time_n,
                                  real64 const & dt,
 ...
 */
void SeismicityRateBase::implicitStepSetup( real64 const & GEOS_UNUSED_PARAM( time_n ),
...
void SeismicityRateBase::implicitStepComplete( real64 const & GEOS_UNUSED_PARAM( time_n ),
                                          real64 const & GEOS_UNUSED_PARAM( dt ),
                                          DomainPartition & GEOS_UNUSED_PARAM( domain ) )
{}

void SeismicityRateBase::setupDofs( DomainPartition const & GEOS_UNUSED_PARAM( domain ),
...
void SeismicityRateBase::applySystemSolution( DofManager const & dofManager,
...
void SeismicityRateBase::updateState( DomainPartition & domain )
{
 ...
 */
void SeismicityRateBase::applyBoundaryConditions( real64 const time_n,
                                             real64 const dt,
                                             DomainPartition & domain,
...
void SeismicityRateBase::resetStateToBeginningOfStep( DomainPartition & GEOS_UNUSED_PARAM( domain ) )
{}
