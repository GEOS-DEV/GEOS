...
public:
  ...
  SinglePhase( NodeManager const & nodeManager,
    ...
    m_fluidPressure_n( elementSubRegion.template getField< extrinsicMeshData::flow::pressure_n >() ),
    m_fluidPressure( elementSubRegion.template getField< extrinsicMeshData::flow::pressure >() )
  {}
