...
//      elemManager.constructMaterialViewAccessor< array1d< real64 >, arrayView1d< real64 const > >(
// ElasticIsotropic::viewKeyStruct::bulkModulusString(),
...
//      elemManager.constructMaterialViewAccessor< array1d< real64 >, arrayView1d< real64 const > >(
// ElasticIsotropic::viewKeyStruct::shearModulusString(),
//                                                                                                   m_contactSolver->getSolidSolver()->targetRegionNames(),
//                                                                                                   m_contactSolver->getSolidSolver()->solidMaterialNames()
// );
