...
void CompositionalMultiphaseReservoir::ComputeAllPerforationRates( WellElementSubRegion * const subRegion )
{
  ...
  arrayView2d< real64 const > const &
  dWellElemMixtureDensity_dComp = subRegion->getReference< array2d< real64 > >(
    CompositionalMultiphaseWell::viewKeyStruct::dMixtureDensity_dGlobalCompDensityString );
  ...
  arrayView3d< real64 const > const &
  dWellElemCompFrac_dCompDens = subRegion->getReference< array3d< real64 > >(
    CompositionalMultiphaseWell::viewKeyStruct::dGlobalCompFraction_dGlobalCompDensityString );
