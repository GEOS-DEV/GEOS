...
public:
  ...
  SinglePhase( NodeManager const & nodeManager,
    ...
    m_deltaDisp( nodeManager.getField< extrinsicMeshData::solidMechanics::incrementalDisplacement >() ),
    m_w( embeddedSurfSubRegion.getField< extrinsicMeshData::contact::dispJump >() ),
    ...
    m_matrixPressure( elementSubRegion.template getField< extrinsicMeshData::flow::pressure >() ),
    m_porosity_n( inputConstitutiveType.getPorosity_n() ),
    m_tractionVec( embeddedSurfSubRegion.getField< extrinsicMeshData::contact::traction >() ),
    m_dTraction_dJump( embeddedSurfSubRegion.getField< extrinsicMeshData::contact::dTraction_dJump >() ),
    m_dTraction_dPressure( embeddedSurfSubRegion.getField< extrinsicMeshData::contact::dTraction_dPressure >() ),
    ...
    m_deltaVolume( elementSubRegion.template getField< extrinsicMeshData::flow::deltaVolume >() ),
