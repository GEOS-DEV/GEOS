...
void FlowProppantTransportSolver::PreStepUpdate( real64 const & timeN,
                                                 real64 const & dt,
                                                 DomainPartition & domain )
{
  ...
  m_proppantSolver->ImplicitStepSetup( timeN, dt, domain );

  m_proppantSolver->PreStepUpdate( timeN, dt, domain );

}

void FlowProppantTransportSolver::PostStepUpdate( real64 const & timeN,
                                                  real64 const & dt,
                                                  DomainPartition & domain )
{
  m_flowSolver->ImplicitStepComplete( timeN, dt, domain );
  m_proppantSolver->ImplicitStepComplete( timeN, dt, domain );
  m_proppantSolver->PostStepUpdate( timeN, dt, domain );
}
...
real64 FlowProppantTransportSolver::SolverStep( real64 const & timeN,
                                                real64 const & dt,
                                                ...
                                                DomainPartition & domain )
{
  ...
  while( iter < this->m_nonlinearSolverParameters.m_maxIterNewton )
  {
    ...
    dtReturnTemporary = m_proppantSolver->NonlinearImplicitStep( timeN, dtReturn, cycleNumber, domain );
