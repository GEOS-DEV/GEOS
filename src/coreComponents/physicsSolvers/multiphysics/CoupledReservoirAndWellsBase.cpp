                               ...
                               DomainPartition const & domain )
{
  ...
  GEOSX_THROW_IF_IF( !badPerforation.first.empty(),
                  GEOS_FMT( "The well {} has a connection to the region {} which is not targeted by the solver", badPerforation.first, badPerforation.second ),
                  std::runtime_error );
