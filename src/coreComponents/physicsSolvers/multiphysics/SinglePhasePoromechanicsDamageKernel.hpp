...
#ifndef GEOSX_PHYSICSSOLVERS_MULTIPHYSICS_SINGLEPHASEPOROMECHANICSDAMAGEKERNEL_HPP_
#define GEOSX_PHYSICSSOLVERS_MULTIPHYSICS_SINGLEPHASEPOROMECHANICSDAMAGEKERNEL_HPP_
...
/**
 * ### SinglePhasePoromechanicsDamage Description
...
public:
                              ...
                              StackVariables & stack ) const
  {
    ...
    // ---------------------------------
    //
    //   divergence( totalStress ) + fractureFlowTerm + bodyForce = 0   (quasi-static linear momentum balance)
    ...
    //
    //   Rmom = - \int symmetricGradient( \eta ) : totalStress + \int \eta \cdot fractureFlowTerm + \int \eta \cdot bodyForce = 0
