...
private:
  ...
  /// Row offset, in m_dR_dAper, of the mass-balance block for this mesh target (0 when the caller does
  /// not distinguish mesh targets, e.g. a single-mesh-body problem).
