...
typedef PoromechanicsInitialization< SinglePhasePoromechanicsConformingFractures< SinglePhaseBase > > SinglePhasePoromechanicsConformingFracturesInitialization;
