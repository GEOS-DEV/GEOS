...
IFENNPoromechanics< FLOW_SOLVER, MECHANICS_SOLVER >::IFENNPoromechanics( const string & name,
                                                                         Group * const parent )
  : Base( name, parent ),
  m_damageFlag()
{
...
template< typename FLOW_SOLVER, typename MECHANICS_SOLVER >
void IFENNPoromechanics< FLOW_SOLVER, MECHANICS_SOLVER >::setupSystem( DomainPartition & domain,
...
template< typename FLOW_SOLVER, typename MECHANICS_SOLVER >
void IFENNPoromechanics< FLOW_SOLVER, MECHANICS_SOLVER >::initializePostInitialConditionsPreSubGroups()
{
...
template<>
void IFENNPoromechanics<>::setMGRStrategy()
{
  LinearSolverParameters & linearSolverParameters = this->m_linearSolverParameters.get();
...
// template<>
// void IFENNPoromechanics< SinglePhaseReservoirAndWells<>, SolidMechanicsLagrangianFEM >::setMGRStrategy()
// {
//   // same as SinglePhaseReservoirAndWells< IFENNPoromechanics<> >::setMGRStrategy
...
//   // TODO: Check removal of the whole method
...
template< typename FLOW_SOLVER, typename MECHANICS_SOLVER >
void IFENNPoromechanics< FLOW_SOLVER, MECHANICS_SOLVER >::assembleElementBasedTerms( real64 const time_n,
                                                                                     real64 const dt,
                                                                                     DomainPartition & domain,
                                                                                     DofManager const & dofManager,
                                                                                     CRSMatrixView< real64, globalIndex const > const & localMatrix,
                                                                                     arrayView1d< real64 > const & localRhs )
{
                                                                                 ...
                                                                                 string_array const & regionNames )
  {
    ...
    string const flowDofKey = dofManager.getKey( DLSinglePhaseBase::viewKeyStruct::elemDofFieldString() );
...
IFENNPoromechanics< FLOW_SOLVER, MECHANICS_SOLVER >::createPreconditioner( DomainPartition & domain ) const
{
  ...
  switch( linParams.preconditionerType )
  {
    case LinearSolverParameters::PreconditionerType::block:
    {
      ...
      precond->setupBlock( linParams.block.order[toUnderlying( Base::SolverType::Flow )],
                           { { DLSinglePhaseBase::viewKeyStruct::elemDofFieldString(), { 1, true } } },
...
template< typename FLOW_SOLVER, typename MECHANICS_SOLVER >
void IFENNPoromechanics< FLOW_SOLVER, MECHANICS_SOLVER >::updateBulkDensity( ElementSubRegionBase & subRegion )
{
...
template class IFENNPoromechanics<>;
template class IFENNPoromechanics< DLSinglePhaseBase, SolidMechanicsLagrangeContact >;
template class IFENNPoromechanics< DLSinglePhaseBase, SolidMechanicsEmbeddedFractures >;
// template class IFENNPoromechanics< SinglePhaseReservoirAndWells<> >;
// template class IFENNPoromechanics< SinglePhaseReservoirAndWells<>, SolidMechanicsLagrangeContact >;
//template class IFENNPoromechanics< SinglePhaseReservoirAndWells<>, SolidMechanicsEmbeddedFractures >;

namespace
{
// typedef IFENNPoromechanics< SinglePhaseReservoirAndWells<> > IFENNReservoirPoromechanics;
// REGISTER_CATALOG_ENTRY( PhysicsSolverBase, IFENNReservoirPoromechanics, string const &, Group * const )
typedef IFENNPoromechanics<> IFENNPoromechanicsDefault;
REGISTER_CATALOG_ENTRY( PhysicsSolverBase, IFENNPoromechanicsDefault, string const &, Group * const )
}
