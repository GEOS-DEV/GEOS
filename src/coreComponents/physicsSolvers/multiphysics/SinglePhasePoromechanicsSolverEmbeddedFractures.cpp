...
SinglePhasePoromechanicsSolverEmbeddedFractures::SinglePhasePoromechanicsSolverEmbeddedFractures( string const & name,
                                                                                                  Group * const parent ):
...
REGISTER_CATALOG_ENTRY( SolverBase, SinglePhasePoromechanicsSolverEmbeddedFractures, string const &, Group * const )
