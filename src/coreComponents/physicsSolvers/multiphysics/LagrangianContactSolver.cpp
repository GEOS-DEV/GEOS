...
void LagrangianContactSolver::RegisterDataOnMesh(
  dataRepository::Group *const MeshBodies)
{
  for(auto &mesh : MeshBodies->GetSubGroups())
  {
    ...
    elemManager->forElementRegions<FaceElementRegion>([&](FaceElementRegion &region) {
      region.forElementSubRegions<FaceElementSubRegion>([&](FaceElementSubRegion
                                                              &subRegion) {
        subRegion
...
void LagrangianContactSolver::InitializePostInitialConditions_PreSubGroups(
...
void LagrangianContactSolver::ComputeTolerances(DomainPartition &domain) const
{
  ...
  ElementRegionManager::ElementViewAccessor<NodeMapViewType>::ViewTypeConst const
    &elemToNodeView = elemToNode.toViewConst();
...
real64 LagrangianContactSolver::ExplicitStep(
...
bool LagrangianContactSolver::LineSearch(
  real64 const &time_n,
  real64 const &dt,
...
void LagrangianContactSolver::AssembleSystem(
  real64 const time,
  real64 const dt,
  DomainPartition &domain,
  DofManager const &dofManager,
...
void LagrangianContactSolver::ApplyBoundaryConditions(
  real64 const time,
  real64 const dt,
  DomainPartition &domain,
  DofManager const &dofManager,
...
real64 LagrangianContactSolver::CalculateResidualNorm(
...
void LagrangianContactSolver::AssembleForceResidualDerivativeWrtTraction(
  DomainPartition &domain,
  DofManager const &dofManager,
  CRSMatrixView<real64, globalIndex const> const &localMatrix,
  arrayView1d<real64> const &localRhs)
...
void LagrangianContactSolver::AssembleTractionResidualDerivativeWrtDisplacementAndTraction(
  DomainPartition const &domain,
  DofManager const &dofManager,
  CRSMatrixView<real64, globalIndex const> const &localMatrix,
  arrayView1d<real64> const &localRhs)
...
void LagrangianContactSolver::AssembleStabilization(
  DomainPartition const &domain,
  DofManager const &dofManager,
  CRSMatrixView<real64, globalIndex const> const &localMatrix,
  arrayView1d<real64> const &localRhs)
...
void LagrangianContactSolver::ApplySystemSolution(
  DofManager const &dofManager,
  arrayView1d<real64 const> const &localSolution,
...
void LagrangianContactSolver::SetFractureStateForElasticStep(
...
bool LagrangianContactSolver::IsFractureAllInStickCondition(
...
void LagrangianContactSolver::ComputeFractureStateStatistics(
  DomainPartition const &domain,
...
void LagrangianContactSolver::SetNextDt(real64 const &currentDt, real64 &nextDt)
{
  nextDt = currentDt;
}
