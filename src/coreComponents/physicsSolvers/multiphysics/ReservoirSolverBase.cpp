...
void ReservoirSolverBase::InitializePostInitialConditions_PreSubGroups(
...
void ReservoirSolverBase::AddCouplingNumNonzeros(
  DomainPartition& domain,
...
void ReservoirSolverBase::AssembleSystem(
  real64 const time_n,
  real64 const dt,
  DomainPartition& domain,
...
void ReservoirSolverBase::ApplyBoundaryConditions(
  real64 const time_n,
  real64 const dt,
  DomainPartition& domain,
  DofManager const& dofManager,
...
real64 ReservoirSolverBase::CalculateResidualNorm(
  DomainPartition const& domain,
  DofManager const& dofManager,
...
bool ReservoirSolverBase::CheckSystemSolution(
  DomainPartition const& domain,
  DofManager const& dofManager,
...
void ReservoirSolverBase::ApplySystemSolution(
  DofManager const& dofManager,
  arrayView1d<real64 const> const& localSolution,
  real64 const scalingFactor,
  DomainPartition& domain)
...
void ReservoirSolverBase::ResetViews(
  DomainPartition* const GEOSX_UNUSED_PARAM(domain))
{ }

real64 ReservoirSolverBase::ScalingForSystemSolution(
  DomainPartition const& domain,
  DofManager const& dofManager,
  arrayView1d<real64 const> const& localSolution)
{
