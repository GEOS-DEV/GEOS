                                        ...
                                        DomainPartition * const domain )
{
  ...
  else if( m_couplingTypeOption == couplingTypeOption::FIM )
  {
	...
	//TJ: find the location of the tip boundary
        ...
        real64 const tipElmtSize = sqrt(tipElmtArea);
	...
	m_convergedTipLoc = m_newTipLocation;
      ...
      //TJ: solve with tip iteration, m_tipIterationFlag=false
      else
      {
...
// The following code is just back up for several methods


// manipulate nodal displacement at the newly split nodes as essential B.C.
real64 HydrofractureSolver::SolverStepManipulateBC( real64 const & time_n,
                                        real64 const & dt,
                                        int const cycleNumber,
                                        DomainPartition * const domain )
{
