  ...
  m_numComponents( 0 )
{
  ...
  RegisterViewWrapper( viewKeyStruct::temperatureString, &m_temperature, false )->
    setDescription("Temperature")->
    setInputFlag(InputFlags::REQUIRED);

  RegisterViewWrapper( viewKeyStruct::useMassFlagString, &m_useMass, false )->
    setDefaultValue(0)->
    setDescription("Use mass formulation instead of molar")->
    setInputFlag(InputFlags::OPTIONAL);

  RegisterViewWrapper( viewKeyStruct::relPermNameString, &m_relPermName,  false )->
    setDescription("Name of the relative permeability constitutive model to use")->
    setInputFlag(InputFlags::REQUIRED);

  RegisterViewWrapper( viewKeyStruct::relPermIndexString, &m_relPermIndex, false );
}
