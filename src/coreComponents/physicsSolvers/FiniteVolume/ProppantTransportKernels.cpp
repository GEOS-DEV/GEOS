...
Launch<CellElementStencilTPFA>( CellElementStencilTPFA const & GEOSX_UNUSED_ARG(stencil),
				...
				FluxKernel::MaterialView< arrayView1d<integer const> > const & GEOSX_UNUSED_ARG( isProppantMobile ),	  
...
Launch<FaceElementStencil>( FaceElementStencil const & stencil,
			    ...
			    FluxKernel::MaterialView< arrayView1d<integer const> > const & isProppantMobile,	  
			    ...
			    FluxKernel::ElementView< arrayView1d<R1Tensor> > const & shearRate,
                            ParallelMatrix * const jacobian,
                            ParallelVector * const residual )
{
