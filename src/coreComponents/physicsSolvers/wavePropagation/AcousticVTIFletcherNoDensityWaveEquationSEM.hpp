...
/**
 * @file AcousticVTIFletcherNoDensityWaveEquationSEM.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICVTIFLETCHERNODENSITYWAVEEQUATIONSEM_HPP_
#define GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICVTIFLETCHERNODENSITYWAVEEQUATIONSEM_HPP_
...
class AcousticVTIFletcherNoDensityWaveEquationSEM : public WaveSolverBase
{
public:
  ...
  AcousticVTIFletcherNoDensityWaveEquationSEM( const std::string & name,
                                               Group * const parent );

  static string catalogName() { return "AcousticVTIFletcherNoDensitySEM"; }
  /**
...
#endif /* GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_AcousticVTIFletcherNoDensityWaveEquationSEM_HPP_ */
