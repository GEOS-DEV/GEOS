...
/**
 * @file Bis_AcousticVTIZhangWaveEquationSEM.cpp
 */

#include "Bis_AcousticVTIZhangWaveEquationSEM.hpp"
#include "Bis_AcousticVTIZhangWaveEquationSEMKernel.hpp"
...
Bis_AcousticVTIZhangWaveEquationSEM::Bis_AcousticVTIZhangWaveEquationSEM( const std::string & name,
                                                  Group * const parent ):
  WaveSolverBase( name,
                  parent )
{
...
Bis_AcousticVTIZhangWaveEquationSEM::~Bis_AcousticVTIZhangWaveEquationSEM()
{
  // TODO Auto-generated destructor stub
}

void Bis_AcousticVTIZhangWaveEquationSEM::initializePreSubGroups()
{
  WaveSolverBase::initializePreSubGroups();
}


void Bis_AcousticVTIZhangWaveEquationSEM::registerDataOnMesh( Group & meshBodies )
{
...
void Bis_AcousticVTIZhangWaveEquationSEM::postProcessInput()
{
...
void Bis_AcousticVTIZhangWaveEquationSEM::precomputeSourceAndReceiverTerm( MeshLevel & mesh,
                                                               arrayView1d< string const > const & regionNames )
{
                                                                                        ...
                                                                                        CellElementSubRegion & elementSubRegion )
  {
    ...
    finiteElement::FiniteElementDispatchHandler< SEM_FE_TYPES >::dispatch3D( fe, [&] ( auto const finiteElement )
    {
      ...
      {
        GEOS_MARK_SCOPE( Bis_acousticVTIZhangWaveEquationSEMKernels::PrecomputeSourceAndReceiverKernel );
...
void Bis_AcousticVTIZhangWaveEquationSEM::addSourceToRightHandSide( integer const & cycleNumber, arrayView1d< real32 > const rhs )
{
...
void Bis_AcousticVTIZhangWaveEquationSEM::initializePostInitialConditionsPreSubGroups()
{
  GEOS_MARK_FUNCTION;
  {
  ...
  if( m_usePML )
  {
    Bis_AcousticVTIZhangWaveEquationSEM::initializePML(); //TODO:
  }
...
void Bis_AcousticVTIZhangWaveEquationSEM::precomputeSurfaceFieldIndicator( DomainPartition & domain )
{
...
void Bis_AcousticVTIZhangWaveEquationSEM::applyFreeSurfaceBC( real64 time, DomainPartition & domain )
{
  GEOS_MARK_FUNCTION;
  FieldSpecificationManager & fsManager = FieldSpecificationManager::getInstance();
  FunctionManager const & functionManager = FunctionManager::getInstance();
...
void Bis_AcousticVTIZhangWaveEquationSEM::initializePML()
{
  GEOS_ERROR( "This option is not supported yet" );
  return;
}
...
void Bis_AcousticVTIZhangWaveEquationSEM::applyPML( real64 const time, DomainPartition & domain )
{
  GEOS_ERROR( "This option is not supported yet" );
  return;
}

real64 Bis_AcousticVTIZhangWaveEquationSEM::explicitStepForward( real64 const & time_n,
                                                     real64 const & dt,
                                                     integer cycleNumber,
...
real64 Bis_AcousticVTIZhangWaveEquationSEM::explicitStepBackward( real64 const & time_n,
                                                      real64 const & dt,
                                                      integer cycleNumber,
                                                      DomainPartition & domain,
                                                      bool computeGradient )
...
void Bis_AcousticVTIZhangWaveEquationSEM::prepareNextTimestep( MeshLevel & mesh )
{
  NodeManager & nodeManager = mesh.getNodeManager();
...
void Bis_AcousticVTIZhangWaveEquationSEM::computeUnknowns( real64 const & time_n,
                                               real64 const & dt,
                                               integer cycleNumber,
                                               DomainPartition & domain,
                                               MeshLevel & mesh,
                                               arrayView1d< string const > const & regionNames )
{
  ...
  auto kernelFactory = Bis_acousticVTIZhangWaveEquationSEMKernels::ExplicitBISAcousticVTIZhangSEMFactory( dt );
...
void Bis_AcousticVTIZhangWaveEquationSEM::synchronizeUnknowns( real64 const & time_n,
                                                   real64 const & dt,
                                                   integer const,
                                                   DomainPartition & domain,
                                                   MeshLevel & mesh,
...
real64 Bis_AcousticVTIZhangWaveEquationSEM::explicitStepInternal( real64 const & time_n,
                                                      real64 const & dt,
...
void Bis_AcousticVTIZhangWaveEquationSEM::cleanup( real64 const time_n,
                                       integer const cycleNumber,
...
REGISTER_CATALOG_ENTRY( SolverBase, Bis_AcousticVTIZhangWaveEquationSEM, string const &, dataRepository::Group * const )
