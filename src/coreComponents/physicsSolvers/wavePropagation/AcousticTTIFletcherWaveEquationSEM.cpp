...
void AcousticTTIFletcherWaveEquationSEM::registerDataOnMesh( Group & meshBodies )
{
                                                    ...
                                                    arrayView1d< string const > const & )
  {
    ...
    elemManager.forElementSubRegions< CellElementSubRegion >( [&]( CellElementSubRegion & subRegion )
    {
      ...
      subRegion.registerField< fields::acousticttifields::AcousticSigma >( getName() );
                                                                         ...
                                                                         arrayView1d< string const > const & regionNames )
{
                                                                                        ...
                                                                                        CellElementSubRegion & elementSubRegion )
  {
    ...
    finiteElement::FiniteElementDispatchHandler< SEM_FE_TYPES >::dispatch3D( fe, [&] ( auto const finiteElement )
    {
      ...
      acousticTTIFletcherWaveEquationSEMKernels::
...
void AcousticTTIFletcherWaveEquationSEM::initializePostInitialConditionsPreSubGroups()
{
                                                                ...
                                                                arrayView1d< string const > const & regionNames )
  {
                                                                                          ...
                                                                                          CellElementSubRegion & elementSubRegion )
    {
      ...
      arrayView1d< real32 const > const vti_sigma    = elementSubRegion.getField< fields::acousticttifields::AcousticSigma >();
      ...
      finiteElement::FiniteElementDispatchHandler< SEM_FE_TYPES >::dispatch3D( fe, [&] ( auto const finiteElement )
      {
        ...
        acousticTTIFletcherWaveEquationSEMKernels::MassMatrixKernel< FE_TYPE > kernelM( finiteElement );
        ...
        acousticTTIFletcherWaveEquationSEMKernels::DampingMatrixKernel< FE_TYPE > kernelD( finiteElement );
