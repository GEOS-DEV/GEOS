...
/**
 * @file AcousticPODKernel.hpp
 */

#ifndef GEOSX_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICPODKERNEL_HPP_
#define GEOSX_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICPODKERNEL_HPP_
...
template< typename SUBREGION_TYPE,
          ...
          typename FE_TYPE >
class ExplicitAcousticPOD : public finiteElement::KernelBase< SUBREGION_TYPE,
                                                              CONSTITUTIVE_TYPE,
                                                              FE_TYPE,
                                                              1,
                                                              1 >
...
//*****************************************************************************
   ...
   */
  ExplicitAcousticPOD( NodeManager & nodeManager,
...
using ExplicitAcousticPODFactory = finiteElement::KernelFactory< ExplicitAcousticPOD,
                                                                 real64 >;
...
#endif //GEOSX_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICPODKERNEL_HPP_
