...
/**
 * @file AcousticVTIFletcherNoDensityWaveEquationSEMKernel.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICVTIFLETCHERNODENSITYWAVEEQUATIONSEMKERNEL_HPP_
#define GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICVTIFLETCHERNODENSITYWAVEEQUATIONSEMKERNEL_HPP_
...
/**
 * @brief Implements kernels for solving the acoustic wave equations in a VTI medium
 *   explicit central FD method and SEM
 * @copydoc geos::finiteElement::KernelBase
 * @tparam SUBREGION_TYPE The type of subregion that the kernel will act on.
 *
 * ### AcousticVTIFletcherNoDensityWaveEquationSEMKernel Description
...
//*****************************************************************************
  ...
  ExplicitAcousticVTIFletcherNoDensitySEM( NodeManager & nodeManager,
    ...
    m_vti_sigma( elementSubRegion.template getField< fields::wavesolverfields::AcousticSigma >() ),
    m_dt( dt )
  {
   ...
   *
   * ### ExplicitAcousticVTIFletcherNoDensitySEM Description
...
#endif //GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_ACOUSTICVTIFLETCHERNODENSITYWAVEEQUATIONSEMKERNEL_HPP_
