...
/**
 * @file Bis_AcousticVTIFletcherWaveEquationSEM.cpp
 */

#include "Bis_AcousticVTIFletcherWaveEquationSEM.hpp"
#include "Bis_AcousticVTIFletcherWaveEquationSEMKernel.hpp"
...
Bis_AcousticVTIFletcherWaveEquationSEM::Bis_AcousticVTIFletcherWaveEquationSEM( const std::string & name,
                                                  Group * const parent ):
  WaveSolverBase( name,
                  parent )
{
...
Bis_AcousticVTIFletcherWaveEquationSEM::~Bis_AcousticVTIFletcherWaveEquationSEM()
{
  // TODO Auto-generated destructor stub
}

void Bis_AcousticVTIFletcherWaveEquationSEM::initializePreSubGroups()
{
  WaveSolverBase::initializePreSubGroups();
}


void Bis_AcousticVTIFletcherWaveEquationSEM::registerDataOnMesh( Group & meshBodies )
{
...
void Bis_AcousticVTIFletcherWaveEquationSEM::postProcessInput()
{
...
void Bis_AcousticVTIFletcherWaveEquationSEM::precomputeSourceAndReceiverTerm( MeshLevel & mesh,
                                                               arrayView1d< string const > const & regionNames )
{
                                                                                        ...
                                                                                        CellElementSubRegion & elementSubRegion )
  {
    ...
    finiteElement::FiniteElementDispatchHandler< SEM_FE_TYPES >::dispatch3D( fe, [&] ( auto const finiteElement )
    {
      ...
      {
        GEOS_MARK_SCOPE( Bis_acousticVTIFletcherWaveEquationSEMKernels::PrecomputeSourceAndReceiverKernel );
...
void Bis_AcousticVTIFletcherWaveEquationSEM::addSourceToRightHandSide( integer const & cycleNumber, arrayView1d< real32 > const rhs )
{
...
void Bis_AcousticVTIFletcherWaveEquationSEM::initializePostInitialConditionsPreSubGroups()
{
  GEOS_MARK_FUNCTION;
  {
  ...
  if( m_usePML )
  {
    Bis_AcousticVTIFletcherWaveEquationSEM::initializePML();
  }
...
void Bis_AcousticVTIFletcherWaveEquationSEM::precomputeSurfaceFieldIndicator( DomainPartition & domain )
{
...
void Bis_AcousticVTIFletcherWaveEquationSEM::applyFreeSurfaceBC( real64 time, DomainPartition & domain )
{
  GEOS_MARK_FUNCTION;
  FieldSpecificationManager & fsManager = FieldSpecificationManager::getInstance();
  FunctionManager const & functionManager = FunctionManager::getInstance();
...
void Bis_AcousticVTIFletcherWaveEquationSEM::initializePML()
{
  GEOS_ERROR( "This option is not supported yet" );
  return;
}
...
void Bis_AcousticVTIFletcherWaveEquationSEM::applyPML( real64 const time, DomainPartition & domain )
{
  GEOS_ERROR( "This option is not supported yet" );
  return;
}

real64 Bis_AcousticVTIFletcherWaveEquationSEM::explicitStepForward( real64 const & time_n,
                                                     real64 const & dt,
                                                     integer cycleNumber,
...
real64 Bis_AcousticVTIFletcherWaveEquationSEM::explicitStepBackward( real64 const & time_n,
                                                      real64 const & dt,
                                                      integer cycleNumber,
                                                      DomainPartition & domain,
                                                      bool computeGradient )
...
void Bis_AcousticVTIFletcherWaveEquationSEM::prepareNextTimestep( MeshLevel & mesh )
{
  NodeManager & nodeManager = mesh.getNodeManager();
...
void Bis_AcousticVTIFletcherWaveEquationSEM::computeUnknowns( real64 const & time_n,
                                               real64 const & dt,
                                               integer cycleNumber,
                                               DomainPartition & domain,
                                               MeshLevel & mesh,
                                               arrayView1d< string const > const & regionNames )
{
  ...
  auto kernelFactory = Bis_acousticVTIFletcherWaveEquationSEMKernels::ExplicitBISAcousticVTIFletcherSEMFactory( dt );
...
void Bis_AcousticVTIFletcherWaveEquationSEM::synchronizeUnknowns( real64 const & time_n,
                                                   real64 const & dt,
                                                   integer const,
                                                   DomainPartition & domain,
                                                   MeshLevel & mesh,
...
real64 Bis_AcousticVTIFletcherWaveEquationSEM::explicitStepInternal( real64 const & time_n,
                                                      real64 const & dt,
...
void Bis_AcousticVTIFletcherWaveEquationSEM::cleanup( real64 const time_n,
                                       integer const cycleNumber,
...
REGISTER_CATALOG_ENTRY( SolverBase, Bis_AcousticVTIFletcherWaveEquationSEM, string const &, dataRepository::Group * const )
