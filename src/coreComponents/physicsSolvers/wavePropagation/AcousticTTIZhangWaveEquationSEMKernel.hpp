...
/// Namespace to contain the acoustic TTI (Zhang's equations) wave kernels .
...
/**
 * @brief Implements kernels for solving the Zhang's acoustic wave equations in TTI medium with density
 ...
 * Zhang's acoustic wave equations in TTI medium with density using the
