...
/**
 * @file Bis_AcousticVTIFletcherWaveEquationSEM.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_BISACOUSTICVTIFLETCHERWAVEEQUATIONSEM_HPP_
#define GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_BISACOUSTICVTIFLETCHERWAVEEQUATIONSEM_HPP_
...
class Bis_AcousticVTIFletcherWaveEquationSEM : public WaveSolverBase
{
public:
  ...
  Bis_AcousticVTIFletcherWaveEquationSEM( const std::string & name,
                           Group * const parent );

  virtual ~Bis_AcousticVTIFletcherWaveEquationSEM() override;

  Bis_AcousticVTIFletcherWaveEquationSEM() = delete;
  Bis_AcousticVTIFletcherWaveEquationSEM( Bis_AcousticVTIFletcherWaveEquationSEM const & ) = delete;
  Bis_AcousticVTIFletcherWaveEquationSEM( Bis_AcousticVTIFletcherWaveEquationSEM && ) = default;

  Bis_AcousticVTIFletcherWaveEquationSEM & operator=( Bis_AcousticVTIFletcherWaveEquationSEM const & ) = delete;
  Bis_AcousticVTIFletcherWaveEquationSEM & operator=( Bis_AcousticVTIFletcherWaveEquationSEM && ) = delete;

  /// String used to form the solverName used to register solvers in CoupledSolver
  static string coupledSolverAttributePrefix() { return "acoustic"; }

  static string catalogName() { return "BISAcousticVTIFletcherSEM"; }
  /**
