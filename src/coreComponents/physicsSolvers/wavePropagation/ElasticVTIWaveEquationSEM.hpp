...
/**
 * @file ElasticVTIWaveEquationSEM.hpp
 */

#ifndef SRC_CORECOMPONENTS_PHYSICSSOLVERS_WAVEPROPAGATION_ELASTICVTIWAVEEQUATIONSEM_HPP_
#define SRC_CORECOMPONENTS_PHYSICSSOLVERS_WAVEPROPAGATION_ELASTICVTIWAVEEQUATIONSEM_HPP_
...
class ElasticVTIWaveEquationSEM : public WaveSolverBase
{
public:
  ...
  ElasticVTIWaveEquationSEM() = delete;
  ElasticVTIWaveEquationSEM( ElasticVTIWaveEquationSEM const & ) = delete;
  ElasticVTIWaveEquationSEM( ElasticVTIWaveEquationSEM && ) = default;

  ElasticVTIWaveEquationSEM & operator=( ElasticVTIWaveEquationSEM const & ) = delete;
