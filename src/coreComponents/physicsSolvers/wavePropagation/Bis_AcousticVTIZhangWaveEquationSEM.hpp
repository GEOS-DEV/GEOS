...
/**
 * @file Bis_AcousticVTIZhangWaveEquationSEM.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_BISACOUSTICVTIZHANGWAVEEQUATIONSEM_HPP_
#define GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_BISACOUSTICVTIZHANGWAVEEQUATIONSEM_HPP_
...
class Bis_AcousticVTIZhangWaveEquationSEM : public WaveSolverBase
{
public:
  ...
  Bis_AcousticVTIZhangWaveEquationSEM( const std::string & name,
                           Group * const parent );

  virtual ~Bis_AcousticVTIZhangWaveEquationSEM() override;

  Bis_AcousticVTIZhangWaveEquationSEM() = delete;
  Bis_AcousticVTIZhangWaveEquationSEM( Bis_AcousticVTIZhangWaveEquationSEM const & ) = delete;
  Bis_AcousticVTIZhangWaveEquationSEM( Bis_AcousticVTIZhangWaveEquationSEM && ) = default;

  Bis_AcousticVTIZhangWaveEquationSEM & operator=( Bis_AcousticVTIZhangWaveEquationSEM const & ) = delete;
  Bis_AcousticVTIZhangWaveEquationSEM & operator=( Bis_AcousticVTIZhangWaveEquationSEM && ) = delete;

  /// String used to form the solverName used to register solvers in CoupledSolver
  static string coupledSolverAttributePrefix() { return "acoustic"; }

  static string catalogName() { return "BISAcousticVTIZhangSEM"; }
  /**
