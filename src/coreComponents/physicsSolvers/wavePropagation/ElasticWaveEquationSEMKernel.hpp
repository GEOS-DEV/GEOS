...
//*****************************************************************************
  ...
  ExplicitElasticSEM( NodeManager & nodeManager,
    ...
    m_ux_n( nodeManager.getField< extrinsicMeshData::Displacementx_n >() ),
    m_uy_n( nodeManager.getField< extrinsicMeshData::Displacementy_n >() ),
    m_uz_n( nodeManager.getField< extrinsicMeshData::Displacementz_n >() ),
    m_stiffnessVectorx( nodeManager.getField< extrinsicMeshData::StiffnessVectorx >() ),
    m_stiffnessVectory( nodeManager.getField< extrinsicMeshData::StiffnessVectory >() ),
    m_stiffnessVectorz( nodeManager.getField< extrinsicMeshData::StiffnessVectorz >() ),
    m_density( elementSubRegion.template getField< extrinsicMeshData::MediumDensity >() ),
    m_velocityVp( elementSubRegion.template getField< extrinsicMeshData::MediumVelocityVp >() ),
    m_velocityVs( elementSubRegion.template getField< extrinsicMeshData::MediumVelocityVs >() ),
    m_dt( dt )
  {
