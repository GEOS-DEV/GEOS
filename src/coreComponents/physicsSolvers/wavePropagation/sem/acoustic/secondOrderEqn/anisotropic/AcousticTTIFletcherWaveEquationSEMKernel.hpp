...
template< typename SUBREGION_TYPE,
          ...
          typename FE_TYPE >
class ExplicitAcousticTTIFletcherWaveEquationSEM : public finiteElement::KernelBase< SUBREGION_TYPE,
                                                                                     CONSTITUTIVE_TYPE,
                                                                                     FE_TYPE,
                                                                                     1,
                                                                                     1 >
...
//*****************************************************************************
   ...
   */
  ExplicitAcousticTTIFletcherWaveEquationSEM ( NodeManager & nodeManager,
...
/// The factory used to construct a ExplicitAcousticTTIFletcher kernel.
using ExplicitAcousticTTIFletcherSEMFactory = finiteElement::KernelFactory< ExplicitAcousticTTIFletcherWaveEquationSEM,
                                                                            real64 >;
