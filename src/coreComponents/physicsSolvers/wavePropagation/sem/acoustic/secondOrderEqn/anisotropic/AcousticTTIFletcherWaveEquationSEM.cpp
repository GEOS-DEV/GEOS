...
void AcousticTTIFletcherWaveEquationSEM::addSourceToRightHandSide( integer const & cycleNumber, arrayView1d< real32 > const rhs )
{
...
void AcousticTTIFletcherWaveEquationSEM::initializePostInitialConditionsPreSubGroups()
{
  ...
  if( m_usePML )
  {
    AcousticTTIFletcherWaveEquationSEM::initializePML(); //TODO:
  }
...
REGISTER_CATALOG_ENTRY( SolverBase, AcousticTTIFletcherWaveEquationSEM, string const &, dataRepository::Group * const )
