...
#include "physicsSolvers/wavePropagation/sem/acoustic/secondOrderEqn/isotropic/AcousticPMLSEMKernel.hpp"
...
void AcousticTTIZhangWaveEquationSEM::addSourceToRightHandSide( integer const & cycleNumber, arrayView1d< real32 > const rhs )
{
...
void AcousticTTIZhangWaveEquationSEM::computeUnknowns( real64 const & GEOS_UNUSED_PARAM( time_n ),
                                                       real64 const & dt,
                                                       integer cycleNumber,
                                                       DomainPartition & GEOS_UNUSED_PARAM( domain ),
                                                       MeshLevel & mesh,
                                                              ...
                                                              bool const ifForward )
{
  ...
  forDiscretizationOnMeshTargets( domain.getMeshBodies(), [&] ( string const &,
                                                                ...
                                                                arrayView1d< string const > const & regionNames )
  {
    computeUnknowns( time_n, dt, cycleNumber, domain, mesh, regionNames, ifForward );
...
REGISTER_CATALOG_ENTRY( SolverBase, AcousticTTIZhangWaveEquationSEM, string const &, dataRepository::Group * const )
