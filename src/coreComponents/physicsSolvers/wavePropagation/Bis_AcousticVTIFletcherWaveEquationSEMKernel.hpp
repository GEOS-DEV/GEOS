...
/**
 * @file Bis_AcousticVTIFletcherWaveEquationSEMKernel.hpp
 */

#ifndef GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_BISACOUSTICVTIFLETCHERWAVEEQUATIONSEMKERNEL_HPP_
#define GEOS_PHYSICSSOLVERS_WAVEPROPAGATION_BISACOUSTICVTIFLETCHERWAVEEQUATIONSEMKERNEL_HPP_
...
namespace Bis_acousticVTIFletcherWaveEquationSEMKernels
{
...
template< typename SUBREGION_TYPE,
          ...
          typename FE_TYPE >
class ExplicitBISAcousticVTIFletcherSEM : public finiteElement::KernelBase< SUBREGION_TYPE,
                                                              CONSTITUTIVE_TYPE,
                                                              FE_TYPE,
                                                              1,
                                                              1 >
...
//*****************************************************************************
   ...
   */
  ExplicitBISAcousticVTIFletcherSEM( NodeManager & nodeManager,
   ...
   *
   * ### ExplicitBISAcousticVTIFletcherSEM Description
...
using ExplicitBISAcousticVTIFletcherSEMFactory = finiteElement::KernelFactory< ExplicitBISAcousticVTIFletcherSEM,
                                                                 real64 >;
