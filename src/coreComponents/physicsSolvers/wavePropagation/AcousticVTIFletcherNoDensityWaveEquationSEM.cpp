...
/**
 * @file AcousticVTIFletcherNoDensityWaveEquationSEM.cpp
 */

#include "AcousticVTIFletcherNoDensityWaveEquationSEM.hpp"
#include "AcousticVTIFletcherNoDensityWaveEquationSEMKernel.hpp"
...
AcousticVTIFletcherNoDensityWaveEquationSEM::AcousticVTIFletcherNoDensityWaveEquationSEM( const std::string & name,
                                                                                          Group * const parent ):
  WaveSolverBase( name,
                  parent )
{
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::initializePreSubGroups()
{
  WaveSolverBase::initializePreSubGroups();

}

void AcousticVTIFletcherNoDensityWaveEquationSEM::registerDataOnMesh( Group & meshBodies )
{
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::postProcessInput()
{
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::precomputeSourceAndReceiverTerm( MeshLevel & mesh,
                                                                                   arrayView1d< string const > const & regionNames )
{
                                                                                        ...
                                                                                        CellElementSubRegion & elementSubRegion )
  {
    ...
    finiteElement::FiniteElementDispatchHandler< SEM_FE_TYPES >::dispatch3D( fe, [&] ( auto const finiteElement )
    {
      ...
      acousticVTIFletcherNoDensityWaveEquationSEMKernels::
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::addSourceToRightHandSide( integer const & cycleNumber, arrayView1d< real32 > const rhs )
{
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::initializePostInitialConditionsPreSubGroups()
{
                                                                ...
                                                                arrayView1d< string const > const & regionNames )
  {
                                                                                          ...
                                                                                          CellElementSubRegion & elementSubRegion )
    {
      ...
      finiteElement::FiniteElementDispatchHandler< SEM_FE_TYPES >::dispatch3D( fe, [&] ( auto const finiteElement )
      {
        ...
        acousticVTIFletcherNoDensityWaveEquationSEMKernels::MassMatrixKernel< FE_TYPE > kernelM( finiteElement );
        ...
        acousticVTIFletcherNoDensityWaveEquationSEMKernels::DampingMatrixKernel< FE_TYPE > kernelD( finiteElement );
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::precomputeSurfaceFieldIndicator( DomainPartition & domain )
{
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::applyFreeSurfaceBC( real64 time, DomainPartition & domain )
{
  FieldSpecificationManager & fsManager = FieldSpecificationManager::getInstance();
  FunctionManager const & functionManager = FunctionManager::getInstance();
...
real64 AcousticVTIFletcherNoDensityWaveEquationSEM::explicitStepForward( real64 const & time_n,
                                                                         real64 const & dt,
                                                                         integer cycleNumber,
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::initializePML()
{
  GEOS_ERROR( "This option is not supported yet" );
  return;
}

void AcousticVTIFletcherNoDensityWaveEquationSEM::applyPML( real64 const GEOS_UNUSED_PARAM( time ),
...
real64 AcousticVTIFletcherNoDensityWaveEquationSEM::explicitStepBackward( real64 const & GEOS_UNUSED_PARAM( time_n ),
...
real64 AcousticVTIFletcherNoDensityWaveEquationSEM::explicitStepInternal( real64 const & time_n,
                                                                          real64 const & dt,
                                                                          integer cycleNumber,
                                                                          DomainPartition & domain )
{
                                        ...
                                        arrayView1d< string const > const & regionNames )
  {
    ...
    auto kernelFactory = acousticVTIFletcherNoDensityWaveEquationSEMKernels::ExplicitAcousticVTIFletcherNoDensitySEMFactory( dt );
...
void AcousticVTIFletcherNoDensityWaveEquationSEM::cleanup( real64 const time_n,
...
REGISTER_CATALOG_ENTRY( SolverBase, AcousticVTIFletcherNoDensityWaveEquationSEM, string const &, dataRepository::Group * const )
