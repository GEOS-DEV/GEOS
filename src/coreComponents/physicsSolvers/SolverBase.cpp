...
Group* SolverBase::CreateChild(string const& GEOSX_UNUSED_PARAM(childKey),
...
void SolverBase::SetNextDt(real64 const& currentDt, real64& nextDt)
{
...
void SolverBase::AssembleSystem(
...
void SolverBase::ApplyBoundaryConditions(
  real64 const GEOSX_UNUSED_PARAM(time),
  real64 const GEOSX_UNUSED_PARAM(dt),
  DomainPartition& GEOSX_UNUSED_PARAM(domain),
  DofManager const& GEOSX_UNUSED_PARAM(dofManager),
...
real64 SolverBase::CalculateResidualNorm(
...
bool SolverBase::CheckSystemSolution(
  DomainPartition const& GEOSX_UNUSED_PARAM(domain),
  DofManager const& GEOSX_UNUSED_PARAM(dofManager),
...
real64 SolverBase::ScalingForSystemSolution(
  DomainPartition const& GEOSX_UNUSED_PARAM(domain),
  DofManager const& GEOSX_UNUSED_PARAM(dofManager),
  arrayView1d<real64 const> const& GEOSX_UNUSED_PARAM(localSolution))
{
...
void SolverBase::ApplySystemSolution(
  DofManager const& GEOSX_UNUSED_PARAM(dofManager),
  arrayView1d<real64 const> const& GEOSX_UNUSED_PARAM(localSolution),
  real64 const GEOSX_UNUSED_PARAM(scalingFactor),
  DomainPartition& GEOSX_UNUSED_PARAM(domain))
...
void SolverBase::ResetStateToBeginningOfStep(
