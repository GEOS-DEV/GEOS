...
/*
 * SolidMechanicsLagrangeContactNew.hpp
 *
 */

#ifndef GEOS_PHYSICSSOLVERS_CONTACT_SOLIDMECHANICSLAGRANGECONTACTNEW_HPP_
#define GEOS_PHYSICSSOLVERS_CONTACT_SOLIDMECHANICSLAGRANGECONTACTNEW_HPP_
...
class SolidMechanicsLagrangeContactNew : public ContactSolverBase
{
public:
  SolidMechanicsLagrangeContactNew( const string & name,
                                    Group * const parent );

  ~SolidMechanicsLagrangeContactNew() override;
  ...
  {
    return "SolidMechanicsLagrangeContactNew";
  }
  /**
...
#endif /* GEOS_PHYSICSSOLVERS_CONTACT_SOLIDMECHANICSLAGRANGECONTACTNEW_HPP_ */
