...
#include "SolidMechanicsLagrangeContactNew.hpp"
...
SolidMechanicsLagrangeContactNew::SolidMechanicsLagrangeContactNew( const string & name,
                                                                    Group * const parent ):
...
SolidMechanicsLagrangeContactNew::~SolidMechanicsLagrangeContactNew()
{}

void SolidMechanicsLagrangeContactNew::registerDataOnMesh( dataRepository::Group & meshBodies )
{
...
void SolidMechanicsLagrangeContactNew::setupDofs( DomainPartition const & domain,
...
void SolidMechanicsLagrangeContactNew::setupSystem( DomainPartition & domain,
...
void SolidMechanicsLagrangeContactNew::setSparsityPattern( DomainPartition & domain,
                                                           DofManager & dofManager,
...
void SolidMechanicsLagrangeContactNew::implicitStepSetup( real64 const & time_n,
                                                          real64 const & dt,
...
void SolidMechanicsLagrangeContactNew::assembleSystem( real64 const time,
                                                       real64 const dt,
                                                       DomainPartition & domain,
...
void SolidMechanicsLagrangeContactNew::implicitStepComplete( real64 const & time_n,
                                                             real64 const & dt,
                                                             DomainPartition & domain )
{
...
real64 SolidMechanicsLagrangeContactNew::calculateResidualNorm( real64 const & time,
                                                                real64 const & dt,
...
void SolidMechanicsLagrangeContactNew::applySystemSolution( DofManager const & dofManager,
...
void SolidMechanicsLagrangeContactNew::updateState( DomainPartition & domain )
{
  GEOS_UNUSED_VAR( domain );
}

bool SolidMechanicsLagrangeContactNew::updateConfiguration( DomainPartition & domain,
...
void SolidMechanicsLagrangeContactNew::updateStickSlipList( DomainPartition const & domain )
{
...
void SolidMechanicsLagrangeContactNew::createFaceTypeList( DomainPartition const & domain )
{
                                                                ...
                                                                string_array const & )
  {
                                      ...
                                      [ = ] GEOS_HOST_DEVICE ( localIndex const kfe )
    {
      ...
      {
        GEOS_ERROR( "SolidMechanicsLagrangeContactNew:: invalid face type" );
      }
    } );
...
void SolidMechanicsLagrangeContactNew::createBubbleCellList( DomainPartition & domain ) const
{
...
void SolidMechanicsLagrangeContactNew::addCouplingNumNonzeros( DomainPartition & domain,
                                                               DofManager & dofManager,
...
void SolidMechanicsLagrangeContactNew::addCouplingSparsityPattern( DomainPartition const & domain,
                                                                   DofManager const & dofManager,
...
void SolidMechanicsLagrangeContactNew::computeTolerances( DomainPartition & domain ) const
{
  GEOS_MARK_FUNCTION;
...
REGISTER_CATALOG_ENTRY( PhysicsSolverBase, SolidMechanicsLagrangeContactNew, string const &, Group * const )
} /* namespace geos */
