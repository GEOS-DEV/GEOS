                                             ...
                                             arrayView1d< real64 > const & localRhs )
{
                                                                 ...
                                                                 FaceElementSubRegion const & subRegion )
  {
    ...
    forAll< serialPolicy >( subRegion.size(), [=]( localIndex const kfe )
    {
      ...
      globalIndex rowDOF[3 * ContactSolverBase::m_maxFaceNodes];
      real64 nodeRHS[3 * ContactSolverBase::m_maxFaceNodes];
      stackArray1d< real64, 3 * ContactSolverBase::m_maxFaceNodes > dRdP( 3*ContactSolverBase::m_maxFaceNodes );
                                              ...
                                              arrayView1d< real64 > const & localRhs )
{
                                                                 ...
                                                                 FaceElementSubRegion const & subRegion )
  {
    ...
    forAll< parallelHostPolicy >( subRegion.size(), [=] ( localIndex const kfe )
    {
      ...
      globalIndex rowDOF[3 * ContactSolverBase::m_maxFaceNodes]; // this needs to be changed when dealing with arbitrary element types
      real64 nodeRHS[3 * ContactSolverBase::m_maxFaceNodes];
      stackArray2d< real64, 3 * ContactSolverBase::m_maxFaceNodes * 3 > dRdT( 3 * ContactSolverBase::m_maxFaceNodes, 3 );
                                                                 ...
                                                                 FaceElementSubRegion const & subRegion )
  {
    ...
    constitutiveUpdatePassThru( frictionLaw, [&] ( auto & castedFrictionLaw )
    {
      ...
      forAll< parallelHostPolicy >( subRegion.size(), [=] ( localIndex const kfe )
      {
        ...
        {
          localIndex const numNodesPerFace = faceToNodeMap.sizeOfArray( elemsToFaces[kfe][0] );
          globalIndex nodeDOF[2 * 3 * ContactSolverBase::m_maxFaceNodes];
          ...
          stackArray2d< real64, 2 * 3 * ContactSolverBase::m_maxFaceNodes * 3 > dRdU( 3, 2 * 3 * ContactSolverBase::m_maxFaceNodes );
