...
/**
 * @file SolidMechanicsSmallStrainExplicitNewmarkKernel_impl.hpp
 */

#ifndef GEOSX_PHYSICSSOLVERS_SOLIDMECHANICS_SOLIDMECHANICSSMALLSTRAINEXPLICITNEWMARK_IMPL_HPP_
#define GEOSX_PHYSICSSOLVERS_SOLIDMECHANICS_SOLIDMECHANICSSMALLSTRAINEXPLICITNEWMARK_IMPL_HPP_
...
namespace solidMechanicsLagrangianFEMKernels
{
  ...
  template< typename SUBREGION_TYPE,
            ...
            typename FE_TYPE >
  ExplicitSmallStrain::ExplicitSmallStrain( NodeManager & nodeManager,
  ...
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  void ExplicitSmallStrain::setup( localIndex const k,
  ...
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  void ExplicitSmallStrain::quadraturePointKernel( localIndex const k,
                              localIndex const q,
                              StackVariables & stack ) const
  {
//#define USE_JACOBIAN
  ...
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  real64 ExplicitSmallStrain::complete( localIndex const k,
  ...
  static real64
  ExplicitSmallStrain::kernelLaunch( localIndex const numElems,
...
#endif //GEOSX_PHYSICSSOLVERS_SOLIDMECHANICS_SOLIDMECHANICSSMALLSTRAINEXPLICITNEWMARK_IMPL_HPP_
