...
#define UPDATE_STRESS 1

#define STANDARD_ELEMENT_DNDX_LAYOUT 1
#define STANDARD_ELEMENT_DETJ_LAYOUT 1
#define STANDARD_ELEMENT_MEANSTRESS_LAYOUT 1
#define STANDARD_ELEMENT_DEVIATORSTRESS_LAYOUT 1
#define STANDARD_ELEMENT_TONODESRELATION_LAYOUT 1
