...
{
inline void velocityUpdate(
  arrayView2d<real64, nodes::ACCELERATION_USD> const& acceleration,
...
inline void displacementUpdate(
  arrayView2d<real64 const, nodes::VELOCITY_USD> const& velocity,
...
struct ExplicitKernel
{
  ...
  GEOSX_HOST_DEVICE GEOSX_FORCE_INLINE static void Integrate(
  ...
  static inline real64 CalculateSingleNodalForce(
    localIndex const k,
