...
void SolidMechanicsEmbeddedFractures::RegisterDataOnMesh(
...
void SolidMechanicsEmbeddedFractures::ResetStateToBeginningOfStep(
...
void SolidMechanicsEmbeddedFractures::SetupSystem(
  DomainPartition &domain,
...
void SolidMechanicsEmbeddedFractures::AssembleSystem(
  real64 const time,
  real64 const dt,
  DomainPartition &domain,
...
void SolidMechanicsEmbeddedFractures::AddCouplingNumNonzeros(
  DomainPartition &domain,
  DofManager &dofManager,
...
void SolidMechanicsEmbeddedFractures::AddCouplingSparsityPattern(
...
void SolidMechanicsEmbeddedFractures::AssembleEquilibriumOperator(
...
void SolidMechanicsEmbeddedFractures::AssembleCompatibilityOperator(
...
void SolidMechanicsEmbeddedFractures::AssembleStrainOperator(
...
void SolidMechanicsEmbeddedFractures::ApplyBoundaryConditions(
  real64 const time,
  real64 const dt,
  DomainPartition &domain,
  DofManager const &dofManager,
...
real64 SolidMechanicsEmbeddedFractures::CalculateResidualNorm(
  DomainPartition const &domain,
  DofManager const &dofManager,
...
void SolidMechanicsEmbeddedFractures::ApplySystemSolution(
  DofManager const &dofManager,
...
void SolidMechanicsEmbeddedFractures::ComputeTraction(
  ConstitutiveManager const *const constitutiveManager,
