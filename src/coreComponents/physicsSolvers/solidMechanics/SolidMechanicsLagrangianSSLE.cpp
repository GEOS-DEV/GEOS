...
//        const realT v2_x_dNdXb2 = v_a[2]*dNdXb[2];
        ...
        p_stress[1] += u0_x_dNdXb0*c[1][0] + u1_x_dNdXb1*c[1][1] + u2_x_dNdXb2*c[1][2];
        p_stress[2] += u0_x_dNdXb0*c[2][0] + u1_x_dNdXb1*c[2][1] + u2_x_dNdXb2*c[2][2];
        p_stress[3] += ( uhat_a[2]*dNdXb[1] + uhat_a[1]*dNdXb[2] )*c[3][3];
        p_stress[4] += ( uhat_a[2]*dNdXb[0] + uhat_a[0]*dNdXb[2] )*c[4][4];
        p_stress[5] += ( uhat_a[1]*dNdXb[0] + uhat_a[0]*dNdXb[1] )*c[5][5];
