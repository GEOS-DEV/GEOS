                                        ...
                                        DomainPartition & domain )
{
  ...
  // Determine trial momenta and velocities based on acceleration due to internal
  // and external forces, but before contact enforcement
