...
/**
 * @file ImplicitSmallStrainQuasiStaticPressurizedDamage.hpp
 */

#ifndef GEOSX_PHYSICSSOLVERS_SOLIDMECHANICS_KERNELS_IMPLCITSMALLSTRAINQUASISTATICPRESSURIZEDDAMAGE_HPP_
#define GEOSX_PHYSICSSOLVERS_SOLIDMECHANICS_KERNELS_IMPLCITSMALLSTRAINQUASISTATICPRESSURIZEDDAMAGE_HPP_
...
/**
 * @brief Implements kernels for solving quasi-static equilibrium with pressurized phase-field cracks.
 ...
 *
 * ### QuasiStaticPressurizedDamage Description
 * Implements the KernelBase interface functions required for solving the
 * quasi-static equilibrium equations with pressurized phase-field cracks using one of the
...
template< typename SUBREGION_TYPE,
          ...
          typename FE_TYPE >
class ImplicitSmallStrainQuasiStaticPressurizedDamage :
...
public:
   ...
   */
  ImplicitSmallStrainQuasiStaticPressurizedDamage( NodeManager const & nodeManager,
...
/// The factory used to construct a QuasiStaticPressurizedDamage kernel.
using QuasiStaticPressurizedDamageFactory = finiteElement::KernelFactory< ImplicitSmallStrainQuasiStaticPressurizedDamage,
