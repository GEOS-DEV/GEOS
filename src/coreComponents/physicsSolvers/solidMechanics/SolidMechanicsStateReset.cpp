  ...
  m_solidSolverName()
{
  ...
  addLogLevel( "logLevel >= 1 and reset displacements", "Information about physics solver during task" );
  addLogLevel( "logLevel >= 2", "Information about solid model during task" );
}
