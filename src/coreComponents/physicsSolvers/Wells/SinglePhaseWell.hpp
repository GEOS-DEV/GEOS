...
public:
  ...
  virtual string ResElementDofName() const override { return SinglePhaseFlowBase::viewKeyStruct::pressureString; }
  ...
  struct viewKeyStruct : WellSolverBase::viewKeyStruct
  {
    ...
    static constexpr auto pressureString      = SinglePhaseFlowBase::viewKeyStruct::pressureString;
    static constexpr auto deltaPressureString = SinglePhaseFlowBase::viewKeyStruct::deltaPressureString;
