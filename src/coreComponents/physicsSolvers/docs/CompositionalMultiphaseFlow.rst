...
.. math::
   \phi \frac{ \partial  }{\partial t} \bigg( \sum_\ell \rho_{\ell} \, x_{c \ell} \, S_{\ell} \bigg) 
   + \nabla \cdot \bigg( \sum_\ell \rho_{\ell} \, x_{c \ell} \, \boldsymbol{u}_{\ell} \bigg)
   - \sum_\ell \rho_{\ell} \, x_{c \ell} \, q_{\ell} = 0,


where :math:`\phi` is the porosity of the medium, 
:math:`S_{\ell}` is the saturation of phase :math:`\ell`, :math:`x_{c \ell}`
...
.. math::
   \phi \frac{ \partial  }{\partial t} \bigg( \sum_\ell \rho_{\ell} \, x_{c \ell} \, S_{\ell} \bigg) 
   - \nabla \cdot \boldsymbol{k} \bigg( \sum_\ell \rho_{\ell} \, x_{c \ell} \, \lambda_{\ell} \nabla \Phi_{\ell}   \bigg)
   - \sum_\ell \rho_{\ell} \, x_{c \ell} \, q_{\ell} = 0.
