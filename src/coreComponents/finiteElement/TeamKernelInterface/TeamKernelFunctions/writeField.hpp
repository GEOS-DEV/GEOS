...
#ifndef GEOSX_FINITEELEMENT_TEAMKERNELFUNCTION_WRITE_HPP_
#define GEOSX_FINITEELEMENT_TEAMKERNELFUNCTION_WRITE_HPP_
...
GEOSX_FORCE_INLINE
void writeField( StackVariables & stack,
                 tensor::StaticDTensor< stride_x, stride_y, stride_z > const & local_field,
                 Field & field )
{
  for (localIndex ind_z = 0; ind_z < stride_z; ind_z++)
  {
...
GEOSX_FORCE_INLINE
void writeField( StackVariables & stack,
                 tensor::StaticDTensor< stride_x, stride_y, stride_z, dim > const & local_field,
                 Field & field )
{
  for (localIndex ind_z = 0; ind_z < stride_z; ind_z++)
  {
...
#endif /* GEOSX_FINITEELEMENT_TEAMKERNELFUNCTION_WRITE_HPP_ */
