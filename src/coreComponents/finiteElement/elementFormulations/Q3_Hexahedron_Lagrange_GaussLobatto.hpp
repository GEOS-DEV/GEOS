...
/**
 * @file Q3_Hexahedron_Lagrange_GaussLobatto.hpp
 */

#ifndef GEOSX_FINITEELEMENT_ELEMENTFORMULATIONS_Q3HEXAHEDRON
#define GEOSX_FINITEELEMENT_ELEMENTFORMULATIONS_Q3HEXAHEDRON
 ...
 *
 */
class Q3_Hexahedron_Lagrange_GaussLobatto final : public FiniteElementBase
{
public:

  using BASIS = LagrangeBasis3GL;
                     ...
                     real64 (& N)[numNodes] )
  {
    ...
    real64 const qCoords[3] = {LagrangeBasis3GL::parentSupportCoord( qa ),
                               LagrangeBasis3GL::parentSupportCoord( qb ),
                               LagrangeBasis3GL::parentSupportCoord( qc ) };

    LagrangeBasis3GL::TensorProduct3D::value( qCoords, N );
  }
...
private:
  ...
  constexpr static real64 parentLength = LagrangeBasis3GL::parentSupportCoord( 3 ) - LagrangeBasis3GL::parentSupportCoord( 0 );
  ...
  //MODIF1 : Hardcoded the weight values for order 3 Gauss-Lobatto points
  /// The weight of each quadrature point.
  //const static real64 weight[4]={ 1.0/6.0, 5.0/6.0, 5.0/6.0, 1.0/6.0};

  constexpr static real64 weight1=1.0/6.0;
  constexpr static real64 weight2=5.0/6.0;
  constexpr static real64 weight3=5.0/6.0;
  constexpr static real64 weight4=1.0/6.0;
...
#endif //GEOSX_FINITEELEMENT_ELEMENTFORMULATIONS_Q3HEXAHEDRON
