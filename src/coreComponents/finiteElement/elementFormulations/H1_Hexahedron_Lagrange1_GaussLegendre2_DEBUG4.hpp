...
/**
 * @file H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4.hpp
 */

#ifndef GEOSX_FINITEELEMENT_ELEMENTFORMULATIONS_TRILINEARHEXAHEDRON_DEBUG4
#define GEOSX_FINITEELEMENT_ELEMENTFORMULATIONS_TRILINEARHEXAHEDRON_DEBUG4
...
class H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4 final : public FiniteElementBase
{
public:
  ...
  virtual ~H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4() override
  {}
...
H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4::supportLoop( int const qa,
                                                            int const qb,
                                                            int const qc,
                                                            FUNC && func,
                                                            PARAMS &&... params )
...
GEOSX_FORCE_INLINE
real64
H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4::calcGradN( localIndex const q,
                                                          real64 const (&X)[numNodes][3],
                                                          real64 (& gradN)[numNodes][3] )
{
  real64 J[3][3] = {{0}};
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
real64 H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4::
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4::symmetricGradient( int const q,
                                                                       real64 const (&invJ)[3][3],
                                                                       real64 const (&var)[numNodes][3],
                                                                       real64 (& grad)[6] )
{
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4::plusGradNajAij( int const q,
                                                                    real64 const (&invJ)[3][3],
                                                                    real64 const (&var)[6],
                                                                    real64 (& R)[numNodes][3] )
{
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void H1_Hexahedron_Lagrange1_GaussLegendre2_DEBUG4::gradient( int const q,
                                                              real64 const (&invJ)[3][3],
                                                              real64 const (&var)[numNodes][3],
                                                              real64 (& grad)[3][3] )
{
