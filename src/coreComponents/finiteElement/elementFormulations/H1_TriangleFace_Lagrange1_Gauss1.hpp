...
/**
 * @class H1_TriangleFace_Lagrange1_Gauss1
 *
 * Contains the kernel accessible functions specific to the H1-conforming nodal
 * linear triangular face finite element with a 1-point Gaussian quadrature rule.
 *
 *
 *          3                                =====  ==  ==
 *           +                               Node   r   s
 ...
 *
 */
class H1_TriangleFace_Lagrange1_Gauss1 : public FiniteElementBase
{
public:
  ...
  virtual ~H1_TriangleFace_Lagrange1_Gauss1() override final
  {}
