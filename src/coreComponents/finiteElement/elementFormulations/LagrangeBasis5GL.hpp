 ...
 */
   ...
   *
   *           31        32      33       34       35 /                               ____________________________________________________ 
   * 30 o--------o--------o--------o--------o--------o                               |Node      xi0                        xi1            |
   *    |                                            |                               |=====     ===                        ===            |
   *    |                                            |                               |  0       -1                         -1             |
   *    |                                            |                               |  1   -sqrt(1/21(7+/sqrt(7))         -1             |
   *    |                                            |                               |  2    -sqrt(1/21(7-/sqrt(7))        -1             |
   * 24 o     25 o     26 o     27 o     28 o     29 o                               |  3    sqrt(1/21(7-/sqrt(7))         -1             |
   *    |                                            |                               |  4    sqrt(1/21(7+/sqrt(7))         -1             |
   *    |                                            |                               |  5        1                         -1             |
   *    |                                            |                               |  6       -1                 -sqrt(1/21(7+/sqrt(7)) |
   * 18 o     19 o     20 o     21 o     22 o     23 o                               |  7   -sqrt(1/21(7+/sqrt(7)) -sqrt(1/21(7+/sqrt(7)) |
   *    |                                            |                               |  8   -sqrt(1/21(7-/sqrt(7)) -sqrt(1/21(7+/sqrt(7)) |
   *    |                                            |                               |  9    sqrt(1/21(7-/sqrt(7)) -sqrt(1/21(7+/sqrt(7)) |
   *    |                                            |                               | 10    sqrt(1/21(7+/sqrt(7)) -sqrt(1/21(7+/sqrt(7)) |
   * 12 o     13 o     14 o     15 o     16 o     17 o                               | 11        1                 -sqrt(1/21(7+/sqrt(7)) |
   *    |                                            |                               | ..       ..                         ..             |
   *    |                                            |                               | ..       ..                         ..             |
   *    |                                            |                               | 30       -1                          1             |
   * 6  o     7  o     8  o     9  o     10 o     11 o                               | 31   -sqrt(1/21(7+/sqrt(7))          1             |
