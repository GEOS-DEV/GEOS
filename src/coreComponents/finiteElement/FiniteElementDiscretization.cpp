...
//  GEOS_ERROR_IF_NE_MSG( m_order, 1, "Higher order finite element spaces are currently not supported." );
  GEOS_ERROR_IF( m_formulation != "default" && m_formulation != "SEM" && m_formulation != "DG", getDataContext() << "Only standard element formulations and spectral element formulations are currently supported." );
  GEOS_ERROR_IF_GT_MSG( m_useVem, 1,
