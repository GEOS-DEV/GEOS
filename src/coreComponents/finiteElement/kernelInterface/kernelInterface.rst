...
launching functions may be implemented, and reused by various physics packages
...
#. The kernel interface, which is specified by the
   ...
   Each physics package will define a class that contains its kernels functions,
