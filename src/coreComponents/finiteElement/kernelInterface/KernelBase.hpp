...
/**
 * @brief Specialization of #::geos::finiteElement::KernelFactory for the case where the kernel template has 3 template parameters
 *(SUBREGION_TYPE, CONSTITUTIVE_TYPE, FE_TYPE).
                                     ...
                                     KERNEL_FACTORY & kernelFactory )
{
  ...
  // Currently only CellElementSubRegion is supported.
