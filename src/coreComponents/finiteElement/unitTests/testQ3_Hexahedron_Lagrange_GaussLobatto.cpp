...
void testKernelDriver()
{
                    ...
                    [=] GEOS_HOST_DEVICE ( localIndex const )
  {
    ...
    {
      real64 N[numNodes] = {0};
      Q3_Hexahedron_Lagrange_GaussLobatto_impl::calcN( q, N );
                    ...
                    [=] GEOS_HOST_DEVICE ( localIndex const )
  {
    ...
    for( localIndex q=0; q<numQuadraturePoints; ++q )
    {
      ...
      viewDetJ[q] = Q3_Hexahedron_Lagrange_GaussLobatto_impl::calcGradN( xLocal[ q ],
                                                                         xLocal,
                                                                         dNdXcheck );

      viewDetJ[q] = Q3_Hexahedron_Lagrange_GaussLobatto_impl::calcGradN( q,
                                                                         xLocal,
                                                                         dNdX );
