...
/**
 * @file MultivariableNonuniformTableFunction.hpp
 */

#ifndef GEOS_FUNCTIONS_MULTIVARIABLENONUNIFORMTABLEFUNCTION_HPP_
#define GEOS_FUNCTIONS_MULTIVARIABLENONUNIFORMTABLEFUNCTION_HPP_
...
/**
 * @class MultivariableNonuniformTableFunction
 *
...
class MultivariableNonuniformTableFunction : public FunctionBase
{
public:
   ...
   */
  MultivariableNonuniformTableFunction( const string & name,
                                        Group * const parent );

  /**
   * @brief The catalog name interface
   * @return name of the MultivariableNonuniformTableFunction in the FunctionBase catalog
   */
  static string catalogName() { return "MultivariableNonuniformTableFunction"; }
   ...
   * @param[in] axisNumCoordinates axis number of coordinates for each dimension
  ...
  void setTableCoordinates( integer const numDims,
                            ...
                            integer_array const & axisNumCoordinates,
                            real64_array2d const & axisCooridnates,
...
private:
  ...
  /// Array [numDims] of number of discretization points for each dimenstion
  integer_array m_axisNumCoordinates;
