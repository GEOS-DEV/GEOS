                                      ...
                                      DomainPartition & domain )
{
  solver.forDiscretizationOnMeshTargets( domain.getMeshBodies(), [&]( string const,
    ...
    elementRegionManager.forElementSubRegions( regionNames,
      ...
      fluxApprox.forStencils< CellElementStencilTPFA >( mesh,
             ...
             stencil.size(); ++iconn )
        {
          ...
          real64 const trans[numFluxSupportPoints] = {
            weights[iconn][0],
            weights[iconn][1]};
          real64 const dTrans_dP[numFluxSupportPoints] = {
            0.,
            0.};
          ...
          real64 gravHead[NP]{};
          real64 dGravHead_dP[NP][numFluxSupportPoints]{};
          real64 dGravHead_dC[NP][numFluxSupportPoints][NC]{};
          real64 dProp_dC[NP][NC]{};

          real64 capHead[NP]{};
          real64 dCapHead_dP[NP][numFluxSupportPoints]{};
          real64 dCapHead_dC[NP][numFluxSupportPoints][NC]{};
          ...
          real64 fflow[NP]{};
          real64 dFflow_dP[NP][numFluxSupportPoints]{};
          real64 dFflow_dC[NP][numFluxSupportPoints][NC]{};
          for( localIndex ip = 0;
               ip <
               NP; ++ip )
          {
               ...
               NP; ++ip )
          {
                 ...
                 NP; ++jp )
            {
                  ...
                  jp )
              {
                phaseFluxScheme -=
                  fflow[ip] *
                  phaseMobView[seri[iconn][0]][sesri[iconn][0]][sei[iconn][k_up_scheme[jp]]][jp]
                  *
                  ((gravHead[ip] +
                    capHead[ip]) -
                   (gravHead[jp] +
      ...
      } );                                                                                              //second level lambda on stencil
                                                                                                        // list
