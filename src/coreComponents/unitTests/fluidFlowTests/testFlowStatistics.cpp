...
#include "physicsPackages/fluidFlow/SinglePhaseStatistics.hpp"
...
real64 getTotalFluidMass( ProblemManager & problem, string_view flowSolverPath )
{
  ...
  PhysicsPackageBase const & solver = problem.getGroupByPath< PhysicsPackageBase >( string( flowSolverPath ) );
                                 ...
                                 TimeStepChecker const & timeStepChecker )
{
  ...
  PhysicsPackageBase const & solver = problem.getGroupByPath< PhysicsPackageBase >( testSet.inputs.flowSolverPath );
