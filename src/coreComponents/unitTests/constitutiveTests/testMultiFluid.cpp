...
{
  CompositionalMultiphaseFluidLBC & fluid = parent.registerGroup< CompositionalMultiphaseFluidLBC >( name );
  ...
  auto & eqnOfState = fluid.getReference< string_array >( CompositionalMultiphaseFluidLBC::viewKeyStruct::equationsOfStateString() );
  eqnOfState.resize( 2 );
  eqnOfState[0] = "PR"; eqnOfState[1] = "PR";

  auto & critPres = fluid.getReference< array1d< real64 > >( CompositionalMultiphaseFluidLBC::viewKeyStruct::componentCriticalPressureString() );
  critPres.resize( 4 );
  critPres[0] = 34e5; critPres[1] = 25.3e5; critPres[2] = 14.6e5; critPres[3] = 220.5e5;

  auto & critTemp = fluid.getReference< array1d< real64 > >( CompositionalMultiphaseFluidLBC::viewKeyStruct::componentCriticalTemperatureString() );
  critTemp.resize( 4 );
  critTemp[0] = 126.2; critTemp[1] = 622.0; critTemp[2] = 782.0; critTemp[3] = 647.0;

  auto & acFactor = fluid.getReference< array1d< real64 > >( CompositionalMultiphaseFluidLBC::viewKeyStruct::componentAcentricFactorString() );
  acFactor.resize( 4 );
