...
#include "physicsSolvers/wavePropagation/sem/acoustic/secondOrderEqn/anisotropic/AcousticTTIFletcherWaveEquationSEM.hpp"
...
protected:
  ...
  GeosxState state;
  AcousticTTIFletcherWaveEquationSEM * propagator;
};

real64 constexpr AcousticTTIFletcherWaveEquationSEMTest::time;
real64 constexpr AcousticTTIFletcherWaveEquationSEMTest::dt;
real64 constexpr AcousticTTIFletcherWaveEquationSEMTest::eps;

TEST_F( AcousticTTIFletcherWaveEquationSEMTest, SeismoTrace )
{

  DomainPartition & domain = state.getProblemManager().getDomainPartition();
  propagator = &state.getProblemManager().getPhysicsSolverManager().getGroup< AcousticTTIFletcherWaveEquationSEM >( "acousticTTIFletcherSolver" );
  real64 time_n = time;
  // run for 1s (10 steps)
  for( int i=0; i<10; i++ )
  {
