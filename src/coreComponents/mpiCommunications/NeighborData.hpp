...
public:
   ...
   */
  array1d<localIndex>& ghostsToSend() { return m_ghostsToSend; }
   ...
   */
  array1d<localIndex>& ghostsToReceive() { return m_ghostsToReceive; }
   ...
   */
  array1d<localIndex>& adjacencyList() { return m_adjacencyList; }
