...
public:
  ...
  void MPI_TestRecv( int const commID,
                     int & test_val );
  ...
  void getRecvRequestAndStatus( int const commID, MPI_Request & r, MPI_Status & s )
  {
    r = m_mpiRecvBufferRequest[commID];
    s = m_mpiRecvBufferStatus[commID];
  }
