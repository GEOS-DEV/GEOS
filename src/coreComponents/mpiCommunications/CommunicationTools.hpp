...
public:
  ...
  static void AssignNewGlobalIndices(
  ...
  static void FindMatchedPartitionBoundaryObjects(
  ...
  static void SynchronizePackSendRecvSizes(
  ...
  static void SynchronizePackSendRecv(
    const std::map<string, string_array>& fieldNames,
    MeshLevel* const mesh,
    std::vector<NeighborCommunicator>& allNeighbors,
    MPI_iCommData& icomm,
