...
public:
  ...
  SolidMechanicsMPM::CohesiveSurfaceDisplacementUpdateOption getCZSurfaceDisplacementUpdate() const { return m_czSurfaceDisplacementUpdate; }
...
protected:
  ...
  SolidMechanicsMPM::CohesiveSurfaceDisplacementUpdateOption m_czSurfaceDisplacementUpdate;
};
