...
void ParticleSubRegion::copyFromCellBlock( CellBlock & source )
{
...
void ParticleSubRegion::addFracturedElement( localIndex const cellElemIndex,
...
localIndex ParticleSubRegion::packFracturedElementsSize( arrayView1d< localIndex const > const & packList,
...
localIndex ParticleSubRegion::packFracturedElements( buffer_unit_type * & buffer,
...
template< bool DOPACK >
localIndex ParticleSubRegion::packFracturedElementsPrivate( buffer_unit_type * & buffer,
                                                               arrayView1d< localIndex const > const & packList,
                                                               arrayView1d< globalIndex const > const & embeddedSurfacesLocalToGlobal ) const
{
...
localIndex ParticleSubRegion::unpackFracturedElements( buffer_unit_type const * & buffer,
                                                          localIndex_array & packList,
