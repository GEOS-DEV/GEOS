...
public:
   ...
   */
  using permutationMapType = map< string, map< string, map< string, stdVector< string > > > >;
...
private:
  ...
  template< typename OBJECT_TYPE,
            typename FUNC >
  void forObjectsInPath( std::pair< string const, map< string, stdVector< string > > > const & levelPair,
                         MeshLevel & meshLevel,
                         FUNC && func ) const;
...
template< typename OBJECT_TYPE,
          typename FUNC >
void MeshObjectPath::forObjectsInPath( std::pair< string const, map< string, stdVector< string > > > const & levelPair,
                                       MeshLevel & meshLevel,
                                       FUNC && func ) const
{
