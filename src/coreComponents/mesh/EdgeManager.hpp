...
public:
   ...
   */
  static const string CatalogName() { return "EdgeManager"; }
   ...
   */
  static localIndex faceMapExtraSpacePerEdge() { return 4; }
   ...
   */
  void ConnectivityFromGlobalToLocal(
...
inline R1Tensor EdgeManager::calculateCenter(
  localIndex const edgeIndex,
  arrayView2d<real64 const, nodes::REFERENCE_POSITION_USD> const& X) const
{
...
inline R1Tensor EdgeManager::calculateLength(
  localIndex const edgeIndex,
  arrayView2d<real64 const, nodes::REFERENCE_POSITION_USD> const& X) const
{
