...
ArrayOfArrays< geos::localIndex > build2dFaceTo2dElems( ArrayOfArraysView< localIndex const > const elem2dToEdges,
                                                        std::map< localIndex, localIndex > const & edgesTo2dFaces,
 ...
 * @return The mapping
 */
std::map< localIndex, localIndex > buildEdgesToFace2d( arrayView1d< localIndex const > const face2dToEdges )
{
  std::map< localIndex, localIndex > edgesToFace2d;
