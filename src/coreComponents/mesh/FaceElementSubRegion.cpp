 ...
 */
map< globalIndex, globalIndex > buildReferenceCollocatedNodes( ArrayOfArrays< array1d< globalIndex > > const & elem2dToCollocatedNodesBuckets )
{
  map< globalIndex, globalIndex > referenceCollocatedNodes;  // Will be returned.
 ...
 */
map< std::pair< globalIndex, globalIndex >, std::set< localIndex > >
buildCollocatedEdgeBuckets( map< globalIndex, globalIndex > const & referenceCollocatedNodes,
                            ...
                            arrayView2d< localIndex const > const edgeToNodes )
{
  ...
  map< std::pair< globalIndex, globalIndex >, localIndex > edgesIds;
  ...
  map< std::pair< globalIndex, globalIndex >, std::set< localIndex > > collocatedEdgeBuckets;
 ...
 * @return The computed mapping.
 */
map< localIndex, localIndex > buildReferenceCollocatedEdges( map< std::pair< globalIndex, globalIndex >, std::set< localIndex > > const & collocatedEdgeBuckets,
                                                                arrayView1d< integer const > const edgeGhostRanks )
{
  map< localIndex, localIndex > referenceCollocatedEdges;
...
ArrayOfArrays< geos::localIndex > build2dFaceTo2dElems( ArrayOfArraysView< localIndex const > const elem2dToEdges,
                                                        ...
                                                        map< geos::localIndex, geos::localIndex > const & referenceCollocatedEdges )
{
...
void fillMissing2dElemToEdges( ArrayOfArraysView< localIndex const > const elem2dToNodes,
                               ...
                               arrayView1d< globalIndex const > const nl2g,
                               map< globalIndex, globalIndex > const & referenceCollocatedNodes,
                               map< std::pair< globalIndex, globalIndex >, std::set< localIndex > > const & collocatedEdgeBuckets,
                               ArrayOfArrays< localIndex > & elem2dToEdges )
{
  ...
  for( localIndex e2d = 0; e2d < num2dElems; ++e2d )
  {
    ...
    map< localIndex, stdVector< localIndex > > nodesOfEdgesTouching2dElem, nodesOfEdgesOf2dElem;
 ...
 */
array1d< localIndex > build2dFaceToEdge( map< localIndex, localIndex > const & referenceCollocatedEdges )
{
                                                 ...
                                                 ElementRegionManager const & elemManager )
{
  ...
  map< globalIndex, globalIndex > const referenceCollocatedNodes = buildReferenceCollocatedNodes( m_2dElemToCollocatedNodesBuckets );

  fillMissing2dElemToNodes( m_2dElemToCollocatedNodesBuckets, nodeManager.globalToLocalMap(), m_toNodesRelation );

  map< std::pair< globalIndex, globalIndex >, std::set< localIndex > > const collocatedEdgeBuckets = buildCollocatedEdgeBuckets( referenceCollocatedNodes, nl2g, edgeManager.nodeList() );
  map< localIndex, localIndex > const referenceCollocatedEdges = buildReferenceCollocatedEdges( collocatedEdgeBuckets, edgeManager.ghostRank() );
  ...
  map< std::set< globalIndex >, std::set< ElemPath > > faceRefNodesToElems;
