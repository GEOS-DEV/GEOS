 ...
 * @param elementType type of element
 * @return number of faces for 3D elements (-1 if not a 3D element)
 */
inline int getNumFaces3D( ElementType const elementType )
{
  switch( elementType )
  {
    ...
    case ElementType::Hexahedron: return 6;
    case ElementType::Prism5: return 7;
    case ElementType::Prism6: return 8;
