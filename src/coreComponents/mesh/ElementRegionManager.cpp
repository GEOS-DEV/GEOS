...
void ElementRegionManager::resize(
...
int ElementRegionManager::PackSize(
...
int ElementRegionManager::PackPrivate(
  buffer_unit_type *&buffer,
  string_array const &wrapperNames,
  ElementViewAccessor<arrayView1d<localIndex>> const &packList) const
{
...
int ElementRegionManager::Unpack(
...
int ElementRegionManager::PackGlobalMapsSize(
  ElementViewAccessor<arrayView1d<localIndex>> const &packList) const
{
  buffer_unit_type *junk = nullptr;
...
int ElementRegionManager::PackGlobalMaps(
  buffer_unit_type *&buffer,
  ElementViewAccessor<arrayView1d<localIndex>> const &packList) const
{
...
template <bool DOPACK>
int ElementRegionManager::PackGlobalMapsPrivate(
  buffer_unit_type *&buffer,
  ElementViewAccessor<arrayView1d<localIndex>> const &packList) const
{
  int packedSize = 0;
...
int ElementRegionManager::UnpackGlobalMaps(
  buffer_unit_type const *&buffer,
...
int ElementRegionManager::PackUpDownMapsSize(
  ElementViewAccessor<arrayView1d<localIndex>> const &packList) const
{
  buffer_unit_type *junk = nullptr;
...
int ElementRegionManager::PackUpDownMaps(
  buffer_unit_type *&buffer,
  ElementViewAccessor<arrayView1d<localIndex>> const &packList) const
{
...
int ElementRegionManager::PackUpDownMapsPrivate(buffer_unit_type *&buffer,
...
int ElementRegionManager::UnpackUpDownMaps(
  buffer_unit_type const *&buffer,
