...
localIndex NodeManager::PackUpDownMapsSize(
...
localIndex NodeManager::PackUpDownMaps(
...
localIndex NodeManager::PackUpDownMapsPrivate(
  buffer_unit_type *&buffer,
  arrayView1d<localIndex const> const &packList) const
{
...
void NodeManager::depopulateUpMaps(
