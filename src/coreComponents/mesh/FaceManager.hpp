...
public:
   ...
   */
  static const string CatalogName() { return "FaceManager"; }
   ...
   */
  void BuildFaces(NodeManager* const nodeManager,
   ...
   */
  virtual void enforceStateFieldConsistencyPostTopologyChange(
    std::set<localIndex> const& targetIndices) override;
   ...
   */
  virtual void ExtractMapFromObjectForAssignGlobalIndexNumbers(
   ...
   */
  arrayView3d<real64 const> const& faceRotationMatrix() const
  {
    return m_faceRotationMatrix;
  }
   ...
   */
  arrayView2d<localIndex> const& elementRegionList()
  {
   ...
   */
  arrayView2d<localIndex const> const& elementRegionList() const
  {
    return m_toElements.m_toElementRegion;
  }
   ...
   */
  arrayView2d<localIndex> const& elementSubRegionList()
  {
   ...
   */
  arrayView2d<localIndex const> const& elementSubRegionList() const
  {
    return m_toElements.m_toElementSubRegion;
  }
   ...
   */
  arrayView2d<localIndex> const& elementList()
  {
   ...
   */
  arrayView2d<localIndex const> const& elementList() const
  {
    return m_toElements.m_toElementIndex;
  }
