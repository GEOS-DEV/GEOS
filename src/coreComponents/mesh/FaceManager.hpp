...
public:
  ...
  /**
   * @brief Returns the name of the face manager in the object catalog.
 ...
 */
  ...
  /**
   * @brief Creates an array listing all excluded local face indices values.
 ...
 /**
  ...
  /**
    * @brief Extract a face-to-node map with global indexed for boundary faces
