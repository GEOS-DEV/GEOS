 ...
 */
using CellMapType = map< ElementType, std::unordered_map< int, stdVector< vtkIdType > > >;
...
public:
  ...
  AllMeshes( vtkSmartPointer< vtkDataSet > const & main,
             map< string, vtkSmartPointer< vtkDataSet > > const & faceBlocks )
    : m_main( main ),
   ...
   */
  map< string, vtkSmartPointer< vtkDataSet > > & getFaceBlocks()
  {
    return m_faceBlocks;
  }
   ...
   */
  void setFaceBlocks( map< string, vtkSmartPointer< vtkDataSet > > const & faceBlocks )
  {
    m_faceBlocks = faceBlocks;
  }
...
private:
  ...
  map< string, vtkSmartPointer< vtkDataSet > > m_faceBlocks;
};
...
redistributeMeshes( integer const logLevel,
                    ...
                    map< string, vtkSmartPointer< vtkDataSet > > & namesToFractures,
                    MPI_Comm const comm,
