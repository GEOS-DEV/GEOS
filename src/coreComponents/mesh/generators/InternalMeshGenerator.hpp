...
public:
  ...
  void importFieldsOnArray( string const cellBlockName, string const wrapperName, int fieldIndex, dataRepository::WrapperBase & wrapper, bool importMaterial ) const override {}
