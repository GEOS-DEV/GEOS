...
{
  GEOS_THROW_CTX_IF( m_polyNodeCoords.size( 1 ) != m_nDims,
  ...
  GEOS_THROW_CTX_IF( m_segmentToPolyNodeMap.size( 1 ) != 2,
  ...
  GEOS_THROW_CTX_IF( m_polyNodeCoords.size( 0 )-1 != m_segmentToPolyNodeMap.size( 0 ),
