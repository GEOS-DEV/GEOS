...
array1d< localIndex > CellBlock::getFaceNodes( localIndex iElement,
                                               localIndex iFace ) const
{
  auto buildArray = []( std::initializer_list< localIndex > input ) -> array1d< localIndex >
  {
    array1d< localIndex > result;
    result.reserve( input.size() );
    for( localIndex const & v: input )
    {
