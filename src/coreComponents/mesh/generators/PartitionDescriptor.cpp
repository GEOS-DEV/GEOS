...
std::array< real64, 3 > PartitionDescriptor::getGridMin() const
{
  return { m_gridMin[0], m_gridMin[1], m_gridMin[2] };
}

std::array< real64, 3 > PartitionDescriptor::getGridMax() const
{
  return { m_gridMax[0], m_gridMax[1], m_gridMax[2] };
}
