 ...
 */
void findSmallestThreeValues(arrayView1d<localIndex const> const &values,
 ...
 */
localIndex calculateTotalNumberOfFaces(
...
void FaceManager::BuildFaces(NodeManager *const nodeManager,
...
void FaceManager::SortFaceNodes(
  arrayView2d<real64 const, nodes::REFERENCE_POSITION_USD> const &X,
...
void FaceManager::ExtractMapFromObjectForAssignGlobalIndexNumbers(
...
localIndex FaceManager::PackUpDownMapsSize(
...
localIndex FaceManager::PackUpDownMaps(
...
localIndex FaceManager::PackUpDownMapsPrivate(
  buffer_unit_type *&buffer,
  arrayView1d<localIndex const> const &packList) const
{
...
localIndex FaceManager::UnpackUpDownMaps(
...
void FaceManager::enforceStateFieldConsistencyPostTopologyChange(
