...
void EdgeManager::SetDomainBoundaryObjects( const ObjectDataStructureBaseT * const referenceObject )
{
  ...
  // been set already!
  const array1d<integer> & isFaceOnDomainBoundary = faceManager->getReference< array1d<integer> >
  ...
  array1d<integer> & isNodeOnDomainBoundary = this->getReference< array1d<integer> >
                                              ( ObjectManagerBase::viewKeyStruct::domainBoundaryIndicatorString );
...
template unsigned int EdgeManager::PackEdges( const set<localIndex> &, const NodeManager &, const FaceManager &, bufvector &, const bool,
                                              const bool, const bool,
                                              const bool ) const;
template unsigned int EdgeManager::PackEdges( const localIndex_array &, const NodeManager &, const FaceManager &, bufvector &, const bool,
                                              const bool, const bool,
                                              const bool ) const;
                                       ...
                                       const bool unpackSets )
{
  ...
  sizeOfUnpacked += ObjectDataStructureBaseT::UnpackBaseObjectData( buffer, edgeReceiveLocalIndices, newEdgeLocalIndices, unpackFields,
                                                                    unpackMaps, unpackSets,
