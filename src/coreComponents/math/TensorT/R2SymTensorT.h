...
inline realT R2SymTensorT< T_dim >::Det( void ) const
{
  ...
  if( T_dim == 2 )
  {
    ...
    det = this->t_data[0] * ( this->t_data[2] * ( this->t_data[5] ) - this->t_data[4] * ( this->t_data[4] ) ) - this->t_data[1] *
          ( this->t_data[1]
            * ( this->t_data[5] ) -
            this->t_data[3] *
            ( this->t_data[4] ) ) +
...
inline realT R2SymTensorT< T_dim >::Inner( void ) const
{
  ...
  if( T_dim == 2 )
  {
    ...
    rval = this->t_data[0] * ( this->t_data[0] ) + 2 * ( this->t_data[1] ) * ( this->t_data[1] ) + this->t_data[2] * ( this->t_data[2] ) + 2 *
           ( this->t_data[3] )
