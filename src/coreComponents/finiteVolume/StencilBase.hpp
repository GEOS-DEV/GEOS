 ...
 */
template <typename LEAFCLASSTRAITS, typename LEAFCLASS> class StencilBase
{
public:
  StencilBase()
   ...
   * @return A view to const
   */
  typename LEAFCLASSTRAITS::IndexContainerViewConstType const& getElementIndices() const
  {
   ...
   * @return A view to const
   */
  typename LEAFCLASSTRAITS::WeightContainerViewConstType const& getWeights() const
  {
