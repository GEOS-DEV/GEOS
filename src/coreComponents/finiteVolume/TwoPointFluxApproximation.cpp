...
void TwoPointFluxApproximation::computeCellStencil( MeshLevel & mesh ) const
{
  ...
  string_array const &const targetRegions = m_targetRegions.at( mesh.getParent().getParent().getName() );
                                                        ...
                                                        SortedArrayView< localIndex const > const & faceSet ) const
{
  ...
  string_array const &const targetRegions = m_targetRegions.at( meshBodyName );
