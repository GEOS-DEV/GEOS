...
void TwoPointFluxApproximation::addToFractureStencil(
  MeshLevel &mesh,
...
void TwoPointFluxApproximation::registerBoundaryStencil(Group &stencilGroup,
...
void TwoPointFluxApproximation::computeBoundaryStencil(
  MeshLevel &mesh,
