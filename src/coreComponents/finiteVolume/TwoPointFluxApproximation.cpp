...
void TwoPointFluxApproximation::updateCellStencil( MeshLevel & GEOSX_UNUSED_PARAM( mesh ) ) const
{/*
  NodeManager const & nodeManager = *mesh.getNodeManager();
  FaceManager const & faceManager = *mesh.getFaceManager();
  ElementRegionManager const & elemManager = *mesh.getElemManager();
...
void TwoPointFluxApproximation::updateFractureStencil( MeshLevel & GEOSX_UNUSED_PARAM( mesh ) ) const
{/*
  NodeManager * const nodeManager = mesh.getNodeManager();
  EdgeManager const * const edgeManager = mesh.getEdgeManager();
  FaceManager const * const faceManager = mesh.getFaceManager();
...
void TwoPointFluxApproximation::updateBoundaryStencil( MeshLevel & GEOSX_UNUSED_PARAM(mesh),
                                                        string const & GEOSX_UNUSED_PARAM(setName),
                                                        SortedArrayView< localIndex const > const & GEOSX_UNUSED_PARAM(faceSet) ) const
{/*
  NodeManager const & nodeManager = *mesh.getNodeManager();
  FaceManager const & faceManager = *mesh.getFaceManager();
  ElementRegionManager const & elemManager = *mesh.getElemManager();
