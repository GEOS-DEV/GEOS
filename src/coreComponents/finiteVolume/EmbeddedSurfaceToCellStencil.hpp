                  ...
                  real64 ( & dWeight_dVar )[1][2] ) const
{
  ...
  real64 const value = t1 + 0.0 * t0*t1/sumOfTrans;
  ...
  dWeight_dVar[0][0] = 0.0 * ( dt0 * t1 * sumOfTrans - dt0 * t0 * t1 ) / ( sumOfTrans * sumOfTrans );
  dWeight_dVar[0][1] = dt1 + 0.0*( t0 * dt1 * sumOfTrans - dt1 * t0 * t1 ) / ( sumOfTrans * sumOfTrans );
}
