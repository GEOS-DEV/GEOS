...
void compareTransmissibilityMatrices( stackArray2d< real64, MAX_NUM_FACES *MAX_NUM_FACES > const & transMatrix,
                                      stackArray2d< real64, MAX_NUM_FACES *MAX_NUM_FACES > const & transMatrixRef )
{
...
void makeHexa( array2d< real64, nodes::REFERENCE_POSITION_PERM > & nodePosition,
               ...
               stackArray2d< real64, MAX_NUM_FACES *MAX_NUM_FACES > & transMatrixRef )
{
  ...
  transMatrixRef.resize( numFaces, numFaces );

  if( ipType == SinglePhaseHybridFVM::InnerProductType::TPFA )
  {
  ...
  else if( ipType == SinglePhaseHybridFVM::InnerProductType::QUASI_TPFA )
  {
    transMatrixRef( 0, 0 ) = 4e-12;
...
TEST( testHybridFVMInnerProducts, TPFA_hexa )
{
  ...
  makeHexa( nodePosition,
            ...
            elemPerm,
            lengthTolerance,
            SinglePhaseHybridFVM::InnerProductType::TPFA,
            transMatrixRef );

  stackArray2d< real64, MAX_NUM_FACES *MAX_NUM_FACES > transMatrix( transMatrixRef.size( 0 ),
...
TEST( testHybridFVMInnerProducts, QTPFA_hexa )
{
  ...
  makeHexa( nodePosition,
            ...
            elemPerm,
            lengthTolerance,
            SinglePhaseHybridFVM::InnerProductType::QUASI_TPFA,
            transMatrixRef );
...
TEST( testHybridFVMInnerProducts, QTPFA_tetra )
{
  ...
  bool const orthonormalizeWithSVD = true;
  real64 const tParam = 2;
