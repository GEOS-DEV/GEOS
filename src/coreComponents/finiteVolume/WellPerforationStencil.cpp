...
/**
 * @file WellPerforationStencil.cpp
 */

#include "WellPerforationStencil.hpp"

namespace geos
{

WellPerforationStencil::WellPerforationStencil()
  : StencilBase()
{
...
void WellPerforationStencil::reserve( localIndex const size )
{
...
void WellPerforationStencil::add( localIndex const numPts,
...
void WellPerforationStencil::addVectors( real64 const & transMultiplier,
...
WellPerforationStencil::KernelWrapper
WellPerforationStencil::createKernelWrapper() const
{
...
WellPerforationStencilWrapper::
  WellPerforationStencilWrapper( IndexContainerType const & elementRegionIndices,
