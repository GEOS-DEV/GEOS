...
/**
 * @file WellPerforationStencil.hpp
 */

#ifndef GEOS_FINITEVOLUME_WELLPERFORATIONSTENCIL_HPP_
#define GEOS_FINITEVOLUME_WELLPERFORATIONSTENCIL_HPP_
 ...
 */
class WellPerforationStencilWrapper : public StencilWrapperBase< TwoPointStencilTraits >
{
public:
...
/**
 * @class WellPerforationStencil
 *
 * Provides management of the interior stencil points when using Two-Point flux approximation.
 */
class WellPerforationStencil final : public StencilBase< TwoPointStencilTraits, WellPerforationStencil >
{
public:
  ...
  using KernelWrapper = WellPerforationStencilWrapper;
...
#endif // GEOS_FINITEVOLUME_WELLPERFORATIONSTENCIL_HPP_
