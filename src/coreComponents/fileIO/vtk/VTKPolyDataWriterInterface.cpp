...
vtkSmartPointer<vtkPoints> VTKPolyDataWriterInterface::GetVTKPoints(
...
void VTKPolyDataWriterInterface::WriteNodeFields(
...
void VTKPolyDataWriterInterface::WriteElementFields(
...
void VTKPolyDataWriterInterface::WriteCellElementRegions(
  real64 time,
  ElementRegionManager const& elemManager,
  NodeManager const& nodeManager) const
{
...
void VTKPolyDataWriterInterface::WriteWellElementRegions(
  real64 time,
  ElementRegionManager const& elemManager,
  NodeManager const& nodeManager) const
{
...
void VTKPolyDataWriterInterface::WriteFaceElementRegions(
  real64 time,
  ElementRegionManager const& elemManager,
  NodeManager const& nodeManager) const
{
...
void VTKPolyDataWriterInterface::WriteEmbeddedSurfaceElementRegions(
  real64 time,
  ElementRegionManager const& elemManager,
  NodeManager const& nodeManager,
  EdgeManager const& edgeManager) const
...
void VTKPolyDataWriterInterface::WriteUnstructuredGrid(
