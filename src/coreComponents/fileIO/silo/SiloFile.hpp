 ...
 */
  ...
  void WriteMultiXXXX(const DBObjectType type,
                      CBF DBPutMultiCB,
                      int const centering,
                      string const name,
                      int const cycleNumber,
   ...
   * @param numGroups number of individual Silo files to generate
   */
  void setNumGroups(int const numGroups) { m_numGroups = numGroups; }
 ...
 */
template <typename OUTTYPE> int DB_TYPE();
 ...
 */
template <typename TYPE> int GetNumberOfVariablesInField();

/**
 * @tparam TYPE the data type in question
 * @return the silo DB_VARTYPE specifier that describes the rank of the variable.
 */
template <typename TYPE> int GetTensorRank();
 ...
 */
template <>
inline long int CastField<long int, long int>(const long int &field,
                                              int const dummy)
{
  GEOSX_UNUSED_VAR(dummy);
  return field;
 ...
 */
template <>
inline int CastField<int, long int>(const long int &field, int const dummy)
{
  GEOSX_UNUSED_VAR(dummy);
 ...
 */
template <>
inline long long int CastField<long long int, long long int>(
 ...
 */
template <>
inline int CastField<int, long long int>(const long long int &field,
                                         int const dummy)
{
  GEOSX_UNUSED_VAR(dummy);
  return LvArray::integerConversion<int>(field);
 ...
 */
template <>
inline real64 CastField<real64, real64>(const real64 &field, int const dummy)
{
  GEOSX_UNUSED_VAR(dummy);
  return field;
}
 ...
 */
template <>
inline float CastField<float, real64>(const real64 &field, int const dummy)
{
  GEOSX_UNUSED_VAR(dummy);
