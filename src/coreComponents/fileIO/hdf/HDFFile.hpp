...
/**
 * @brief Specialization of GetHDFDataType for char.
 * @copydoc GetHDFDataType
 */
template <>
inline hid_t GetHDFDataType<char>() { return H5T_NATIVE_CHAR; }
/**
 * @brief Specialization of GetHDFDataType for signed char.
 * @copydoc GetHDFDataType
 */
template <>
inline hid_t GetHDFDataType<signed char>() { return H5T_NATIVE_CHAR; }
/**
 * @brief Specialization of GetHDFDataType for real32.
 * @copydoc GetHDFDataType
 */
template <>
inline hid_t GetHDFDataType<real32>() { return H5T_NATIVE_FLOAT; }
/**
 * @brief Specialization of GetHDFDataType for real64.
 * @copydoc GetHDFDataType
 */
template <>
inline hid_t GetHDFDataType<real64>() { return H5T_NATIVE_DOUBLE; }
/**
 * @brief Specialization of GetHDFDataType for integer.
 * @copydoc GetHDFDataType
 */
template <>
inline hid_t GetHDFDataType<integer>() { return H5T_NATIVE_INT; }
/**
 * @brief Specialization of GetHDFDataType for localIndex.
 * @copydoc GetHDFDataType
 */
template <>
inline hid_t GetHDFDataType<localIndex>() { return H5T_NATIVE_LONG; }
/**
 * @brief Specialization of GetHDFDataType for globalIndex.
 * @copydoc GetHDFDataType
 */
template <>
