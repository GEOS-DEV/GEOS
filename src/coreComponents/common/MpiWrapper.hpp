...
#if !defined(GEOS_USE_MPI)
  static map< int, std::pair< int, void * > > & getTagToPointersMap()
  {
    static map< int, std::pair< int, void * > > tagToPointers;
...
#else
  map< int, std::pair< int, void * > > & pointerMap = getTagToPointersMap();
  map< int, std::pair< int, void * > >::iterator iPointer = pointerMap.find( tag );
