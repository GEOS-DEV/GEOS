...
TableLayout::Column & TableLayout::addColumns( stdVector< string > const & columnNames )
{
...
TableLayout::Column & TableLayout::addColumns( stdVector< TableLayout::Column > const & columns )
{
