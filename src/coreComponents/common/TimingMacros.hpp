...
#define GEOSX_CXX_MARK_LOOP_BEGIN(loop, loopName) CALI_CXX_MARK_LOOP_BEGIN(loop,DO_STRINGIFY(loopName))
...
#define GEOSX_CXX_MARK_FUNCTION CALI_CXX_MARK_FUNCTION
...
#define GEOSX_CXX_MARK_FUNCTION
