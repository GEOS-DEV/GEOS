...
{
  test( { { "displacement", DofManager::Location::Node, 3, { "region1", "region3", "region4" } } } );
}
...
{
  test( { { "pressure", DofManager::Location::Elem, 2, { "region1", "region3", "region4" } } } );
}
...
{
  test( { { "flux", DofManager::Location::Face, 2, { "region1", "region3", "region4" } } } );
}
