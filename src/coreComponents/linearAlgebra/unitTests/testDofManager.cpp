 ...
 */
template <>
void checkLocalDofNumbers<DofManager::Location::Elem>(
 ...
 */
void checkStride(arrayView1d<globalIndex const> const& dofNumbers,
 ...
 */
template <typename LAI> class DofManagerMatrixTest : public DofManagerTestBase
{
protected:
...
template <typename LAI>
void DofManagerSparsityTest<LAI>::test(
...
template <typename LAI>
void DofManagerRestrictorTest<LAI>::test(
  std::vector<FieldDesc> fields,
  std::vector<DofManager::SubComponent> selection,
  std::map<std::pair<string, string>, CouplingDesc> couplings)
{
