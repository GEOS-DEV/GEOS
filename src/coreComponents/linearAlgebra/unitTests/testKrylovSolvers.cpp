...
TYPED_TEST_P(KrylovSolverTest, CG) { this->test(params_CG()); }

TYPED_TEST_P(KrylovSolverTest, BiCGSTAB) { this->test(params_BiCGSTAB()); }

TYPED_TEST_P(KrylovSolverTest, GMRES) { this->test(params_GMRES()); }
...
TYPED_TEST_P(KrylovSolverBlockTest, CG) { this->test(params_CG()); }

TYPED_TEST_P(KrylovSolverBlockTest, BiCGSTAB) { this->test(params_BiCGSTAB()); }

TYPED_TEST_P(KrylovSolverBlockTest, GMRES) { this->test(params_GMRES()); }
