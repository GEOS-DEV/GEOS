...
#ifndef GEOS_LINEARALGEBRA_MULTISCALE_DOFMANAGER_HPP
#define GEOS_LINEARALGEBRA_MULTISCALE_DOFMANAGER_HPP
...
#endif //GEOS_LINEARALGEBRA_MULTISCALE_DOFMANAGER_HPP
