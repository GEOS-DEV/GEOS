                          ...
                          MeshObjectManager & msNodeManager )
{
  ...
  // Remove index fields on the GEOS mesh
  dofManager.clear();
}
                                   ...
                                   localIndex const numLocalCells )
{
  ...
  {
    // Allocate an element-based field on the GEOS mesh that will keep a mapping to new cell local indices
                          ...
                          MeshObjectManager & msCellManager )
{
  ...
  // Make sure to remove temporary global index field on the GEOS mesh
  dofManager.clear();
}
                               ...
                               Span< geos::DofManager::FieldSupport const > const support )
{
  ...
  // Allocate fields on the GEOS sourceMesh that will keep mappings to new local indices
  ...
  // Remove local index fields used during construction from GEOS sourceMesh
