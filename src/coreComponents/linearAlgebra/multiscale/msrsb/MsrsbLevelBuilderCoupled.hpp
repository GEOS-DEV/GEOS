...
#ifndef GEOS_LINEARALGEBRA_MULTISCALE_MSRSBLEVELBUILDERCOUPLED_HPP
#define GEOS_LINEARALGEBRA_MULTISCALE_MSRSBLEVELBUILDERCOUPLED_HPP
...
#endif //GEOS_LINEARALGEBRA_MULTISCALE_MSRSBLEVELBUILDERCOUPLED_HPP
