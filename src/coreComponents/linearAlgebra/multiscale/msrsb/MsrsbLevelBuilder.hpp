...
#ifndef GEOS_LINEARALGEBRA_MULTISCALE_MSRSBSTRATEGY_HPP
#define GEOS_LINEARALGEBRA_MULTISCALE_MSRSBSTRATEGY_HPP
...
#endif //GEOS_LINEARALGEBRA_MULTISCALE_MSRSBSTRATEGY_HPP
