...
#ifndef GEOS_LINEARALGEBRA_MULTISCALE_LEVELBUILDERBASE_HPP_
#define GEOS_LINEARALGEBRA_MULTISCALE_LEVELBUILDERBASE_HPP_
...
#endif //GEOS_LINEARALGEBRA_MULTISCALE_LEVELBUILDERBASE_HPP_
