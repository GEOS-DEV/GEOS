...
/**
 * @file ExpBicgstabSolver.hpp
 */

#ifndef GEOSX_LINEARALGEBRA_SOLVERS_EXPBICGSTABSOLVER_HPP_
#define GEOSX_LINEARALGEBRA_SOLVERS_EXPBICGSTABSOLVER_HPP_
...
/**
 * @brief This class implements ~~~ add proper description ~~~~
...
class ExpBicgstabSolver : public KrylovSolver< VECTOR >
{
public:
   ...
   */
  ExpBicgstabSolver( LinearSolverParameters params,
...
#endif /*GEOSX_LINEARALGEBRA_SOLVERS_EXPBICGSTABSOLVER_HPP_ */
