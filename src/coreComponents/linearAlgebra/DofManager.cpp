...
void DofManager::addField(string const &fieldName, Location const location)
{
...
template <typename MATRIX>
void DofManager::setSparsityPattern(MATRIX &matrix, bool const closePattern) const
{
  GEOSX_MARK_FUNCTION;
  GEOSX_ERROR_IF(!m_reordered,
...
{
template <int N>
GEOSX_HOST_DEVICE inline localIndex getNeighborNodes(
  localIndex (&neighborNodes)[N],
  arrayView1d<arrayView1d<arrayView2d<localIndex const, cells::NODE_MAP_USD> const> const> const
    &elemsToNodes,
...
void DofManager::setFiniteElementSparsityPattern(
  ...
  localIndex const fieldIndex) const
{
  ...
  arrayView1d<arrayView1d<arrayView2d<localIndex const, cells::NODE_MAP_USD> const> const> const
    &elemsToNodes = elemsToNodesArray.toViewConst();
...
std::vector<DofManager::SubComponent> DofManager::filterDofs(
