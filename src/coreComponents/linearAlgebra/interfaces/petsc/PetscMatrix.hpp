...
public:
  ...
  virtual void
  add( globalIndex const rowIndex,
       globalIndex const colIndex,
       real64 const value ) override;

  virtual void
  set( globalIndex const rowIndex,
       globalIndex const colIndex,
       real64 const value ) override;

  virtual void
  insert( globalIndex const rowIndex,
          globalIndex const colIndex,
          real64 const value ) override;
  ...
  virtual void
  add( globalIndex const * rowIndices,
       globalIndex const * colIndices,
       real64 const * values,
  ...
  virtual void
  set( globalIndex const * rowIndices,
       globalIndex const * colIndices,
       real64 const * values,
       localIndex const numRows,
       localIndex const numCols ) override;
  ...
  virtual void
  insert( globalIndex const * rowIndices,
          globalIndex const * colIndices,
          real64 const * values,
          localIndex const numRows,
          localIndex const numCols ) override;
  ...
  virtual void
  apply( PetscVector const & src, PetscVector & dst ) const override;

  virtual void
  multiply( PetscMatrix const & src, PetscMatrix & dst ) const override;

  virtual void
  applyTranspose( Vector const & src, Vector & dst ) const override;

  virtual void
  leftMultiplyTranspose( PetscMatrix const & src,
                         PetscMatrix & dst ) const override;

  virtual void
  rightMultiplyTranspose( PetscMatrix const & src,
                          PetscMatrix & dst ) const override;

  virtual void
  multiplyRAP( PetscMatrix const & R,
               PetscMatrix const & P,
               PetscMatrix & dst ) const override;

  virtual void
  multiplyPtAP( PetscMatrix const & P, PetscMatrix & dst ) const override;

  virtual void
  gemv( real64 const alpha,
        PetscVector const & x,
        real64 const beta,
        PetscVector & y,
  ...
  virtual void
  leftScale( PetscVector const & vec ) override;

  virtual void
  rightScale( PetscVector const & vec ) override;

  virtual void
  leftRightScale( PetscVector const & vecLeft,
                  PetscVector const & vecRight ) override;

  virtual void
  transpose( PetscMatrix & dst ) const override;

  virtual real64
  clearRow( globalIndex const row,
            bool const keepDiag = false,
            real64 const diagValue = 0.0 ) override;

  virtual void
  addEntries( PetscMatrix const & src,
              real64 const scale = 1.0 ) override;

  virtual void
  addDiagonal( PetscVector const & src ) override;

  virtual localIndex
  maxRowLength() const override;

  virtual localIndex
  localRowLength( localIndex localRowIndex ) const override;

  virtual localIndex
  globalRowLength( globalIndex globalRowIndex ) const override;

  virtual real64
  getDiagValue( globalIndex globalRow ) const override;

  virtual void
  extractDiagonal( PetscVector & dst ) const override;

  virtual void
  getRowCopy( globalIndex globalRow,
              arraySlice1d< globalIndex > const & colIndices,
              arraySlice1d< real64 > const & values ) const override;

  virtual globalIndex
  numGlobalRows() const override;

  virtual globalIndex
  numGlobalCols() const override;

  virtual localIndex
  numLocalRows() const override;

  virtual localIndex
  numLocalCols() const override;
  ...
  virtual globalIndex
  jlower() const override;

  virtual globalIndex
  jupper() const override;

  virtual localIndex
  numLocalNonzeros() const override;

  virtual globalIndex
  numGlobalNonzeros() const override;
  ...
  virtual real64
  normFrobenius() const override;

  virtual localIndex
  getLocalRowID( globalIndex const index ) const override;

  virtual globalIndex
  getGlobalRowID( localIndex const index ) const override;
