...
{
  staticstdMap< LinearSolverParameters::PreconditionerType, PCJacobiType > const typeMap =
  {
...
{
  staticstdMap< LinearSolverParameters::PreconditionerType, MatSORType > const typeMap =
  {
...
{
  staticstdMap< LinearSolverParameters::AMG::CycleType, PCMGCycleType > const typeMap =
  {
