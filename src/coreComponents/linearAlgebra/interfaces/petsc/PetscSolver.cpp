...
void PetscSolver::solve_direct(PetscMatrix& mat, PetscVector& sol, PetscVector& rhs)
{
...
void PetscSolver::solve_krylov(PetscMatrix& mat, PetscVector& sol, PetscVector& rhs)
{
  Stopwatch watch;
