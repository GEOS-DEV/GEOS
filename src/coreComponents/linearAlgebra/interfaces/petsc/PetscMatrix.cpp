...
namespace geosx
{
PetscMatrix::PetscMatrix() : LinearOperator(), MatrixBase(), m_mat {} { }

PetscMatrix::PetscMatrix(PetscMatrix const& src) : PetscMatrix()
{
...
bool PetscMatrix::created() const { return m_mat != nullptr; }
...
void PetscMatrix::apply(PetscVector const& src, PetscVector& dst) const
{
  GEOSX_LAI_ASSERT(ready());
  GEOSX_LAI_ASSERT(src.ready());
...
void PetscMatrix::applyTranspose(Vector const& src, Vector& dst) const
{
  GEOSX_LAI_ASSERT(ready());
  GEOSX_LAI_ASSERT(src.ready());
  GEOSX_LAI_ASSERT(dst.ready());
...
void PetscMatrix::multiply(PetscMatrix const& src, PetscMatrix& dst) const
{
  GEOSX_LAI_ASSERT(ready());
  GEOSX_LAI_ASSERT(src.ready());
...
void PetscMatrix::multiplyPtAP(PetscMatrix const& P, PetscMatrix& dst) const
{
  GEOSX_LAI_ASSERT(ready());
...
void PetscMatrix::write(string const& filename, LAIOutputFormat const format) const
{
  GEOSX_LAI_ASSERT(ready());
