...
double GEOSX_dasum(int const* N, double const* DX, int const* INCX);
...
int GEOSX_idamax(int const* N, double const* DX, int const* INCX);
...
void GEOSX_dlarnv(int const* IDIST, int* ISEED, int const* N, double* X);

  #define GEOSX_dnrm2 FORTRAN_MANGLE(dnrm2)
double GEOSX_dnrm2(int const* N, double const* X, int const* INCX);

  #define GEOSX_dscal FORTRAN_MANGLE(dscal)
void GEOSX_dscal(int const* N, double const* DA, double* DX, int const* INCX);
