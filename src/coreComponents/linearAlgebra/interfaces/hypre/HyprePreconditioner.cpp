...
HyprePreconditioner::~HyprePreconditioner() { clear(); }
...
void HyprePreconditioner::apply(Vector const& src, Vector& dst) const
{
...
HYPRE_Solver const& HyprePreconditioner::unwrapped() const { return m_precond; }
