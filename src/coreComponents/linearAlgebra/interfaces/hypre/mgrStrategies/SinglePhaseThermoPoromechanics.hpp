...
/**
 * @file SinglePhaseThermoPoromechanics.hpp
 */

#ifndef GEOSX_LINEARALGEBRA_INTERFACES_HYPREMGRSINGLEPHASETHERMOPOROMECHANICS_HPP_
#define GEOSX_LINEARALGEBRA_INTERFACES_HYPREMGRSINGLEPHASETHERMOPOROMECHANICS_HPP_
...
/**
 * @brief SinglePhaseThermoPoromechanics strategy.
 *
 ...
 */
class SinglePhaseThermoPoromechanics : public MGRStrategyBase< 1 >
{
public:
   ...
   * @brief Constructor.
   */
  explicit SinglePhaseThermoPoromechanics( arrayView1d< int const > const & )
    : MGRStrategyBase( 4 )
  {
...
#endif /*GEOSX_LINEARALGEBRA_INTERFACES_HYPREMGRSINGLEPHASETHERMOPOROMECHANICS_HPP_*/
