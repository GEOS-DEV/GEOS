...
#ifndef GEOS_LINEARALGEBRA_INTERFACES_HYPREMGRSMULIPHASEPOROMECHANICSCONTACT_HPP_
#define GEOS_LINEARALGEBRA_INTERFACES_HYPREMGRSMULIPHASEPOROMECHANICSCONTACT_HPP_
 ...
 *
 * Ingredients:
 * 1. Level 1: F-points lag mult (3,4,5), C-points displacements, pressure and densities (0,1,2,6,7...)
 * 2. Level 2: F-points displacement (0,1,2), C-points pressure and densities (6,7...)
 * 2. F-points smoother: BoomerAMG, single V-cycle
 * 3. Level 3: F-points densities (7,...) and C-points pressure (6)
 * 4. C-points coarse-grid/Schur complement solver: BoomerAMG
 * 5. Global smoother: none
 */
class MultiphasePhasePoromechanicsConformingFractures : public MGRStrategyBase< 3 >
{
public:
  ...
  explicit MultiPhasePoromechanicsConformingFractures( arrayView1d< int const > const & )
    : MGRStrategyBase( ... )
    //LvArray::integerConversion< HYPRE_Int >( numComponentsPerField[0] + numComponentsPerField[1] + numComponentsPerField[2] ) 
  {

    // we keep u, dens and p
    m_labels[0].resize( m_dens );
...
#endif /* GEOS_LINEARALGEBRA_INTERFACES_HYPREMGRSMULIPHASEPOROMECHANICSCONTACT_HPP_ */