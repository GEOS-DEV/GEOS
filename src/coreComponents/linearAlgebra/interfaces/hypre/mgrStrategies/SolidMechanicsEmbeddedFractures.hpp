...
#ifndef GEOSX_LINEARALGEBRA_INTERFACES_HYPREMGRSOLIDMECHANICSEMBEDDEDFRACTURES_HPP_
#define GEOSX_LINEARALGEBRA_INTERFACES_HYPREMGRSOLIDMECHANICSEMBEDDEDFRACTURES_HPP_
 ...
 *
 * Enriched finite element method for solid mechanics with embedded fractures
 *
 * dofLabel: 0 = displacement, x-component
 * dofLabel: 1 = displacement, y-component
 * dofLabel: 2 = displacement, z-component
 * dofLabel: 3 = displacement jump
 *
 * Ingredients:
 * 1. F-points displacement (0,1,2), C-points displacement jump (3)
...
#endif /*GEOSX_LINEARALGEBRA_INTERFACES_HYPREMGRSOLIDMECHANICSEMBEDDEDFRACTURES_HPP_*/
