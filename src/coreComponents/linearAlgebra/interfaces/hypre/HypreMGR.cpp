                            ...
                            HypreMGRData & mgrData )
{
  ...
  GEOS_LAI_CHECK_ERROR( HYPRE_MGRSetTol( precond.ptr, mgrParameters.tolerance ) );
  GEOS_LAI_CHECK_ERROR( HYPRE_MGRSetMaxIter( precond.ptr, mgrParameters.maxIterations ) );
