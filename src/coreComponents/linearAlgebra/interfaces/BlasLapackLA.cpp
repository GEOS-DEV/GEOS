...
template <int USD>
static real64 matrixNorm(arraySlice2d<real64 const, USD> const& A, char const NORM)
{
...
template <int USD>
void matrixScale(real64 const alpha, arraySlice2d<real64, USD> const& A)
{
  int const INCX = 1;
  int const N = LvArray::integerConversion<int>(A.size());
...
real64 BlasLapackLA::determinant(
...
real64 BlasLapackLA::matrixNormInf(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A)
{
...
real64 BlasLapackLA::matrixNorm1(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A)
{
...
real64 BlasLapackLA::matrixNormFrobenius(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A)
{
...
void BlasLapackLA::matrixMatrixAdd(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
...
void BlasLapackLA::vectorScale(real64 const alpha, arraySlice1d<real64> const& X)
{
  int const INCX = 1;
  int const N = LvArray::integerConversion<int>(X.size());
...
void BlasLapackLA::matrixVectorMultiply(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
...
void BlasLapackLA::matrixTVectorMultiply(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
  arraySlice1d<real64 const> const& X,
  arraySlice1d<real64> const& Y,
  real64 const alpha,
...
void BlasLapackLA::matrixMatrixMultiply(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
...
void BlasLapackLA::matrixTMatrixMultiply(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& B,
  arraySlice2d<real64, MatrixLayout::ROW_MAJOR> const& C,
  real64 const alpha,
...
void BlasLapackLA::matrixMatrixTMultiply(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& B,
  arraySlice2d<real64, MatrixLayout::ROW_MAJOR> const& C,
  real64 const alpha,
...
void BlasLapackLA::matrixTMatrixTMultiply(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& B,
  arraySlice2d<real64, MatrixLayout::ROW_MAJOR> const& C,
  real64 const alpha,
...
void BlasLapackLA::matrixInverse(
  arraySlice2d<real64 const, MatrixLayout::ROW_MAJOR> const& A,
