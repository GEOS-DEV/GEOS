...
std::unique_ptr<Epetra_Operator> CreateMLOperator(LinearSolverParameters const& params,
...
std::unique_ptr<Epetra_Operator> CreateIfpackOperator(
...
void TrilinosPreconditioner::apply(Vector const& src, Vector& dst) const
{
