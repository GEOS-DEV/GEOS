...
{
  static map< LinearSolverParameters::AMG::CycleType, string > const optionMap =
  {
...
{
  static map< LinearSolverParameters::AMG::SmootherType, string > const optionMap =
  {
...
{
  static map< LinearSolverParameters::AMG::CoarseType, string > const optionMap =
  {
...
{
  static map< LinearSolverParameters::AMG::PreOrPost, string > const optionMap =
  {
...
{
  static map< LinearSolverParameters::PreconditionerType, Ifpack::EPrecType > const typeMap =
  {
...
{
  static map< LinearSolverParameters::PreconditionerType, string > const typeMap =
  {
