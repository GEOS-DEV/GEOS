...
namespace geosx
{
EpetraMatrix::EpetraMatrix() : LinearOperator(), MatrixBase() { }

EpetraMatrix::EpetraMatrix(EpetraMatrix const& src) : EpetraMatrix()
{
...
bool EpetraMatrix::created() const { return bool(m_matrix); }
...
void EpetraMatrix::apply(EpetraVector const& src, EpetraVector& dst) const
{
  GEOSX_LAI_ASSERT(ready());
  GEOSX_LAI_ASSERT(src.ready());
...
void EpetraMatrix::applyTranspose(EpetraVector const& src, EpetraVector& dst) const
{
  GEOSX_LAI_ASSERT(ready());
  GEOSX_LAI_ASSERT(src.ready());
  GEOSX_LAI_ASSERT(dst.ready());
...
void EpetraMatrix::multiply(EpetraMatrix const& src, EpetraMatrix& dst) const
{
...
void EpetraMatrix::multiplyPtAP(EpetraMatrix const& P, EpetraMatrix& dst) const
{
...
void EpetraMatrix::write(string const& filename, LAIOutputFormat const format) const
{
  GEOSX_LAI_ASSERT(ready());
  switch(format)
  {
