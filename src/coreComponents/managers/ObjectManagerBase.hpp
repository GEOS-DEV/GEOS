...
private:
   ...
   */
  template <bool DOPACK>
  localIndex PackParentChildMapsPrivate(
...
public:
   ...
   */
  localIndex resize(localIndex const newSize, const bool /*assignGlobals*/)
  {
   ...
   */
  static localIndex GetParentRecusive(
  ...
  dataRepository::Wrapper<typename MESH_DATA_TRAIT::type> &registerExtrinsicData(
   ...
   */
  template <typename MESH_DATA_TRAIT> auto const &getExtrinsicData() const
  {
    return this
   ...
   */
  template <typename MESH_DATA_TRAIT> auto &getExtrinsicData()
  {
    return this
      ->getWrapper<typename MESH_DATA_TRAIT::type>(MESH_DATA_TRAIT::key)
      ->referenceAsView();
   ...
   */
  template <typename MESH_DATA_TRAIT> bool hasExtrinsicData() const
  {
   ...
   */
  arrayView1d<integer> const &isExternal() { return this->m_isExternal; }
   ...
   */
  arrayView1d<integer> const &ghostRank() { return this->m_ghostRank; }
   ...
   * @return The index.
   */
  globalIndex maxGlobalIndex() const { return m_maxGlobalIndex; }
...
inline void ObjectManagerBase::FixUpDownMaps(
  ArrayOfSets<localIndex> &relation,
  unordered_map<globalIndex, localIndex> const &globalToLocal,
  map<localIndex, SortedArray<globalIndex>> &unmappedIndices,
  bool const clearIfUnmapped)
