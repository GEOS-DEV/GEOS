...
void ObjectManagerBase::ConstructSetFromSetAndMap(
...
void ObjectManagerBase::ConstructLocalListOfBoundaryObjects(
...
void ObjectManagerBase::ConstructGlobalListOfBoundaryObjects(
...
template <bool DOPACK>
localIndex ObjectManagerBase::PackParentChildMapsPrivate(
...
template localIndex ObjectManagerBase::PackParentChildMapsPrivate<true>(
  buffer_unit_type*& buffer,
  arrayView1d<localIndex const> const& packList) const;
template localIndex ObjectManagerBase::PackParentChildMapsPrivate<false>(
  buffer_unit_type*& buffer,
  arrayView1d<localIndex const> const& packList) const;
...
template <bool DOPACK>
localIndex ObjectManagerBase::PackSets(
  buffer_unit_type*& buffer,
  arrayView1d<localIndex const> const& packList) const
{
  localIndex packedSize = 0;
...
localIndex ObjectManagerBase::PackGlobalMapsSize(
...
template <bool DOPACK>
localIndex ObjectManagerBase::PackGlobalMapsPrivate(
  buffer_unit_type*& buffer,
  arrayView1d<localIndex const> const& packList,
  integer const recursive) const
{
...
void ObjectManagerBase::ViewPackingExclusionList(
...
void ObjectManagerBase::CopyObject(const localIndex source,
...
void ObjectManagerBase::CleanUpMap(
...
void ObjectManagerBase::enforceStateFieldConsistencyPostTopologyChange(
  std::set<localIndex> const& targetIndices)
{
