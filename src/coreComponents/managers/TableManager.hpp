...
template <>
inline void TableManager::NewTable<1>( const std::string & name, const Array1dT<rArray1d> & x, const rArray1d & values,
                                       TableInterpolation::Order interp )
{
...
template <>
inline void TableManager::NewTable<2>( const std::string & name, const Array1dT<rArray1d> & x, const rArray1d & values,
                                       TableInterpolation::Order interp )
{
...
template <>
inline void TableManager::NewTable<3>( const std::string & name, const Array1dT<rArray1d> & x, const rArray1d & values,
                                       TableInterpolation::Order interp )
{
...
template <>
inline void TableManager::NewTable<4>( const std::string & name, const Array1dT<rArray1d> & x, const rArray1d & values,
                                       TableInterpolation::Order interp )
{
