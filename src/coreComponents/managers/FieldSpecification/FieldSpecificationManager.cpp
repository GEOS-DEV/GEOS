...
FieldSpecificationManager::FieldSpecificationManager( std::string const & name, Group * const parent ):
  Group( name, parent )
{
...
Group * FieldSpecificationManager::createChild( std::string const & childKey, std::string const & childName )
{
