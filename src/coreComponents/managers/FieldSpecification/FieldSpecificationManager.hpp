...
#ifndef GEOSX_BOUNDARYCONDITIONS_BOUNDARYCONDITIONMANAGER_HPP_
#define GEOSX_BOUNDARYCONDITIONS_BOUNDARYCONDITIONMANAGER_HPP_
...
#endif /*
          GEOSX_BOUNDARYCONDITIONS_BOUNDARYCONDITIONMANAGER_HPP_
        */
