...
#ifndef GEOSX_TENSOR_TRAITS_HPP_
#define GEOSX_TENSOR_TRAITS_HPP_

#include "containers/container_traits.hpp"
#include "layouts/layout_traits.hpp"
#include "containers/stack_container.hpp"
...
struct is_tensor_v<TensorBase<C,L>>
{
...
template <typename Container, typename Layout>
struct get_tensor_rank_v<TensorBase<Container,Layout>>
{
...
template <typename C, typename L>
struct get_tensor_value_type_t<TensorBase<C,L>>
{
   using type = get_container_type<C>;
};

template <typename C, typename L>
struct get_tensor_value_type_t<const TensorBase<C,L>>
{
   using type = get_container_type<C>;
};
...
template <typename C, typename L>
struct is_dynamic_tensor_v<TensorBase<C,L>>
{
   static constexpr bool value = is_dynamic_layout<L>;
};

template <typename C, typename L>
struct is_dynamic_tensor_v<const TensorBase<C,L>>
{
   static constexpr bool value = is_dynamic_layout<L>;
};
...
template <typename C, typename L>
struct is_static_tensor_v<TensorBase<C,L>>
{
   static constexpr bool value = is_static_layout<L>;
};

template <typename C, typename L>
struct is_static_tensor_v<const TensorBase<C,L>>
{
   static constexpr bool value = is_static_layout<L>;
};
...
template <typename C, typename L>
struct is_serial_tensor_v<TensorBase<C,L>>
{
   static constexpr bool value = is_serial_layout<L>;
};

template <typename C, typename L>
struct is_serial_tensor_v<const TensorBase<C,L>>
{
   static constexpr bool value = is_serial_layout<L>;
};
...
template <typename C, typename L>
struct is_1d_threaded_tensor_v<TensorBase<C,L>>
{
   static constexpr bool value = is_1d_threaded_layout<L>;
};

template <typename C, typename L>
struct is_1d_threaded_tensor_v<const TensorBase<C,L>>
{
   static constexpr bool value = is_1d_threaded_layout<L>;
};
...
template <typename C, typename L>
struct is_2d_threaded_tensor_v<TensorBase<C,L>>
{
   static constexpr bool value = is_2d_threaded_layout<L>;
};

template <typename C, typename L>
struct is_2d_threaded_tensor_v<const TensorBase<C,L>>
{
   static constexpr bool value = is_2d_threaded_layout<L>;
};
...
template <typename C, typename L>
struct is_3d_threaded_tensor_v<TensorBase<C,L>>
{
   static constexpr bool value = is_3d_threaded_layout<L>;
};

template <typename C, typename L>
struct is_3d_threaded_tensor_v<const TensorBase<C,L>>
{
   static constexpr bool value = is_3d_threaded_layout<L>;
};
...
struct is_serial_tensor_dim_v<N,TensorBase<C, Layout>>
{
...
template <int N, typename C, typename Layout>
struct is_threaded_tensor_dim_v<N,TensorBase<C, Layout>>
{
...
struct get_tensor_size_v<N, TensorBase<C,L>>
{
   static constexpr int value = get_layout_size<N, L>;
};

template <int N, typename C, typename L>
struct get_tensor_size_v<N, const TensorBase<C,L>>
{
   static constexpr int value = get_layout_size<N, L>;
};
...
struct get_tensor_sizes_t<TensorBase<C,Layout>>
{
...
template <typename C, typename L>
struct get_tensor_batch_size_v<TensorBase<C,L>>
{
   static constexpr int value = get_layout_batch_size<L>;
};

template <typename C, typename L>
struct get_tensor_batch_size_v<const TensorBase<C,L>>
{
   static constexpr int value = get_layout_batch_size<L>;
};
...
template <typename C, typename L>
struct get_tensor_capacity_v<TensorBase<C,L>>
{
   static constexpr int value = get_layout_capacity<L>;
};

template <typename C, typename L>
struct get_tensor_capacity_v<const TensorBase<C,L>>
{
   static constexpr int value = get_layout_capacity<L>;
};
...
template <typename C, typename L>
struct has_pointer_container_v<TensorBase<C,L>>
{
   static constexpr bool value = is_pointer_container<C>;
};

template <typename C, typename L>
struct has_pointer_container_v<const TensorBase<C,L>>
{
   static constexpr bool value = is_pointer_container<C>;
};
...
// Sizes deduced
template <typename Container, typename Layout>
struct get_result_tensor_t<TensorBase<Container,Layout>>
{
   ...
   using container = StackContainer<T,get_layout_capacity<layout>>;
   using type = TensorBase<container, layout>;
};

// Sizes given
template <typename Container, typename Layout, int... Sizes>
struct get_result_tensor_t<TensorBase<Container,Layout>,Sizes...>
{
   using T = get_container_type<Container>;
   template <int... Dims>
...
#endif // GEOSX_TENSOR_TRAITS_HPP_
