...
real64 ContactRelationBase::limitTangentialTractionNorm(
...
real64 ContactRelationBase::dLimitTangentialTractionNorm_dNormalTraction(
  real64 const GEOSX_UNUSED_PARAM(normalTraction)) const
{
  GEOSX_ERROR(
...
Group *ContactRelationBase::CreateChild(string const &catalogKey,
