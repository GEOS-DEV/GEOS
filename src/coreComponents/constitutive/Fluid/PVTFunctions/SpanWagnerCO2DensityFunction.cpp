...
namespace PVTProps
{
  ...
  SpanWagnerCO2DensityFunction::SpanWagnerCO2DensityFunction(const string_array& inputPara, const string_array& componentNames, const real64_array& componentMolarWeight) : PVTFunctionBase(componentNames, componentMolarWeight), m_functionName(inputPara[1])
  {
