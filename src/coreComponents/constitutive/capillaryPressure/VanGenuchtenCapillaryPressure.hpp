                                        ...
                                        real64 const & volFracScale )
{
  ...
  if( ip_water >= 0 )
  {
    ...
    real64 const exponentInv   = phaseCapPressureExponentInv[ip_water]; // div by 0 taken care of by initialization
                                                                        // check
  ...
  if( ip_gas >= 0 )
  {
    ...
    real64 const multiplier    = -phaseCapPressureMultiplier[ip_gas]; // for gas capillary pressure, take the opposite
                                                                      // of the VG function
