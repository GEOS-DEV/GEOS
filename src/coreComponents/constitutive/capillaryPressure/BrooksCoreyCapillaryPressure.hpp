...
public:
  ...
  BrooksCoreyCapillaryPressureUpdate& operator=(
...
private:
  GEOSX_HOST_DEVICE
  GEOSX_FORCE_INLINE
  static void EvaluateBrooksCoreyFunction(
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void BrooksCoreyCapillaryPressureUpdate::Compute(
  arraySlice1d<real64 const> const& phaseVolFraction,
  arraySlice1d<real64> const& phaseCapPres,
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void BrooksCoreyCapillaryPressureUpdate::EvaluateBrooksCoreyFunction(
  real64 const scaledWettingVolFrac,
  real64 const dScaledWettingPhaseVolFrac_dVolFrac,
  real64 const exponentInv,
  real64 const entryPressure,
