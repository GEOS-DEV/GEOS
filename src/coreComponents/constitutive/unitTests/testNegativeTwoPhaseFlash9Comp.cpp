...
using PengRobinson9 = NegativeTwoPhaseFlashTest9CompFixture< CubicEOSPhaseModel< PengRobinsonEOS > >;
using SoaveRedlichKwong9 = NegativeTwoPhaseFlashTest9CompFixture< CubicEOSPhaseModel< SoaveRedlichKwongEOS > >;

TEST_P( PengRobinson9, testNegativeFlash )
{
  testFlash( GetParam() );
}

TEST_P( PengRobinson9, testNegativeFlashDerivatives )
{
  testFlashDerivatives( GetParam() );
}

TEST_P( SoaveRedlichKwong9, testNegativeFlash )
{
  testFlash( GetParam() );
}

TEST_P( SoaveRedlichKwong9, testNegativeFlashDerivatives )
{
  testFlashDerivatives( GetParam() );
}
...
INSTANTIATE_TEST_SUITE_P(
  NegativeTwoPhaseFlash, PengRobinson9,
  ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(
  NegativeTwoPhaseFlash, SoaveRedlichKwong9,
  ::testing::Values( 
