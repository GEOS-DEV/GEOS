...
<< std::scientific << std::setprecision(5) << std::setw(12) << leftValues[i] << " " << centreValues[i] << " " << rightValues[i] << " | "
<< std::scientific << std::setprecision(5) << std::setw(12) << derivatives[i]-selectedDerivative << " "
