                               ...
                               real64 relTol )
{
  ...
  arraySlice1d<real64> phaseRelPerm = relPerm->getReference<array3d<real64>>
                                      ( RelativePermeabilityBase::viewKeyStruct::phaseRelPermString )[0][0];
  ...
  arraySlice1d<real64> phaseRelPermCopy = relPermCopy->getReference<array3d<real64>>
                                          ( RelativePermeabilityBase::viewKeyStruct::phaseRelPermString )[0][0];
