                               ...
                               real64 relTol )
{
  ...
  arraySlice1d<real64> phaseCapPressure = capPressure->getReference<array3d<real64>>
                                          ( CapillaryPressureBase::viewKeyStruct::phaseCapPressureString )[0][0];
  ...
  arraySlice1d<real64> phaseCapPressureCopy = capPressureCopy->getReference<array3d<real64>>
                                              ( CapillaryPressureBase::viewKeyStruct::phaseCapPressureString )[0][0];
