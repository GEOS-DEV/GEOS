...
TEST( ElasticTransverseIsotropicTests, testThermalExpansionAndTemperature )
{
  conduit::Node node;
  dataRepository::Group rootGroup( "root", node );
  ElasticTransverseIsotropic constitutiveModel( "model", &rootGroup );

  // Create kernel updates
  ElasticTransverseIsotropicUpdates updates = constitutiveModel.createKernelUpdates();
