...
void RelativePermeabilityBase::ResizeFields(localIndex const size,
...
void RelativePermeabilityBase::AllocateConstitutiveData(
...
void RelativePermeabilityBase::DeliverClone(
  string const& name,
  Group* const parent,
