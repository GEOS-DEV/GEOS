...
void TableRelativePermeability::postInputInitialization()
{
  ...
  if( numPhases == 2 )
  {
    GEOS_THROW_CTX_IF( m_wettingNonWettingRelPermTableNames.empty(),
    ...
    GEOS_THROW_CTX_IF( m_wettingNonWettingRelPermTableNames.size() != 2,
                       GEOS_FMT(
  ...
  {
    GEOS_THROW_CTX_IF( m_wettingIntermediateRelPermTableNames.empty() || m_nonWettingIntermediateRelPermTableNames.empty(),
                       GEOS_FMT(
    ...
    GEOS_THROW_CTX_IF( m_wettingIntermediateRelPermTableNames.size() != 2,
                       GEOS_FMT(
    ...
    GEOS_THROW_CTX_IF( m_nonWettingIntermediateRelPermTableNames.size() != 2,
                       GEOS_FMT(
...
void TableRelativePermeability::initializePreSubGroups()
{
  ...
  if( numPhases == 2 )
  {
    ...
    {
      GEOS_THROW_CTX_IF( !functionManager.hasGroup( m_wettingNonWettingRelPermTableNames[ip] ),
  ...
  else if( numPhases == 3 )
  {
    ...
    {
      GEOS_THROW_CTX_IF( !functionManager.hasGroup( m_wettingIntermediateRelPermTableNames[ip] ),
                         GEOS_FMT( "{}: the table function named {} could not be found",
                                   getFullName(),
    ...
    {
      GEOS_THROW_CTX_IF( !functionManager.hasGroup( m_nonWettingIntermediateRelPermTableNames[ip] ),
                         GEOS_FMT( "{}: the table function named {} could not be found",
                                   getFullName(),
