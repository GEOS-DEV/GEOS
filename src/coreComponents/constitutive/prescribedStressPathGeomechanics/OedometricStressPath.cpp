...
#include "constitutive/prescribedStressPathGeomechanics/OedometricStressPath.hpp"
...
void OedometricStressPath::postInputInitialization()
{
  ...
  //if( getLogLevel() > 0 )
  {
    print(); // aqui a inicializacao do XML foi feita. Tem um NLSP para o solver e para o gerador de surface
  }
}
...
REGISTER_CATALOG_ENTRY( ConstitutiveBase, OedometricStressPath, string const &, Group * const )
