...
public:
  ...
  DamagePermeabilityUpdate( arrayView3d< real64 > const & permeability,
                            ...
                            real64 const & fracturePermeability )
    : PermeabilityBaseUpdate( permeability, dPerm_dPressure ),
    m_bulkPermeability( bulkPermeability ),
    m_fracturePermeability( fracturePermeability )
  {}
  ...
  {
    real64 const matrixPermeability = ( damage > 0.3 )? m_fracturePermeability:m_bulkPermeability;
...
public:
  ...
  struct viewKeyStruct : public PermeabilityBase::viewKeyStruct
  {
    ...
    static constexpr char const * fracturePermeabilityString() { return "fracturePermeability"; }
  } viewKeys;
