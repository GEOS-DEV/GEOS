...
void BrineCO2DensityFunction::CalculateBrineDensity(real64_array const & pressure, real64_array const & temperature, real64 const & salinity, real64_array2d const & density)
{
