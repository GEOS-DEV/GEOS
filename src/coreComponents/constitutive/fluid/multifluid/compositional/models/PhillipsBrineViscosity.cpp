...
PhillipsBrineViscosityUpdate::PhillipsBrineViscosityUpdate( real64 const constantPhaseViscosity ):
...
PhillipsBrineViscosity::Parameters::Parameters( std::unique_ptr< ModelParameters > parameters ):
  ModelParameters( std::move( parameters ) )
{}

void PhillipsBrineViscosity::Parameters::registerParametersImpl( MultiFluidBase * fluid )
{
...
void PhillipsBrineViscosity::Parameters::postInputInitializationImpl( MultiFluidBase const * fluid,
                                                                 ComponentProperties const & componentProperties )
{
  ...
  if( m_constantPhaseViscosity.empty() )
  {
    ...
    {
      m_constantPhaseViscosity[ip] = PhillipsBrineViscosity::defaultViscosity;
    }
  }
