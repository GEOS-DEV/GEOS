...
public:
  CompositionalMultiphaseFluidUpdates( compositional::ComponentProperties const & componentProperties,
                                       compositional::EquationOfState const & equationsOfState,
                                       FLASH const & flash,
                                       PHASE1 const & phase1,
                                       PHASE2 const & phase2,
                                       PHASE3 const & phase3,
...
protected:
  ...
  void compute( real64 const pressure,
                ...
                PhaseProp::SliceType const phaseInternalEnergy,
                PhaseComp::SliceType const phaseCompFrac,
                FluidProp::SliceType const totalDensity,
                PhaseComp::SliceType::ValueType const & kValues ) const;
...
private:
  ...
  compositional::EquationOfState::KernelWrapper m_equationsOfState;
  ...
  // Backup variables
  PhaseComp::ViewValueType m_kValues;
};
...
CompositionalMultiphaseFluidUpdates( compositional::ComponentProperties const & componentProperties,
  ...
  m_equationsOfState( equationsOfState.createKernelWrapper() ),
  ...
  FluidProp::SliceType const totalDensity ) const
{
  ...
  PhaseComp::StackValueType< maxNumPhase *maxNumComp > kValues( 1, 1, numPhases() - 1, numComponents() );
