...
private:
   ...
   */
  GEOSX_HOST_DEVICE
  virtual void UpdateFluidProperty(
    localIndex const k,
    localIndex const q,
    real64 const pressure,
    arraySlice1d<real64 const> const& componentConcentration,
   ...
   */
  GEOSX_HOST_DEVICE
  virtual void UpdateComponentDensity(
    localIndex const k,
    localIndex const q,
    real64 const pressure,
...
public:
  ...
  {
    return m_dDens_dPres;
  }
  arrayView2d<real64> const& dDensity_dPressure() { return m_dDens_dPres; }

  arrayView2d<real64 const> const& dDensity_dProppantConcentration() const
  {
    return m_dDens_dProppantConc;
  }
  arrayView2d<real64> const& dDensity_dProppantConcentration()
  {
    return m_dDens_dProppantConc;
  }

  arrayView3d<real64 const> const& dDensity_dComponentConcentration() const
  {
    return m_dDens_dCompConc;
  }
  arrayView3d<real64> const& dDensity_dComponentConcentration()
  {
    return m_dDens_dCompConc;
  }

  arrayView2d<real64 const> const& fluidDensity() const
  {
    return m_fluidDensity;
  }
  arrayView2d<real64> const& fluidDensity() { return m_fluidDensity; }

  arrayView2d<real64 const> const& dFluidDensity_dPressure() const
  {
    return m_dFluidDens_dPres;
  }
  arrayView2d<real64> const& dFluidDensity_dPressure()
  {
    return m_dFluidDens_dPres;
  }

  arrayView3d<real64 const> const& dFluidDensity_dComponentConcentration() const
  {
    return m_dFluidDens_dCompConc;
  }
  arrayView3d<real64> const& dFluidDensity_dComponentConcentration()
  {
    return m_dFluidDens_dCompConc;
  }

  arrayView3d<real64 const> const& componentDensity() const
  {
    return m_componentDensity;
  }
  arrayView3d<real64> const& componentDensity() { return m_componentDensity; }

  arrayView3d<real64 const> const& dComponentDensity_dPressure() const
  {
    return m_dCompDens_dPres;
  }
  arrayView3d<real64> const& dComponentDensity_dPressure()
  {
    return m_dCompDens_dPres;
  }

  arrayView4d<real64 const> const& dComponentDensity_dComponentConcentration() const
  {
    return m_dCompDens_dCompConc;
  }
  arrayView4d<real64> const& dComponentDensity_dComponentConcentration()
  {
    return m_dCompDens_dCompConc;
  }

  arrayView2d<real64 const> const& fluidViscosity() const
  {
    return m_fluidViscosity;
  }
  arrayView2d<real64> const& fluidViscosity() { return m_fluidViscosity; }

  arrayView2d<real64 const> const& dFluidViscosity_dPressure() const
  {
    return m_dFluidVisc_dPres;
  }
  arrayView2d<real64> const& dFluidViscosity_dPressure()
  {
    return m_dFluidVisc_dPres;
  }

  arrayView3d<real64 const> const& dFluidViscosity_dComponentConcentration() const
  {
    return m_dFluidVisc_dCompConc;
  }
  arrayView3d<real64> const& dFluidViscosity_dComponentConcentration()
  {
    return m_dFluidVisc_dCompConc;
  }
  ...
  {
    return m_dVisc_dPres;
  }
  arrayView2d<real64> const& dViscosity_dPressure() { return m_dVisc_dPres; }

  arrayView2d<real64 const> const& dViscosity_dProppantConcentration() const
  {
    return m_dVisc_dProppantConc;
  }
  arrayView2d<real64> const& dViscosity_dProppantConcentration()
  {
    return m_dVisc_dProppantConc;
  }

  arrayView3d<real64 const> const& dViscosity_dComponentConcentration() const
  {
    return m_dVisc_dCompConc;
  }
  arrayView3d<real64> const& dViscosity_dComponentConcentration()
  {
    return m_dVisc_dCompConc;
  }
  ...
  struct viewKeyStruct
  {
    ...
    static constexpr auto defaultCompressibilityString =
