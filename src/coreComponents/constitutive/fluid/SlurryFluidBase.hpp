...
protected:
  ...
  SlurryFluidBaseUpdate( arrayView1d< real64 const > const & defaultDensity,
    ...
    m_dDens_dProppantConc( dDensDProppantConc ),
    m_dDens_dCompConc( dDensDCompConc ),
    m_componentDensity( componentDensity ),
    m_dCompDens_dPres( dCompDensDPres ),
    m_dCompDens_dCompConc( dCompDensDCompConc ),
    m_fluidDensity( fluidDensity ),
    m_dFluidDens_dPres( dFluidDensDPres ),
    m_dFluidDens_dCompConc( dFluidDensDCompConc ),
    m_fluidViscosity( fluidViscosity ),
    m_dFluidVisc_dPres( dFluidViscDPres ),
    m_dFluidVisc_dCompConc( dFluidViscDCompConc ),
    m_viscosity( viscosity ),
    m_dVisc_dPres( dViscDPres ),
    m_dVisc_dProppantConc( dViscDProppantConc ),
    m_dVisc_dCompConc( dViscDCompConc )
  {}
