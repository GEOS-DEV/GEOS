...
ThermalReactiveCompressibleSinglePhase::~ThermalReactiveCompressibleSinglePhase() = default;

void ThermalReactiveCompressibleSinglePhase::allocateConstitutiveData( dataRepository::Group & parent,
                                                                       localIndex const numConstitutivePointsPerParentIndex )
{
  ReactiveCompressibleSinglePhase::allocateConstitutiveData( parent, numConstitutivePointsPerParentIndex );

  m_internalEnergy.value.setValues< serialPolicy >( m_referenceInternalEnergy );
}

void ThermalReactiveCompressibleSinglePhase::postInputInitialization()
{
  ReactiveCompressibleSinglePhase::postInputInitialization();
...
ThermalReactiveCompressibleSinglePhase::KernelWrapper
ThermalReactiveCompressibleSinglePhase::createKernelWrapper()
{
