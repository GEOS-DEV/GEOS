...
/**
 * @file ReactiveCompressibleSinglePhaseFluid.cpp
 */

#include "ReactiveCompressibleSinglePhaseFluid.hpp"
...
ReactiveCompressibleSinglePhase::ReactiveCompressibleSinglePhase( string const & name, Group * const parent ):
  ReactiveSingleFluid( name, parent ),
...
ReactiveCompressibleSinglePhase::~ReactiveCompressibleSinglePhase() = default;

void ReactiveCompressibleSinglePhase::allocateConstitutiveData( dataRepository::Group & parent,
                                                                localIndex const numConstitutivePointsPerParentIndex )
{
  ReactiveSingleFluid::allocateConstitutiveData( parent, numConstitutivePointsPerParentIndex );
...
void ReactiveCompressibleSinglePhase::postInputInitialization()
{
  ReactiveSingleFluid::postInputInitialization();
...
ReactiveCompressibleSinglePhase::KernelWrapper
ReactiveCompressibleSinglePhase::createKernelWrapper()
{
  return KernelWrapper( KernelWrapper::DensRelationType( m_referencePressure, m_referenceDensity, m_compressibility ),
                        ...
                        m_primarySpeciesAggregateConcentration.toView(),
                        m_dPrimarySpeciesAggregateConcentration_dLogPrimaryConc.toView(),
                        m_kineticReactionRates.toView() );
}

REGISTER_CATALOG_ENTRY( ConstitutiveBase, ReactiveCompressibleSinglePhase, string const &, Group * const )
