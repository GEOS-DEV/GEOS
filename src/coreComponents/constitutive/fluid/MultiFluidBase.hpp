...
protected:
  ...
  MultiFluidBaseUpdate( arrayView1d< real64 const > const & componentMolarWeight,
    ...
    m_dPhaseFraction_dPressure( dPhaseFractionDPressure ),
    m_dPhaseFraction_dTemperature( dPhaseFractionDTemperature ),
    m_dPhaseFraction_dGlobalCompFraction( dPhaseFractionDGlobalCompFraction ),
    m_phaseDensity( phaseDensity ),
    m_dPhaseDensity_dPressure( dPhaseDensityDPressure ),
    m_dPhaseDensity_dTemperature( dPhaseDensityDTemperature ),
    m_dPhaseDensity_dGlobalCompFraction( dPhaseDensityDGlobalCompFraction ),
    m_phaseViscosity( phaseViscosity ),
    m_dPhaseViscosity_dPressure( dPhaseViscosityDPressure ),
    m_dPhaseViscosity_dTemperature( dPhaseViscosityDTemperature ),
    m_dPhaseViscosity_dGlobalCompFraction( dPhaseViscosityDGlobalCompFraction ),
    m_phaseCompFraction( phaseCompFraction ),
    m_dPhaseCompFraction_dPressure( dPhaseCompFractionDPressure ),
    m_dPhaseCompFraction_dTemperature( dPhaseCompFractionDTemperature ),
    m_dPhaseCompFraction_dGlobalCompFraction( dPhaseCompFractionDGlobalCompFraction ),
    m_totalDensity( totalDensity ),
    m_dTotalDensity_dPressure( dTotalDensityDPressure ),
    m_dTotalDensity_dTemperature( dTotalDensityDTemperature ),
    m_dTotalDensity_dGlobalCompFraction( dTotalDensityDGlobalCompFraction )
  {}
...
private:
  ...
  virtual void Compute( real64 const pressure,
                        ...
                        arraySlice1d< real64 > const & dTotalDensityDGlobalCompFraction ) const = 0;
