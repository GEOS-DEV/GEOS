...
The user can specify the relative permeabilities using tables describing a piecewise-constant relative permeability function of volume fraction (i.e., saturation) for each phase.
