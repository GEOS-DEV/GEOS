...
:math:`\epsilon_{v}^e` and :math:`\epsilon_{s}^e` are the volumetric and deviatoric components of the the strain tensor. :math:`\epsilon_{v0}` and :math:`p_0` are the initial volumetric strain and initial pressure. :math:`C_r` denotes the elastic compressibility index,
