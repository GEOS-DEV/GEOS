                                                 ...
                                                 integer const updateStiffnessFlag )
{
  ...
  Tdata[0] += c[0][0]*Ddata[0] + c[0][1]*Ddata[2] + c[0][2]*Ddata[5] + c[0][3]*( 2*Ddata[4] ) + c[0][4]*( 2*Ddata[3] ) + c[0][5]*
              ( 2*Ddata[1] );
  Tdata[2] += c[1][0]*Ddata[0] + c[1][1]*Ddata[2] + c[1][2]*Ddata[5] + c[1][3]*( 2*Ddata[4] ) + c[1][4]*( 2*Ddata[3] ) + c[1][5]*
              ( 2*Ddata[1] );
  Tdata[5] += c[2][0]*Ddata[0] + c[2][1]*Ddata[2] + c[2][2]*Ddata[5] + c[2][3]*( 2*Ddata[4] ) + c[2][4]*( 2*Ddata[3] ) + c[2][5]*
              ( 2*Ddata[1] );
  Tdata[4] += c[3][0]*Ddata[0] + c[3][1]*Ddata[2] + c[3][2]*Ddata[5] + c[3][3]*( 2*Ddata[4] ) + c[3][4]*( 2*Ddata[3] ) + c[3][5]*
              ( 2*Ddata[1] );
  Tdata[3] += c[4][0]*Ddata[0] + c[4][1]*Ddata[2] + c[4][2]*Ddata[5] + c[4][3]*( 2*Ddata[4] ) + c[4][4]*( 2*Ddata[3] ) + c[4][5]*
              ( 2*Ddata[1] );
  Tdata[1] += c[5][0]*Ddata[0] + c[5][1]*Ddata[2] + c[5][2]*Ddata[5] + c[5][3]*( 2*Ddata[4] ) + c[5][4]*( 2*Ddata[3] ) + c[5][5]*
              ( 2*Ddata[1] );
