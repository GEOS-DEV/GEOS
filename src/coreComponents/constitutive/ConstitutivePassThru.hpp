 ...
 */
template <typename BASETYPE> struct ConstitutivePassThru;

/**
 * Specialization for models that derive from SolidBase.
 */
template <> struct ConstitutivePassThru<SolidBase>
{
  template <typename LAMBDA>
  static void Execute(ConstitutiveBase* const constitutiveRelation,
                      LAMBDA&& lambda)
  {
 ...
 */
template <> struct ConstitutivePassThru<NullModel>
{
  template <typename LAMBDA>
  static void Execute(ConstitutiveBase* const constitutiveRelation,
                      LAMBDA&& lambda)
 ...
 */
template <> struct ConstitutivePassThru<PoroElasticBase>
{
  template <typename LAMBDA>
  static void Execute(ConstitutiveBase* const constitutiveRelation,
                      LAMBDA&& lambda)
