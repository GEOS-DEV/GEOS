...
struct ConstitutivePassThru< SolidBase >
{
                ...
                LAMBDA && lambda )
  {
    ...
    else if( dynamic_cast< ElasticAnisotropic * >( constitutiveRelation ) )
    {
      lambda( static_cast< ElasticAnisotropic * >( constitutiveRelation) );
    }
    else
    {
      string name;
...
struct ConstitutivePassThru< PoroElasticBase >
{
                ...
                LAMBDA && lambda )
  {
    ...
    else if( dynamic_cast< PoroElastic< ElasticAnisotropic > * >( constitutiveRelation ) )
    {
      lambda( static_cast< PoroElastic< ElasticAnisotropic > * >( constitutiveRelation) );
    }
    else
    {
      string name;
