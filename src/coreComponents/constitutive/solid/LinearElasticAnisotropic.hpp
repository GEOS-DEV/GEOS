...
public:
  ...
  LinearElasticAnisotropicUpdates& operator=(
    LinearElasticAnisotropicUpdates const&) = delete;

  /// Deleted move assignment operator
  LinearElasticAnisotropicUpdates& operator=(LinearElasticAnisotropicUpdates&&) =
    delete;
...
GEOSX_FORCE_INLINE
GEOSX_HOST_DEVICE
void LinearElasticAnisotropicUpdates::SmallStrainNoState(
  localIndex const k,
  real64 const (&voigtStrain)[6],
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void LinearElasticAnisotropicUpdates::SmallStrain(
  localIndex const k,
  localIndex const q,
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void LinearElasticAnisotropicUpdates::HypoElastic(localIndex const k,
                                                  localIndex const q,
                                                  real64 const (&Ddt)[6],
...
GEOSX_HOST_DEVICE
GEOSX_FORCE_INLINE
void LinearElasticAnisotropicUpdates::HyperElastic(
