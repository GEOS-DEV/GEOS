...
void PoreVolumeCompressibleSolid::DeliverClone(
  string const &name,
  Group *const parent,
...
void PoreVolumeCompressibleSolid::AllocateConstitutiveData(
...
void PoreVolumeCompressibleSolid::StateUpdateBatchPressure(
