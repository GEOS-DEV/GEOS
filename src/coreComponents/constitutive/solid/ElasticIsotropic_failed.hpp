                                                   ...
                                                   real64 ( & stiffness )[6][6] ) const
{
  ...
  real64 const K = m_bulkModulus[k]; //added by SG
                                                                   ...
                                                                   real64 ( & stress )[6] ) const
{
  ...
  real64 const lambda = conversions::bulkModAndShearMod::toFirstLame( K, m_shearModulus[k] ); //changed from m_bulkModulus[k] to K
