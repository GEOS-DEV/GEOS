...
GEOSX_HOST_DEVICE
static void stressCalculator(  real64 ( &strain )[6],
                               ...
                               localIndex const decompOption )                                
  {
    ...
    if (decompOption == 1)
    {
      ...
      real64 bulk = lambda + 2.0*mu/3.0; //undamged bulk modulus
      mu *= damageFactor;
      ...
      //THIS BULK AND SHEAR OPERATION SHOULD BE DONE TO THE DISC_OPs; THIS IS ONLY FOR COMPILING
      ...
      real64 stressP = bulk * volStrain;
      real64 stressQ = 3 * mu * devStrain;      
      ...
      sed = 0.5 * (stressQ * devStrain) / damageFactor;
