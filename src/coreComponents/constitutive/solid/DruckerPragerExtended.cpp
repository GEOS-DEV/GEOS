...
void DruckerPragerExtended::postProcessInput()
{
  ...
  GEOSX_THROW_IF_IF( m_defaultInitialFrictionAngle < 0, "Negative initial friction angle detected", InputError );
  GEOSX_THROW_IF_IF( m_defaultResidualFrictionAngle < 0, "Negative residual friction angle detected", InputError );
  GEOSX_THROW_IF_IF( m_defaultDilationRatio < 0, "Dilation ratio out of [0,1] range detected", InputError );
  GEOSX_THROW_IF_IF( m_defaultDilationRatio > 1, "Dilation ratio out of [0,1] range detected", InputError );
  GEOSX_THROW_IF_IF( m_defaultHardening < 0, "Negative hardening parameter detected", InputError );
