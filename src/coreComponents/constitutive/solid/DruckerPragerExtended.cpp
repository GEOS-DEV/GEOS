...
void DruckerPragerExtended::postProcessInput()
{
  ...
  GEOSX_ERROR_IF( m_defaultCohesion <= 0, "Negative cohesion value detected" );
  GEOSX_ERROR_IF( m_defaultInitialFrictionAngle <= 0, "Negative initial friction angle detected" );
  GEOSX_ERROR_IF( m_defaultResidualFrictionAngle <= 0, "Negative residual friction angle detected" );
  GEOSX_ERROR_IF( m_defaultDilationRatio <= 0, "Dilation ratio out of [0,1] range detected" );
  GEOSX_ERROR_IF( m_defaultDilationRatio >= 1, "Dilation ratio out of [0,1] range detected" );
  GEOSX_ERROR_IF( m_defaultHardening <= 0, "Negative hardening parameter detected" );
