  ...
  TaskBase( name, parent )
{
  ...
  registerWrapper( viewKeyStruct::outputString(), &m_outputFilePath ).
    setInputFlag( InputFlags::OPTIONAL ).
    setApplyDefaultValue("none").
    setDescription( "Output file" );

  registerWrapper( viewKeyStruct::baselineString(), &m_baselineFilePath ).
    setInputFlag( InputFlags::OPTIONAL ).
    setApplyDefaultValue("none").
...
{
  FILE * fp = fopen( m_outputFilePath.c_str(), "w" );
