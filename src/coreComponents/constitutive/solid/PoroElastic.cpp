...
template <typename BASE> PoroElastic<BASE>::~PoroElastic() { }

template <typename BASE> void PoroElastic<BASE>::PostProcessInput()
{
...
template <typename BASE>
void PoroElastic<BASE>::AllocateConstitutiveData(
...
template <typename BASE>
void PoroElastic<BASE>::StateUpdateBatchPressure(
