...
#define GEOSX_CONSTITUTIVE_SOLID_SOLIDMODELDISCRETIZATIONOPSTRANSVERSEISOTROPIC_HPP_
...
#endif /* GEOSX_CONSTITUTIVE_SOLID_SOLIDMODELDISCRETIZATIONOPSTRANSVERSEISOTROPIC_HPP_ */
