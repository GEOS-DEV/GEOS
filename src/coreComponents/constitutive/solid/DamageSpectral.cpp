...
DamageSpectral< BASE >::DamageSpectral( std::string const & name, Group * const parent ):
...
REGISTER_CATALOG_ENTRY( ConstitutiveBase, DamageSpectralLinearElasticIsotropic, std::string const &, Group * const )
