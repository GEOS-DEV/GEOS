...
/**
 * @file ThermoPoroMechanics.hpp
 */

#ifndef GEOS_CONSTITUTIVE_SOLID_THERMOPOROMECHANICS_HPP_
#define GEOS_CONSTITUTIVE_SOLID_THERMOPOROMECHANICS_HPP_
...
/**
 * @brief ThermoPoroMechanicsBase class used for dispatch of all Porous solids.
 */
class ThermoPoroMechanicsBase
{};
...
public:
   ...
   */
  ThermoPoroMechanics( string const & name, dataRepository::Group * const parent );

  /// Destructor
  virtual ~ThermoPoroMechanics() override;

  /**
   * @brief Catalog name
   * @return Static catalog string
   */
  static string catalogName() { return string( "ThermoPoro" ) + SOLID_TYPE::catalogName(); }
  ...
  /**
   * @brief Create a instantiation of the ThermoPoroMechanicsUpdates class
   *        that refers to the data in this.
   * @return An instantiation of ThermoPoroMechanicsUpdates.
   */
...
#endif /* GEOS_CONSTITUTIVE_SOLID_THERMOPOROMECHANICS_HPP_ */
