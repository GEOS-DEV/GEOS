...
/**
 *  @file ElasticAnisotropic.hpp
 */

#ifndef GEOSX_CONSTITUTIVE_SOLID_ELASTICANISOTROPIC_HPP_
#define GEOSX_CONSTITUTIVE_SOLID_ELASTICANISOTROPIC_HPP_
...
/**
 * @class ElasticAnisotropicUpdates
 *
 * Class to provide fully anisotropic material updates that may be called from
 * a kernel function.
 *
 */
class ElasticAnisotropicUpdates : public SolidBaseUpdates
{
public:
   ...
   *                   point.
   */
  ElasticAnisotropicUpdates( arrayView3d< real64 const, solid::STIFFNESS_USD > const & C,
  ...
  ElasticAnisotropicUpdates() = delete;

  /// Default copy constructor
  ElasticAnisotropicUpdates( ElasticAnisotropicUpdates const & ) = default;

  /// Default move constructor
  ElasticAnisotropicUpdates( ElasticAnisotropicUpdates && ) = default;

  /// Deleted copy assignment operator
  ElasticAnisotropicUpdates & operator=( ElasticAnisotropicUpdates const & ) = delete;

  /// Deleted move assignment operator
  ElasticAnisotropicUpdates & operator=( ElasticAnisotropicUpdates && ) =  delete;
...
ElasticAnisotropicUpdates::
  hyperElastic( localIndex const GEOSX_UNUSED_PARAM( k ),
                ...
                real64 ( & )[ 6 ] ) const
{
  GEOSX_ERROR( "ElasticAnisotropicKernelWrapper::HyperElastic() is not implemented!" );
}
...
/**
 * @class ElasticAnisotropic
 *
 * Class to provide a linear elastic anisotropic material response.
 */
class ElasticAnisotropic : public SolidBase
{
public:
  /// @typedef Alias for ElasticAnisotropicUpdates
  using KernelWrapper = ElasticAnisotropicUpdates;
   ...
   */
  ElasticAnisotropic( string const & name, Group * const parent );

  /**
   * Destructor
   */
  virtual ~ElasticAnisotropic() override;
  ...
  static constexpr auto m_catalogNameString = "ElasticAnisotropic";
  ...
  /**
   * @brief Create a instantiation of the ElasticAnisotropicUpdate class
   *        that refers to the data in this.
   * @return An instantiation of ElasticAnisotropicUpdate.
   */
  ElasticAnisotropicUpdates createKernelUpdates() const
  {
    return ElasticAnisotropicUpdates( m_stiffness.toViewConst(),
                                            m_stress.toView() );
  }
...
#endif /* GEOSX_CONSTITUTIVE_SOLID_ELASTICANISOTROPIC_HPP_ */
