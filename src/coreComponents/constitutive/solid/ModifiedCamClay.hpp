...
public:
  ...
  ModifiedCamClayUpdates( real64 const & refPressure,
    ...
    ElasticIsotropicPressureDependentUpdates( refPressure, refStrainVol, recompressionIndex, shearModulus, thermalExpansionCoefficient, anelasticStrainMagnitude, newStress, oldStress,
