...
TEST( testGeosxTraits, HasOperatorPlusEquals )
{
  ...
  static_assert( !HasOperatorPlusEquals< stdVector< int > >, "Should be false." );
}
...
TEST( testGeosxTraits, HasOperatorPlusEquals2 )
{
  ...
  static_assert( !HasOperatorPlusEquals2< stdVector< int >, int >, "Should be false." );
}
...
TEST( testGeosxTraits, HasMemberFunction_at )
{
  ...
  static_assert( HasMemberFunction_at< map< int, string > >, "Should be true." );
  ...
  static_assert( !HasMemberFunction_at< map< string, string > >, "Should be false." );
...
TEST( testGeosxTraits, HasMemberFunction_insert )
{
  ...
  static_assert( HasMemberFunction_insert< map< string, int > >, "Should be true." );
...
TEST( testGeosxTraits, HasAlias_value_type )
{
  ...
  static_assert( HasAlias_value_type< map< string, string > >, "Should be true." );
...
TEST( testGeosxTraits, Pointer )
{
  ...
  static_assert( std::is_same< Pointer< stdVector< double > >, double * >::value, "Should be true." );
  ...
  static_assert( std::is_same< ConstPointer< stdVector< double > >, double const * >::value, "Should be true." );
...
TEST( testGeosxTraits, HasMemberFunction_data )
{
  ...
  static_assert( !HasMemberFunction_data< map< string, string > >, "Should be false." );
...
TEST( testGeosxTraits, HasMemberFunction_size )
{
  ...
  static_assert( HasMemberFunction_size< map< string, string > >, "Should be true." );
...
TEST( testGeosxTraits, HasMemberFunction_resize )
{
  ...
  static_assert( HasMemberFunction_resize< stdVector< int > >, "Should be true." );
  ...
  static_assert( !HasMemberFunction_resize< map< string, string > >, "Should be false." );
...
TEST( testGeosxTraits, CanStreamInto )
{
  ...
  static_assert( !CanStreamInto< std::istringstream, stdVector< int > >, "Should be false." );
}
