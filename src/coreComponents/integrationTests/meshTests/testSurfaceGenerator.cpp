 ...
 */
using SurfaceGeneratorMpiMeshTuple = std::tuple< std::string, std::string, std::string, integer, integer >;
using SurfaceGeneratorMpiPartitionTuple = std::tuple< int, int, int >;

class SurfaceGeneratorMpiTest
  : public ::testing::TestWithParam<
      std::tuple< SurfaceGeneratorMpiMeshTuple, SurfaceGeneratorMpiPartitionTuple > >
{
protected:
  void SetUp() override
  {
...
<Problem>
  ...
  <FieldSpecifications>
    ...
    <FieldSpecification name="frac" initialCondition="1"
      setNames=")xml" << nodeSetNames << R"xml(" objectPath="faceManager"
