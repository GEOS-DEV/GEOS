...
/**
 * @file testMixedDimSinglePhaseFlowFixture.hpp
 *
 * Shared test fixture and TEST_P body for single-phase flow in mixed-dimensional
 * meshes (3D matrix + 2D fractures).  Both the serial and MPI test executables
 * include this header and only differ in the INSTANTIATE_TEST_SUITE_P parameters.
 */

#ifndef GEOS_TEST_MIXEDDIMSINGLEPHASEFLOW_FIXTURE_HPP
#define GEOS_TEST_MIXEDDIMSINGLEPHASEFLOW_FIXTURE_HPP
...
#endif /* GEOS_TEST_MIXEDDIMSINGLEPHASEFLOW_FIXTURE_HPP */
