...
#include "physicsSolvers/wavePropagation/dg/acoustic/secondOrderEqn/isotropic/AcousticWaveEquationDG.hpp"
...
class AcousticWaveEquationDGTest : public ::testing::Test
{
public:

  AcousticWaveEquationDGTest():
...
protected:
  ...
  GeosxState state;
  AcousticWaveEquationDG * propagator;
};

real64 constexpr AcousticWaveEquationDGTest::time;
real64 constexpr AcousticWaveEquationDGTest::dt;
real64 constexpr AcousticWaveEquationDGTest::eps;

TEST_F( AcousticWaveEquationDGTest, SeismoTrace )
{

  DomainPartition & domain = state.getProblemManager().getDomainPartition();
  propagator = &state.getProblemManager().getPhysicsSolverManager().getGroup< AcousticWaveEquationDG >( "acousticSolverDG" );
