...
inline parallelDeviceStream getCudaStream( )
{
...
using parallelDeviceStream = localIndex;
...
RAJA_INLINE void forAll( RESOURCE && res, const localIndex end, LAMBDA && body )
{
  RAJA::forall< POLICY >( std::forward< RESOURCE>( res ),  
