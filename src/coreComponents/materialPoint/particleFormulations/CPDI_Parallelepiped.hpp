...
// This will be a CPDI particle.  The particle will be defined with a single gauss point, used onlt
// to connect to the constitutive model.
//
// For MPM particles, we will have integration points (defined by the r-vectors for the CPDI particle)
// where we will be evaluating the background grid shape functions and gradients.
