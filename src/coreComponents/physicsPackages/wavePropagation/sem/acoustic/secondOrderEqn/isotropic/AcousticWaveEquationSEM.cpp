...
void AcousticWaveEquationSEM::initializePML()
{
                                                                ...
                                                                arrayView1d< string const > const & )
  {
    ...
    arrayView2d< WavePackageBase::wsCoordType const, nodes::REFERENCE_POSITION_USD > const nodeCoords32 = nodeManager.getField< fields::referencePosition32 >().toViewConst();
    indicatorPML.zero();
...
REGISTER_CATALOG_ENTRY( PhysicsPackageBase, AcousticWaveEquationSEM, string const &, dataRepository::Group * const )
