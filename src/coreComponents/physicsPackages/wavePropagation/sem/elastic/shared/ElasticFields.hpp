...
#ifndef GEOS_PHYSICSPACKAGES_WAVEPROPAGATION_ELASTICFIELDS_HPP_
#define GEOS_PHYSICSPACKAGES_WAVEPROPAGATION_ELASTICFIELDS_HPP_
...
#endif /* GEOS_PHYSICSPACKAGES_WAVEPROPAGATION__HPP_ELASTICFIELDS */
