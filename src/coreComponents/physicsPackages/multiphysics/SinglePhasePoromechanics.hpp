                                                                                  ...
                                                                                  PARAMS && ... params )
{
  ...
  real64 const gravityVectorData[3] = LVARRAY_TENSOROPS_INIT_LOCAL_3( PhysicsPackageBase::gravityVector() );
...
#endif /* GEOS_PHYSICSPACKAGES_MULTIPHYSICS_SINGLEPHASEPOROMECHANICS_HPP_ */
