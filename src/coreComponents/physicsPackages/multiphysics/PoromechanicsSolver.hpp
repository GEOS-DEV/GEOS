...
public:
  ...
  virtual void setConstitutiveNamesCallSuper( ElementSubRegionBase & subRegion ) const override final
  {
    if( dynamic_cast< SurfaceElementSubRegion * >( &subRegion ) )
    {
      ...
      hydraulicApertureModelName =PhysicsPackageBase::getConstitutiveName< constitutive::HydraulicApertureBase >( subRegion );
  ...
  virtual void registerDataOnMesh( dataRepository::Group & meshBodies ) override
  {
    ...
    PhysicsPackageBase::forDiscretizationOnMeshTargets( meshBodies, [&] ( string const &,
                                                                          MeshLevel & mesh,
                                                                          arrayView1d< string const > const & regionNames )
    {
...
protected:
                                              ...
                                              array1d< real64 > & averageMeanTotalStressIncrement )
  {
    ...
    PhysicsPackageBase::forDiscretizationOnMeshTargets( domain.getMeshBodies(), [&]( string const &,
                                                                                     MeshLevel & mesh,
                                                                                     arrayView1d< string const > const & regionNames ) {
      mesh.getElemManager().forElementSubRegions< CellElementSubRegion >( regionNames, [&]( localIndex const,
        ...
        constitutive::CoupledSolidBase & solid = PhysicsPackageBase::getConstitutiveModel< constitutive::CoupledSolidBase >(
          subRegion, solidName );
...
#endif //GEOS_PHYSICSPACKAGES_MULTIPHYSICS_POROMECHANICSSOLVER_HPP_
