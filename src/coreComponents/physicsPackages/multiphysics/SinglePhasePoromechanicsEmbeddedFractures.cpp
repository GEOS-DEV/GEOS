...
void SinglePhasePoromechanicsEmbeddedFractures::updateState( DomainPartition & domain )
{
                                                                ...
                                                                arrayView1d< string const > const & regionNames )
  {
                                                                                     ...
                                                                                     auto & subRegion )
    {
      ...
      string const porousSolidName = subRegion.template getReference< string >( FlowPackageBase::viewKeyStruct::solidNamesString() );
...
REGISTER_CATALOG_ENTRY( PhysicsPackageBase, SinglePhasePoromechanicsEmbeddedFractures, std::string const &, Group * const )
