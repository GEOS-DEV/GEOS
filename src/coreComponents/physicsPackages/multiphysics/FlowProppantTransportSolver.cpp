...
real64 FlowProppantTransportSolver::sequentiallyCoupledSimulationStep( real64 const & time_n,
                                                                       real64 const & dt,
...
REGISTER_CATALOG_ENTRY( PhysicsPackageBase, FlowProppantTransportSolver, string const &, Group * const )
