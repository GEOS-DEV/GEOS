...
void
addCouplingNumNonzeros( PhysicsPackageBase const * const solver,
                               ...
                               DomainPartition const & domain )
{
  ...
  arrayView1d< string const > const flowTargetRegionNames =
    reservoirSolver->getReference< array1d< string > >( PhysicsPackageBase::viewKeyStruct::targetRegionsString() );
