...
{
  GEOS_LOG_LEVEL_RANK_0( 1, GEOS_FMT( "Task `{}`: at time {}s, physics package `{}` is set to perform stress initialization during the next time step(s)",
  ...
  GEOS_LOG_LEVEL_RANK_0( 1, GEOS_FMT( "Task `{}`: at time {}s, physics package `{}` has completed stress initialization",
