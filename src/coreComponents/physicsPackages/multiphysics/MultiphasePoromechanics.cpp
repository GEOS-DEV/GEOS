...
void MultiphasePoromechanics< FLOW_SOLVER, MECHANICS_SOLVER >::initializePostInitialConditionsPreSubGroups()
{
  ...
  arrayView1d< string const > const & poromechanicsTargetRegionNames =
    this->template getReference< array1d< string > >( PhysicsPackageBase::viewKeyStruct::targetRegionsString() );
  arrayView1d< string const > const & solidMechanicsTargetRegionNames =
    this->solidMechanicsSolver()->template getReference< array1d< string > >( PhysicsPackageBase::viewKeyStruct::targetRegionsString() );
  arrayView1d< string const > const & flowTargetRegionNames =
    this->flowSolver()->template getReference< array1d< string > >( PhysicsPackageBase::viewKeyStruct::targetRegionsString() );
...
REGISTER_CATALOG_ENTRY( PhysicsPackageBase, MultiphaseReservoirPoromechanics, string const &, Group * const )
typedef MultiphasePoromechanics<> MultiphasePoromechanics;
REGISTER_CATALOG_ENTRY( PhysicsPackageBase, MultiphasePoromechanics, string const &, Group * const )
}
