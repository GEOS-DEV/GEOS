...
#ifndef GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_SOLIDMECHANICSLAGRANGIANFEM_HPP_
#define GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_SOLIDMECHANICSLAGRANGIANFEM_HPP_
 ...
 */
class SolidMechanicsLagrangianFEM : public PhysicsPackageBase
{
public:
  ...
  /**
   * @return The string that may be used to generate a new instance from the PhysicsPackageBase::CatalogInterface::CatalogType
   */
  ...
  /**@{*/
  virtual
  real64 simulationStep( real64 const & time_n,
                         real64 const & dt,
...
private:
  ...
  PhysicsPackageBase * m_surfaceGenerator;
...
#endif /* GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_SOLIDMECHANICSLAGRANGIANFEM_HPP_ */
