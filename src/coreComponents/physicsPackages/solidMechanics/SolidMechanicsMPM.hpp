...
#ifndef GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_MPM_HPP_
#define GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_MPM_HPP_
 ...
 */
class SolidMechanicsMPM : public PhysicsPackageBase
{
public:
