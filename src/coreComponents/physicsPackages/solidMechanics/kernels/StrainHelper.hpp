...
#ifndef GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_KERNELS_STRAINHELPER_HPP_
#define GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_KERNELS_STRAINHELPER_HPP_
...
#endif /* GEOS_PHYSICSPACKAGES_SOLIDMECHANICS_KERNELS_STRAINHELPER_HPP_ */
