                                                          ...
                                                          arrayView1d< real64 const > const & localRhs )
{
  ...
  PhysicsPackageBaseKernels::NormType const normType = getNonlinearSolverParameters().normType();
                                                               ...
                                                               arrayView1d< string const > const & regionNames )
  {
                                                     ...
                                                     ElementSubRegionBase const & subRegion )
    {
      ...
      {
        PhysicsPackageBaseKernels::LinfResidualNormHelper::
          updateLocalNorm< numNorm >( subRegionResidualNorm, localResidualNorm );
      }
      else
      {
        PhysicsPackageBaseKernels::L2ResidualNormHelper::
  ...
  else
  {
    ...
    if( normType == PhysicsPackageBaseKernels::NormType::Linf )
    {
      PhysicsPackageBaseKernels::LinfResidualNormHelper::computeGlobalNorm( localResidualNorm[0], residualNorm );
    }
    else
    {
      PhysicsPackageBaseKernels::L2ResidualNormHelper::computeGlobalNorm( localResidualNorm[0], localResidualNormalizer[0], residualNorm );
    }
...
REGISTER_CATALOG_ENTRY( PhysicsPackageBase, CompositionalMultiphaseFVM, string const &, Group * const )
