...
#include "physicsPackages/fluidFlow/SinglePhaseProppantBaseKernels.hpp"
...
void SinglePhaseProppantBase::setConstitutiveNames( ElementSubRegionBase & subRegion ) const
{
  ...
  fluidMaterialName = PhysicsPackageBase::getConstitutiveName< SlurryFluidBase >( subRegion );
