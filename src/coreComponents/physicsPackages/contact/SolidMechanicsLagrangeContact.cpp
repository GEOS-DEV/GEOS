                                                 ...
                                                 bool const GEOS_UNUSED_PARAM( setSparsity ) )
{
  ...
  PhysicsPackageBase::setupSystem( domain, dofManager, localMatrix, rhs, solution, true ); // "true" is to force setSparsity
...
REGISTER_CATALOG_ENTRY( PhysicsPackageBase, SolidMechanicsLagrangeContact, string const &, Group * const )
