...
#ifndef GEOS_PHYSICSPACKAGES_SURFACEGENERATION_EMBEDDEDSURFACEGENERATOR_HPP_
 ...
 *
 */
class EmbeddedSurfaceGenerator : public PhysicsPackageBase
{
public:
...
#endif /* GEOS_PHYSICSPACKAGES_SURFACEGENERATION_EMBEDDEDSURFACEGENERATOR_HPP_ */
