...
//  { return getGroup< Group >( groupKeys.commandLine ).getReference< string >( viewKeys.rdInputFileName ); }
  ...
  {
    dataRepository::ViewKey rdInputFileName          = { "rdInputFileName"};         ///< Input file name key for rd format
    dataRepository::ViewKey stableInputFileName      = {"stableInputFileName"};      ///< Input file name key for stable usage
