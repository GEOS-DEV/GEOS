...
void PAMELAMeshGenerator::GenerateElementRegions(
...
void PAMELAMeshGenerator::RemapMesh(
  dataRepository::Group *const GEOSX_UNUSED_PARAM(domain))
{
  return;
}

Group *PAMELAMeshGenerator::CreateChild(string const &GEOSX_UNUSED_PARAM(childKey),
...
void PAMELAMeshGenerator::GetElemToNodesRelationInBox(
