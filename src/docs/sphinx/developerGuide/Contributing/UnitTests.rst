...
Unit testing is integral to the GEOS development process. While not all components naturally lend themselves to unit testing (for example a physics package) every effort should be made to write comprehensive quality unit tests.
...
*[Source: coreComponents/physicsPackages/fluidFlow/unitTests/testSinglePhaseBaseKernels.cpp]*
...
*[Source: coreComponents/physicsPackages/fluidFlow/unitTests/testCompMultiphaseFlow.cpp]*
