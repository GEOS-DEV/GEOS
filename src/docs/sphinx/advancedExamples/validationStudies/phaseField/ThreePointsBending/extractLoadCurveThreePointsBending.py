#!/usr/bin/env python3
"""Reduce the GEOS TimeHistory output of the symmetric three-point bending benchmark to a light load curve.
...
``inputFiles/phaseField/benchmark/threePointsBending``, and writes ``loadCurve.csv``, a two-column
...
DECK_DIR = os.path.join(GEOS_DIR, "inputFiles", "phaseField", "benchmark", "threePointsBending")

HISTORY_FILE = "threePointsBending_reactionCut.hdf5"
...
def main():
    ...
    header = ("Load-deflection curve of the symmetric three-point bending benchmark\n"
              "Extracted from {} by extractLoadCurveThreePointsBending.py\n"
