...
def main():
   ...
   # Initialize the argument parser
    ...
    path = outputDir + "/ExtendedDruckerPragerResults.txt"
    xmlFilePath = geosDir + "/inputFiles/constitutiveDriver/triaxialDriver_base.xml"
    xmlFilePath_case = geosDir + "/inputFiles/constitutiveDriver/triaxialDriver_ExtendedDruckerPrager.xml"
    ...
    for idx in range(1,len(list_ax_strain_anal)):
        ...
        delta_ra_stress_anal = 0 # constant lateral confining stress
