...
try:
	...
	_src_dir = os.getcwd()
	_this_dir = os.path.join(_src_dir, 'docs', 'sphinx', 'advancedExamples', 'validationStudies', 'wellboreProblems', 'nonLinearThermalDiffusion_TemperatureDependentSinglePhaseThermalConductivity')
