...
//    }
    ...
    for (array<R1TensorT<2> >::size_type i1 = 1; i1 <= a1.size(); ++i1)
    {
      ...
      for (array<R1TensorT<2> >::size_type i2 = 1; i2 <= a2.size(); ++i2)
      {
        ...
        localIndex contactType = LineIntersection(a1[i1-1],a1[ii1],a2[i2-1],a2[ii2],
                                                  intersection, intersection2, 0.0); // Call a different LineIntersection
  ...
  /**
   ...
   /*
    * A version of the above with modifications and bug-fixes as were apparent to me when called from XfemManager
   ...
   * This is being used only in calls to Intersection_2DPolygons by XfemManager to calculate overlapping area and intersection points between polygons
   */
  localIndex LineIntersection( const R1TensorT<2>& uv1,
                               const R1TensorT<2>& uv1p,
                               const R1TensorT<2>& uv2,
