...
templates<class POLICY=elemPolicy, typename LAMBDA=void>
void forall_in_set(const localIndex * const indexList, const localIndex len, LAMBDA && body){

  RAJA::forall<POLICY>(RAJA::ListSegment(indexList, len), body);  
}
#endif
