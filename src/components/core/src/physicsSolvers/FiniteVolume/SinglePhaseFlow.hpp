...
public:
  ...
  array1d<array1d<array1d<real64>>> const & dPorosity_dPressure() const { return m_dPoro_dPres; }
  array1d<array1d<array1d<real64>>> & dPorosity_dPressure() { return m_dPoro_dPres; }
