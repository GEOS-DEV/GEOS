...
theta = -30. * np.pi / 180. # Tangent angle to x-axis where data are extracted, converted degree to radial
...
kappa = 1e-9 # (m2/Pa/s) ratio between the intrinsic permeability and the dynamic viscosity of fluid
...
def analyticalResults():
    ...
    return [r, sig_rr/1e6, sig_tt/1e6]

r_anal, sig_rr_anal, sig_tt_anal = analyticalResults()
