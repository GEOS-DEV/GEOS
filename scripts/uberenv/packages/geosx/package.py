...
class Geosx(CMakePackage, CudaPackage):
    ...
    depends_on('hypre@2.20.200 +shared +superlu-dist +mixedint +mpi +openmp', when='+hypre')
    depends_on('hypre@2.20.200 +cuda +shared +superlu-dist +mpi +openmp +unified-memory +cusparse', when='+hypre-cuda')
