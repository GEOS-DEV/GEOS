...
# Modified recipe as of: https://github.com/spack/spack/commit/4fe53061a8579fcf2a36ba8f81af05b3ee342a76
class Hypre(AutotoolsPackage, CudaPackage, ROCmPackage):
    ...
    # GEOSX EDIT START
    version('2.24.0geosx', commit='07a8def6f8b7dfdffa4208d962f08f5e5d80ccaa')
    # GEOSX EDIT END
