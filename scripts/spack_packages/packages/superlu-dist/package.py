...
class SuperluDist(CMakePackage, CudaPackage, ROCmPackage):
    ...
    # GEOSX_EDIT_START
    version('6.3.1geosx', commit='0f6efc377df2440c235452d13d28d2c717f832a1')
    # GEOSX_EDIT_END
    ...
    def cmake_args(self):
        ...
        append_define("TPL_PARMETIS_LIBRARIES", [spec["parmetis"].libs.ld_flags, spec["metis"].libs.ld_flags])
        append_define(
