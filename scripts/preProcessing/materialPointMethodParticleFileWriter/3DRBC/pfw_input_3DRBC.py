...
maximumStrength = 50.0*compressiveStrength #changed from 5 to 50 . 2 GPa compressive strength for concrete
crackSpeed = 1.8
...
pfw["plottableFields"]=["particleStrengthScale","target_damage", "gridVelocity"]
