...
lambda_failure = maximumStretch
if fractureStretchLambda0 > 0:
  lambda_failure = fractureStretchLambdaMin + fractureStretchLambda0*exp((T - fractureStretchT0)/fractureStretchTemperatureScale)
if lambda_chain >= lambda_failure:
  damage = 1
