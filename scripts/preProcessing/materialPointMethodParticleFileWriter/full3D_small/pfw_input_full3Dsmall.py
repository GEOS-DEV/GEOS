...
sampleDiameter = 38.2 # target diameter
sampleLength = 38.2 # target length (cylinder) , mm
...
cppx=4   # cells per partition in each direction
cppy=4
cppz=4
...
pfw["endTime"] = stopTime /40 # shorten simulation time
pfw["plotInterval"] = stopTime / 80
...
pfw["plottableFields"]=["gridMass","particleStrengthScale"]
