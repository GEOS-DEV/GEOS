...
domainSize =       1000.0  # diameter of annular region mm
boreholeDiameter = 250.    # mm

boreholePressure =  0.000  # borehole pressure stress in GPa
confiningPressure = 0.008  # confining stress in GPa


# Domain ---------------------------------------------------------------------------------
pfw["planeStrain"] = 1

domainX = 1.*domainSize
...
def make_objects():
    sample = geom.cylinder('ring',
        x1=[0.0,0.0,pfw["zmin"]-10],
    ...
    weibullVolume = 0.25*3.1415*25.12*25.12*56.6  # test cylinder sample volume (mm^3)
    weibullModulus = 7.3 # this is a guess based on shale value
    flawSize=5*DZ

    weibullSample = geom.voronoiWeibullBoxWrapper('weibullring',
        subObject=sample,
