...
pfw["plottableFields"]=["particleDensity",
...
# material model values will still be plotted (stess, p. strain, damage, etc.) 
# in the constitutive models are mpm specific, you can add setPlotLevel( PlotLevel::NOPLOT ) and recompile to prevent them from being written to vtk
...
substrate = geom.box('substrate',
    ...
    vel=[-pdcVelocity, 0.0, 0.0], mat=1, group=0, dim=3, flaggedSurfaces=[False, False, False, False, True, False])
