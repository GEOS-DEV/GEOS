...
# Purpose: Dynamic expanding-ring example.
# Solver/PFW features: Annular geometry, initial radial velocity, damage fields, and surface detection.
...
disk1 = geom.cylinder('disk1',[0,domainHeight/2,pfw["zmin"]],[0,domainHeight/2,pfw["zmax"]],domainHeight/2,vel=[0,0,0],mat=0,group=0)
pfw["objects"] = [disk1]
