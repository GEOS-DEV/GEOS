...
box1=geom.box('box1',[-sampleWidth/2, -2*sampleHeight/2, pfw["zmin"]],[sampleWidth/2, 0.0, pfw["zmax"]], vel=[0.0, 0.0, 0.0], mat=0, group=0, dim=2, flaggedSurfaces=[False, False, False, True])
box2=geom.box('box2',[-sampleWidth/2, 0.0, pfw["zmin"]], [sampleWidth/2, 2*sampleHeight/2, pfw["zmax"]], vel=[0.0, 0.0, 0.0], mat=0, group=0, dim=2, flaggedSurfaces=[False, True, False, False])
...
pfw["fTable"]=[[0.0,          1.00,  1.00,  1.00],
               [stopTime,     1.0 + 0.15/np.sqrt(2),  1.0 + 0.15/np.sqrt(2),  1.00]]
