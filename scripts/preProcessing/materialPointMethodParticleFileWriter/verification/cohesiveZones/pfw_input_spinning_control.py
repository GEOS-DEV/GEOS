...
box1=geom.box('box1',[-sampleWidth/2, -sampleHeight/2, pfw["zmin"]],[sampleWidth/2, 0.0, pfw["zmax"]],vel=getVelocity, mat=0, group=0, dim=2, flaggedSurfaces=[False, False, False, False])
box2=geom.box('box2',[-sampleWidth/2, 0.0, pfw["zmin"]],[sampleWidth/2, sampleHeight/2, pfw["zmax"]],vel=getVelocity, mat=0, group=0, dim=2, flaggedSurfaces=[False, False, False, False])

boxWFlag1 = geom.surfaceFlagWrapper('boxWFlag1',box1, 0)
boxWFlag2 = geom.surfaceFlagWrapper('boxWFlag2',box2, 0)
