...
box1=geom.box('box1',[-sampleWidth/2, -sampleHeight/2, -sampleLength/2],[sampleWidth/2, 0.0, sampleLength/2],vel=[0.0, 0.0, 0.0], mat=0, group=0, dim=3, flaggedSurfaces=[False, False, False, False, True, False])
box2=geom.box('box2',[-sampleWidth/2, 0.0, -sampleLength/2],[sampleWidth/2, sampleHeight/2, sampleLength/2],vel=[0.0, 0.0, 0.0], mat=0, group=0, dim=3, flaggedSurfaces=[False, True, False, False, False, False])
