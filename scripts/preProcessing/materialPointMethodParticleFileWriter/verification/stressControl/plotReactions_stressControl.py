...
for i,file in enumerate(files):
	...
	ax1.plot(time,1000*sxx,linestyle='-',color=cm.gist_rainbow(0),linewidth=6,alpha=0.25,label='box: sxx')
	ax1.plot(time,1000*syy,linestyle='-',color=cm.gist_rainbow(0.33),linewidth=6,alpha=0.25,label='box: syy')
	ax1.plot(time,1000*szz,linestyle='-',color=cm.gist_rainbow(0.67),linewidth=6,alpha=0.25,label='box: szz')
...
for i,file in enumerate(files):
	...
	ax2.plot(time,F00,linestyle='-',color=cm.gist_rainbow(0),linewidth=1,label='F00')
	ax2.plot(time,F11,linestyle='-',color=cm.gist_rainbow(0.33),linewidth=1,label='F11')
	ax2.plot(time,F22,linestyle='-',color=cm.gist_rainbow(0.67),linewidth=1,label='F22')
 
	ax3.plot(time,L00,linestyle='-',color=cm.gist_rainbow(0),linewidth=1,label='L00')
	ax3.plot(time,L11,linestyle='-',color=cm.gist_rainbow(0.33),linewidth=1,label='L11')
	ax3.plot(time,L22,linestyle='-',color=cm.gist_rainbow(0.67),linewidth=1,label='L22')
...
ax1.plot([0,10],[-200,-200],linestyle='--',color='k')
ax1.plot([0,10],[100,100],linestyle='--',color='r')
...
fig.tight_layout()
#plt.show()
fig.savefig("stressControl.png", bbox_inches="tight")