...
pfw["surfaceTensionPairs"]=[[0, -1, 7.28e-5], # Liquid - Gas
                            [1, -1, 1.9e-4], # Solid - Gas For Si 1.14 (111) - 1.9 (110)
                            [0,  1, 0]] # Liquid - solid (6.5e-8)
...
drop = geom.cylinder(
    "drop",
    [0.0, thickness + radius - inset, 10*pfw["zmin"]],
    [0.0, thickness + radius - inset, 10*pfw["zmax"]],
    r=radius,
    vel=[0.0, 0.0, 0.0],
    mat=0,
    group=0,
