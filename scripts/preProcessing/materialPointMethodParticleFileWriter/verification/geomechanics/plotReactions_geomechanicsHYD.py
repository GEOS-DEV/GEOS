...
for i,file in enumerate(files):
	...
	ax2.plot(ev,p,linestyle='-',color=cm.gist_rainbow(0),linewidth=2,label='reaction')
 ...
 #print(file)
	...
	#print('box data',box_time, box_sxx)  
		ax1.plot(box_time,box_epxx,linestyle='-',color=cm.gist_rainbow(0),linewidth=3,label='box ep_xx')		
		ax1.plot(box_time,box_epyy,linestyle='-',color=cm.gist_rainbow(.1),linewidth=3,label='box ep_yy')
		ax1.plot(box_time,box_epzz,linestyle='-',color=cm.gist_rainbow(.2),linewidth=3,label='box ep_zz')
		ax1.plot(box_time,box_epxy,linestyle='-',color=cm.gist_rainbow(.3),linewidth=3,label='box ep_xy')
		ax1.plot(box_time,box_epyz,linestyle='-',color=cm.gist_rainbow(.4),linewidth=3,label='box ep_yz')
		ax1.plot(box_time,box_epxz,linestyle='-',color=cm.gist_rainbow(.5),linewidth=3,label='box ep_xz')
		...
		ax2.plot(box_ev,box_p,linestyle='-',color=cm.gist_rainbow(5),linewidth=3,label='box')
...
ax2.set_xlabel('Vol. Strain', fontsize=16)
#ax2.set_xlim(0,1.2)
#ax2.set_ylim(0,600)
#ax2.set_yscale("log")
#ax2.set_ylim(-2,2)

ax2.set_ylabel('Pressure GPa)', fontsize=16)
...
fig.tight_layout()
#plt.show()
fig.savefig("geoModel_HYD.png", bbox_inches="tight")