...
A = 0.1  # 0.238    # creep: phi_e = A*exp(-p/B), note that A is 0-pressure equilbrium porosity and phi_i = 1 -exp(-p3)
B = 100. # 0.08     # creep: phi_e = A*exp(-p/B), B is GPa
C = timeScale*1.e-10   # creep rate: dphi/dt = -p*C*(phi-phi_e)
