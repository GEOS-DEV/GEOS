...
for i,file in enumerate(files):
 ...
 #print(file)
	...
	#print('box data',box_time, box_sxx)  
		...
		ax2.plot(box_p,box_vm,linestyle='-',color=cm.gist_rainbow(5),linewidth=3,label='box')
...
ax2.set_ylabel(r'$\sigma_{vm}$ (MPa)', fontsize=16)
...
fig.tight_layout()
#plt.show()
fig.savefig("geoModel_FTable.png", bbox_inches="tight")