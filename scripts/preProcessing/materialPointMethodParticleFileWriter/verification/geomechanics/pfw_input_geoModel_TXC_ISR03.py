...
confiningPressure = 0.00203  
maxCompressiveStrain = 0.0704
...
#values taken from ISR01 Mathematica script
...
p0 = -0.03
confiningPressure = min(confiningPressure,p0/(-3.0001))
print('confining pressure ='+str(confiningPressure))
#p0 should be less than or equal to -3* the confining pressure
p1 = 0.65 # GPa^-1
p2 = 0.0
p3 = 0.255
p4 = 0.0 #not yet sure what value p4 should be
