...
for i,file in enumerate(files):
	...
	ax5.plot(-100.*ezz,-1000.*(szz-sxx),linestyle='-',color=cm.gist_rainbow(0.67),linewidth=1,label='ezz-exx')
	ax6.plot(-100.*ev,-1000.*(szz-sxx),linestyle='-',color=cm.gist_rainbow(0.67),linewidth=1,label='ezz-exx')
	...
	#print('box data',box_time, box_sxx)  
        # plot strain history
		ax1.plot(box_time,box_evp,linestyle='-',color=cm.gist_rainbow(.6),linewidth=3,label='box ev')
		...
		ax2.plot(box_time,box_damage,linestyle='-',color=cm.gist_rainbow(.6),linewidth=3,label='box damage')
		...
		ax4.plot(box_time,box_damage,linestyle='-',color='r',linewidth=3,label='box damage')	
        
        # plt pressure-shear, it would be good to add the yield surface to this plot.
		#ax4.plot(1000.*box_p,1000.*box_vm,linestyle='-',color=cm.gist_rainbow(5),linewidth=3,label='box')
...
ax5.set_xlabel('axial strain (%)', fontsize=16)
ax5.set_ylabel('differential stress (MPa)', fontsize=16)
ax5.legend(bbox_to_anchor=(1.04,1), loc="upper left",fontsize='x-small')

ax6.set_xlabel('vol. strain (%)', fontsize=16)
...
fig.tight_layout()
#plt.show()
fig.savefig("geoModel_Tension.png", bbox_inches="tight")