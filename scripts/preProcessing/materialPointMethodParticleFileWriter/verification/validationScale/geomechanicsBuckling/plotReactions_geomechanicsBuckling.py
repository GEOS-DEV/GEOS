...
files=[
'geoModel_isotropicBuckling_uniaxial',
'geoModel_isotropicBuckling_unconfinedCompression',
'geoModel_anisotropicBuckling_unconfinedCompression'
]  

labels=[
'isotropic uniaxial',
'isotropic unconfined',
'anisotropic unconfined [101]'
]
...
for i,file in enumerate(files):
	...
	axes[0][0].plot(time,F11,linestyle='-',color=cm.gist_rainbow(0.33),linewidth=1,label='F11')
	...
	axes[0][1].plot(time,-1000*Rym/Ay,linestyle='-',color=cm.gist_rainbow(0.33),linewidth=2,label='y_minus')
	axes[0][1].plot(time,1000.0*Ryp/Ay,linestyle='--',color=lighten_color(cm.gist_rainbow(0.33),1.5),linewidth=2,label='y_plus')
 ...
 #print(file)
	...
	#print('box data',box_time, box_sxx)  
		...
		axes[0][1].plot(box_time,1000.*box_syy,linestyle='-',color=cm.gist_rainbow(.2),linewidth=3,label='box syy')		
		...
		axes[1][0].plot(box_p,box_vm,linestyle='-',color=cm.gist_rainbow(.5),linewidth=3,label='box')
  
		axes[1][1].plot(box_rho,box_p,linestyle='-',color=cm.gist_rainbow(.5),linewidth=3,label='p')
		axes[1][1].plot(box_rho,box_vm,linestyle='--',color=cm.gist_rainbow(.5),linewidth=3,label='vm')
...
axes[0][0].legend(bbox_to_anchor=(1.04,1), loc="upper left",fontsize='x-small')
axes[0][0].grid()
...
axes[1][0].set_xlabel('Pressure (GPa)', fontsize=16)
#ax2.set_xlim(0,1.2)
#ax2.set_ylim(0,600)
#ax2.set_yscale("log")
...
axes[1][0].legend(bbox_to_anchor=(1.04,1), loc="upper left",fontsize='medium')
axes[1][0].grid()


axes[0][1].set_xlabel('time', fontsize=16)
axes[0][1].set_ylabel(r'$\sigma$ (MPa)', fontsize=16)
axes[0][1].legend(bbox_to_anchor=(1.04,1), loc="upper left",fontsize='medium')


axes[1][1].set_xlabel('density', fontsize=16)
axes[1][1].set_ylabel(r'$\sigma$ (MPa)', fontsize=16)
axes[1][1].legend(bbox_to_anchor=(1.04,1), loc="upper left",fontsize='medium')
...
fig.tight_layout()
#plt.show()
fig.savefig("geoModel_Buckling.png", bbox_inches="tight")