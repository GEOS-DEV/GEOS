...
pfw["runDebug"] = False
stopTime = 1000.0
confiningPressure = 0.0207  # confining pressure GPa (make sure this p < -p0/3)
maxCompressiveStrain = 0.064
...
creepC = (1.e4)*timeScale*5.7e-09   # creep rate: dphi/dt = -p*C*(phi-phi_e)
creepD = 1.
creepE = 0.
creepF = 1.
