...
sampleDiameter = 38.2/4 # target diameter
sampleLength = 38.2/4 # target length (cylinder) , mm
...
pfw["endTime"] = stopTime/2 #changed this so that the simulation does not run for long
...
pfw["absorbingDampingFactor"]=[100, 100, 100, 100, 100, 100]  
