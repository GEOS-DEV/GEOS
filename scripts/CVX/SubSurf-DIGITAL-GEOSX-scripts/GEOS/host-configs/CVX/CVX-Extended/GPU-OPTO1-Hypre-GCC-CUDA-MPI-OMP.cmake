...
if(ENABLE_CUDA)
  ...
  set(CMAKE_CUDA_FLAGS_RELEASE "   -rdc=true -O1 -ftz=true -Xcompiler -O1 -Xcompiler -fno-fast-math -Xcompiler -mdaz-ftz -DNDEBUG  " CACHE STRING "") 
...
set(CMAKE_C_FLAGS_RELEASE " $ENV{GEOSX_HOST_FLAGS_CLI} -O1  -Wno-error -pthread  -fno-fast-math -DNDEBUG $ENV{GEOS_HOST_FLAGS_CLI} " CACHE STRING "")
