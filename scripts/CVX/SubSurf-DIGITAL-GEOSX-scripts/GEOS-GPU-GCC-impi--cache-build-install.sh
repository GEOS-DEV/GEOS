#!/bin/bash 
#
# Chevron generic clone-config-build-install script for GEOS on x86_64 platforms
#
...
# OS :        RHEL7/8
#
# Michael E. Thomadakis, Innvation and HPC R&D, CTC 
#
#
# NOTE :
...
# : ${gitGEOSX:="https://github.com/GEOSX/GEOSX.git"}
...
if [ $# -lt 1 ]; then 
    ...
    for hcf in $(ls -1 ${HOST_CONFIG_DIR}/*GPU*impi*.cmake ${HOST_CONFIG_DIR}/*GPU*MPI*.cmake); do 
...
# GIT_LFS="/data/saet/software/x86_64/bin"
