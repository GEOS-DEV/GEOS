...
# Default suffix if nothing passed
# SUFFIX=${SUFFIX:-cpu}
...
if [[ ${UMPIRE} == "1" ]]; then
	...
	cmake -DCMAKE_TOOLCHAIN_FILE=$HOST_CONFIG_FILENAME \
	      -B ${UMPIRE_BUILD} -S ${UMPIRE_DIR} \
              ...
              -DCMAKE_INSTALL_PREFIX=${UMPIRE_INSTALL} 
...
# HYPRE_INSTALL=${HYPRE_DIR}/${INSTALLDIR}
# HYPRE_DIR=${CWD}/hypre
# HYPRE_BUILD=${HYPRE_DIR}/build-${SUFFIX}
# HYPRE_INSTALL=${HYPRE_DIR}/install-${SUFFIX}
