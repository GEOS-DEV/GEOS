...
#
# Compilers : NVHPC nvc, nc++, nvfortran 
...
#   https://github.com/GEOS-DEV/GEOSX.git
# Documentation
...
echo "# Chevron HPC Innovation and R&D generic clone-cache-config-build-install script for GEOSX 
#
# Compilers : GCC $GCC_VER (modulefile= ${comp})
# MPI Stack : $MPI $MPIVER (modulefile= ${mpi})
"
