...
: ${mpi:="nvhpc-hpcx-cuda11/23.7"}
# aarch64 
# nvhpc-hpcx-cuda11/23.7 nvhpc-hpcx-cuda12/23.7  nvhpc-hpcx/23.7  
: ${comp:="aarch64/CUDA/NVHPC_23.7.0"}
: ${gpucomp:=""}
# : ${gpucomp:="aarch64/CUDA/11.8"}
# : ${modules:=" /devl/geophys/util/modules/ModuleFiles/git/2.27.0  aarch64/CMake_3.24.1  "}
