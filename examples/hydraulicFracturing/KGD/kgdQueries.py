...
for state in range(TimeSliderGetNStates()):
    ...
    injectionPressure = ZonePick(coord=(0, 0.01, 0.5), vars=("CellData/pressure"))['CellData/pressure']
    injectionAperture = ZonePick(coord=(0, 0.01, 0.5), vars=("CellData/elementAperture"))['CellData/elementAperture']
