include(${CMAKE_CURRENT_LIST_DIR}/../../src/coreComponents/LvArray/host-configs/LLNL/tioga-cce-16.cmake)
include(${CMAKE_CURRENT_LIST_DIR}/tioga-base.cmake)

set( CONDUIT_DIR "${GEOSX_TPL_DIR}/conduit-0.8.8" CACHE PATH "" )
set( HDF5_DIR "${GEOSX_TPL_DIR}/hdf5-1.14.1-2" CACHE PATH "" )

set( BLAS_DIR "/opt/rocm-5.6.0/" CACHE PATH "" )
...
set( CALIPER_DIR "${GEOSX_TPL_DIR}/caliper-master" CACHE PATH "" )
