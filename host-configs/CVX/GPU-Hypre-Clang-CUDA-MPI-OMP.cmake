...
#
# CVX Generic .cmake for Nvidia GPUs:  Clang (+GCC), CUDA and Open or Intel MPI ; OpenMP enabled
# 
...
set(CLANG_GCC " --gcc-install-dir=$ENV{GCC_ROOT} " CACHE STRING "")
message("## CLANG_GCC = ${CLANG_GCC}")
...
if(ENABLE_CUDA)
  # GEOS_USE_DEVICE and CALC_FEM_SHAPE_IN_KERNEL must be defined and visible
  ...
  set(CMAKE_CUDA_FLAGS " $ENV{GEOS_CUDA_FLAGS_CLI}  -rdc=true  -restrict -arch ${CUDA_ARCH} --expt-extended-lambda --expt-relaxed-constexpr -Werror cross-execution-space-call,reorder,deprecated-declarations -Xcompiler ${CLANG_GCC}  " CACHE STRING "") 
  message("## ENV{GEOS_CUDA_FLAGS_CLI} = $ENV{GEOS_CUDA_FLAGS_CLI}")
  message("## CMAKE_CUDA_FLAGS = ${CMAKE_CUDA_FLAGS}")

  set(CMAKE_CUDA_FLAGS_RELEASE " -O3 -ftz=true -Xcompiler -O3 -Xcompiler -fno-fast-math -DNDEBUG  " CACHE STRING "") 
  set(CMAKE_CUDA_FLAGS_RELWITHDEBINFO "-g -lineinfo ${CMAKE_CUDA_FLAGS_RELEASE}" CACHE STRING "") 
  set(CMAKE_CUDA_FLAGS_DEBUG " ${CMAKE_CUDA_FLAGS} -g -G -O0 -Xcompiler -O0  " CACHE STRING "") 

  set(CUDA_SEPARABLE_COMPILATION ON CACHE BOOL "")

  ## set(CMAKE_CUDA_FLAGS " $ENV{GEOS_CUDA_FLAGS_CLI} -restrict -arch ${CUDA_ARCH} --expt-extended-lambda --expt-relaxed-constexpr -Werror cross-execution-space-call,reorder,deprecated-declarations -Xcompiler -DGEOS_USE_DEVICE  -Xcompiler -DCALC_FEM_SHAPE_IN_KERNEL " CACHE STRING "") 
...
set(CMAKE_C_FLAGS_RELEASE " $ENV{GEOSX_HOST_FLAGS_CLI} ${CLANG_GCC} -O3  -Wno-error -pthread  -fno-fast-math -DNDEBUG $ENV{GEOS_HOST_FLAGS_CLI} " CACHE STRING "")
