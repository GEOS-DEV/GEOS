...
message("## GEOS with static linking ") 
...
if(ENABLE_CUDA)
  ...
  set(CMAKE_CUDA_FLAGS " $ENV{GEOS_CUDA_FLAGS_CLI}   -rdc=true -restrict -arch ${CUDA_ARCH} --expt-extended-lambda --expt-relaxed-constexpr -Werror cross-execution-space-call,reorder,deprecated-declarations " CACHE STRING "") 
