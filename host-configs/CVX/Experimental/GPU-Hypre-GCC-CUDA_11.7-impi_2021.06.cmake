...
site_name(HOST_NAME)
set(CONFIG_NAME "GPU-Hypre-GCC_10.2.0-impi_2021.06" CACHE PATH "")
...
set(CUDA_TOOLKIT_LIB_DIR "${CUDA_TOOLKIT_ROOT_DIR}/lib64"  CACHE PATH "")
...
#   set(CMAKE_CUDA_FLAGS "-restrict -arch ${CUDA_ARCH} --expt-extended-lambda --expt-relaxed-constexpr -Werror cross-execution-space-call,reorder,deprecated-declarations --library-path=${CUDA_TOOLKIT_LIB_DIR} -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "") 
  set(CMAKE_CUDA_FLAGS_RELEASE " ${CMAKE_CUDA_FLAGS} -O3 -DNDEBUG -Xcompiler -DNDEBUG  " CACHE STRING "") 
  set(CMAKE_CUDA_FLAGS_RELWITHDEBINFO "-g -lineinfo ${CMAKE_CUDA_FLAGS_RELEASE}" CACHE STRING "") 
  set(CMAKE_CUDA_FLAGS_DEBUG "-g -G -O0 -Xcompiler -O0  " CACHE STRING "") 

  # set(CMAKE_CUDA_FLAGS "-restrict -arch ${CUDA_ARCH} --expt-extended-lambda --expt-relaxed-constexpr -Werror cross-execution-space-call,reorder,deprecated-declarations --library-path=${CUDA_TOOLKIT_LIB_DIR} -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "") 
  # set(CMAKE_CUDA_FLAGS_RELEASE "-O3 -DNDEBUG -Xcompiler -DNDEBUG -Xcompiler -O3 -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "") 
  # set(CMAKE_CUDA_FLAGS_RELWITHDEBINFO "-g -lineinfo ${CMAKE_CUDA_FLAGS_RELEASE}" CACHE STRING "") 
  # set(CMAKE_CUDA_FLAGS_DEBUG "-g -G -O0 -Xcompiler -O0 -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "") 
...
set(CMAKE_C_FLAGS_RELEASE "  -Wno-error -pthread -O2 -fno-fast-math -DNDEBUG -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "")
set(CMAKE_C_FLAGS_RELWITHDEBINFO "-g ${CMAKE_C_FLAGS_RELEASE}" CACHE STRING "")
set(CMAKE_C_FLAGS_DEBUG "-O0 -g  -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "")
...
set(CMAKE_CXX_FLAGS_DEBUG "-O0 -g  -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "")
# set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE}" CACHE STRING "")
...
set(CMAKE_Fortran_FLAGS_DEBUG "-O0 -g  -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "")
# set(CMAKE_Fortran_COMPILER "gfortran" CACHE PATH "")
# set(CMAKE_Fortran_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE}" CACHE STRING "")
# set(ENABLE_FORTRAN OFF CACHE BOOL "" FORCE)
...
set(CMAKE_EXE_LINKER_FLAGS_RELEASE " -L${CUDA_TOOLKIT_LIB_DIR} " CACHE STRING "")
