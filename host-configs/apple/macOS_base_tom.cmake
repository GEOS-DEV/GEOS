...
set(ENABLE_SCOTCH "ON" CACHE PATH "" FORCE )

#set(BLAS_LIBRARIES   "/opt/homebrew/opt/openblas/lib/libopenblas.dylib" CACHE FILEPATH "" FORCE)
#set(LAPACK_LIBRARIES "/opt/homebrew/opt/openblas/lib/libopenblas.dylib" CACHE FILEPATH "" FORCE)
...
set(BISON_EXECUTABLE "/Users/zibitsker1/homebrew/opt/bison/bin/bison" CACHE FILEPATH "" FORCE)
# If scotch also uses flex:
set(FLEX_EXECUTABLE  "/Users/zibitsker1/homebrew/opt/flex/bin/flex"   CACHE FILEPATH "" FORCE)
...
set(GEOS_TPL_DIR "/Users/zibitsker1/Documents/Projects/codes/thirdPartyLibs/install-macOS_base_tom-release" CACHE PATH "" FORCE) # the commit.
