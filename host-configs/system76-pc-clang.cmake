set( CONFIG_NAME "system76-pc" ) 

# Set compilers path
set(CMAKE_C_COMPILER "/usr/bin/clang" CACHE PATH "")   # This is typically something like /usr/bin/gcc ... or clang
set(CMAKE_CXX_COMPILER "/usr/bin/clang++" CACHE PATH "") # This is typically something like /usr/bin/g++ ... or clang++
