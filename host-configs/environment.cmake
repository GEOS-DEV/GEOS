...
if(NOT DEFINED ENABLE_HYPREDRV)
  if(DEFINED ENV{ENABLE_HYPREDRV} AND NOT "$ENV{ENABLE_HYPREDRV}" STREQUAL "")
    set(ENABLE_HYPREDRV "$ENV{ENABLE_HYPREDRV}" CACHE BOOL "" FORCE)
  endif()
endif()
