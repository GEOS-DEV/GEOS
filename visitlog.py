...
DefineScalarExpression("weakTraceGrid_traceActive_all", "max(<CellRegion1_GridFields/gridWeakInterfaceTraceActive_velocityField1>,<CellRegion1_GridFields/gridWeakInterfaceTraceActive_velocityField2>)")
AddPlot("Pseudocolor", "weakTraceGrid_traceActive_all", 1, 1)
...
SaveWindowAtts.outputDirectory = "scripts/preProcessing/materialPointMethodParticleFileWriter/verification/weakTraceRotatedBar/output/weakTraceRotatedBar_diagnostic_dryrun"
SaveWindowAtts.fileName = "grid_trace_active_smoke_2field"
